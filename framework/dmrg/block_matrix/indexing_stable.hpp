...
public:
    ...
    // Methods to load/store stuff
    template <class Archive>
    void load(Archive & ar) { ar["Index"] >> data_; }
    //
    template <class Archive>
    void save(Archive & ar) const { ar["Index"] << data_; }
    //
    friend class boost::serialization::access;
    //
    template <class Archive>
    void load(Archive & ar, const unsigned int version) { ar & data_; }
    //
    template <class Archive>
    void save(Archive & ar, const unsigned int version) const { ar & data_; }
