...
namespace ietl
{
    ...
    template<class MATRIX, class VS, class ITER>
    void jacobi_davidson_standard<MATRIX, VS, ITER>::restart_jd(vector_space &V, vector_space &VA, property_vector& props,
    ...
    void jacobi_davidson_standard_mo<MATRIX, VS, ITER, OtherMatrix, SymmGroup>::restart_jd
            (vector_space &V, vector_space &VA, property_vector& props, const matrix_double &eigvecs,
             const vector_double &eigvals)
    {
        // Variable declaration
        std::vector<couple_val> vector_values ;
