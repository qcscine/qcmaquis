...
namespace chem_detail {
    ...
    inline IndexTuple align_indices(int i, int j, int k, int l) {
        if (i<j) std::swap(i,j);
        if (k<l) std::swap(k,l);
    ...
    inline IndexTuple align_indices(IndexTuple const & rhs) {
        return align_indices(rhs[0], rhs[1], rhs[2], rhs[3]);
    }

    inline IndexTuple no_align_indices(int i, int j, int k, int l) {
        return IndexTuple(i,j,k,l);
    }
    ...
    {
    public:
        IndexTuple operator() (int i, int j, int k, int l){
            return align_indices(i,j,k,l);
        }
    };
    ...
    public:
        IndexTuple operator() (int i, int j, int k, int l){
            return no_align_indices(i,j,k,l);
        }
    };
