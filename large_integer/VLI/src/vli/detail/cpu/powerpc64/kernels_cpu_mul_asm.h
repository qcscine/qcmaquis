...
namespace vlilib{
    namespace detail{
                     ...
                     #define FUNCTION_mul_nbits_64bits(z, n, unused) \
                         void NAME_MUL_NBITS_64BITS(n)(unsigned long int* x, boost::uint64_tconst* y){           \
                         asm(                                                                                       \
                             "xor   6,6,6 \n" \
                             "ld    "R(0)", 0(3)   \n" /* x arg */                                                     \
                             "ld    "R(1)", 0(4)   \n" /* y arg */                                                     \
                      ...
                      // remark same than x86, look cpu_x86 for details
                       ...
                       #define BOOST_PP_LOCAL_MACRO(n) \
                          void NAME_MUL_NBITS_NBITS(BOOST_PP_SUB(n,2))(unsigned long int* x, boost::uint64_tconst* y){ \
                         asm(                                                                                       \
                       ...
                       void mul128_64_64(unsigned long int* x/* %%rdi */, boost::uint64_tconst* y/* %%rsi */, boost::uint64_tconst* z/* %%rdx -> rcx */){
                          asm( 
                              "ld 14, 0(4)     \n"                   
                              "ld 15, 0(5)     \n"                   
                              "mulld  16,14,15 \n"  
                       ...
                       void mul256_128_128(unsigned long int* x/* %%rdi */, boost::uint64_tconst* y/* %%rsi */, boost::uint64_tconst* z/* %%rdx -> rbx */){
                          asm( 
                              "ld 14, 0(4)              \n"                   
                              "ld 15, 8(4)              \n"                   
                              "ld 16, 0(5)              \n"                   
                      ...
                      void mul384_192_192(unsigned long int* x/* %%rdi */, boost::uint64_tconst* y/* %%rsi */, boost::uint64_tconst* z/* %%rdx -> rbx */){
                          asm( 
                              "ld 14, 0(4)              \n"                   
                              "ld 15, 8(4)              \n"                   
                              "ld 16, 16(4)              \n"                   
                     ...
                     void mul512_256_256(unsigned long int* x/* %%rdi */, boost::uint64_tconst* y/* %%rsi */, boost::uint64_tconst* z/* %%rdx -> rbx */){
                            asm(
                              "ld 14, 0(4)              \n"                   
                              "ld 15, 8(4)              \n"                   
                              "ld 16, 16(4)              \n"                   
