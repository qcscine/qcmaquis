...
\item We group 32 coefficients of the result into a task and distribute them among the warps of threads (Fig.\ \ref{fig:GPU_load_balance}).
\begin{figure}[t]
    \begin{center}
    \mbox{
    ...
    \end{center}
\end{figure}
\item {\color{red} TODO: Tim please elaborate}
