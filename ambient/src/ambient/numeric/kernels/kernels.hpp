...
namespace ambient { namespace numeric { namespace kernels {
    ...
    template<typename T, class A>
    struct scalar_norm : public kernel< scalar_norm<T,A> > 
    { static void c(const matrix<T,A>& a, future<double>& norm); };
...
////////////////////////////
    ...
    template<typename T, class A>
    void scalar_norm<T,A>::c(const matrix<T,A>& a, future<double>& norm){
        T* ad = current(a);
