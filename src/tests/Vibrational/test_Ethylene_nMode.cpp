 ...
 * from the initial guess. With the new constructor, which also includes the
 * zero blocks of the MPS, the noise is sufficient to move the optimization
 * towards the correct energy. For this reason, we
 */
