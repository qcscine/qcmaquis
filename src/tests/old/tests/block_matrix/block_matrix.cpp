...
BOOST_AUTO_TEST_CASE(block_matrix_has_block) {
  ...
  BOOST_CHECK_EQUAL(
      true, ba.has_block(std::make_pair(1, 1), std::make_pair(1, 1))
  );
  BOOST_CHECK_EQUAL(
      true, ba.has_block(std::make_pair(2, 1), std::make_pair(2, 1))
  );
  BOOST_CHECK_EQUAL(
      true, ba.has_block(std::make_pair(3, 1), std::make_pair(3, 1))
  );
  BOOST_CHECK_EQUAL(
      false, ba.has_block(std::make_pair(2, 1), std::make_pair(3, 1))
  );
}
