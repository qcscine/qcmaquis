...
// Test 1: H2 with d=3 Angstrom, singlet, 6-31G* basis set, FCI, integrals
...
BOOST_AUTO_TEST_CASE(PreBO_Test1) {
  ...
  std::vector<std::vector<std::vector<double>>> RDM{
      {{1.13103300179178, -2.52211470905664e-08, -0.0947313411126442,
        -9.1603632625322e-09},
       {-2.52211470905664e-08, 0.855019531445115, 3.53874389777801e-08,
        -0.0716856100438375},
       {-0.0947313411126442, 3.53874389777801e-08, 0.00793626405671728,
        -2.03230542773261e-09},
       {-9.1603632625322e-09, -0.0716856100438375, -2.03230542773261e-09,
        0.00601120270638985}}};
