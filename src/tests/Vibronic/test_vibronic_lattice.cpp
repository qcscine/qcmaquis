...
BOOST_FIXTURE_TEST_CASE(
    Test_Lattice_GetProp_Vibronic_Pyrazine, VibronicFixture
) {
  auto lattice = VibronicLattice(parametersVibronic);
...
BOOST_FIXTURE_TEST_CASE(Test_Lattice_GetProp_Excitonic, VibronicFixture) {
  ...
  // The index 0 is the first excite state of the first monomer, then 1-10 are
  // the next modes, then 11 is the excited states of the second monomer.
