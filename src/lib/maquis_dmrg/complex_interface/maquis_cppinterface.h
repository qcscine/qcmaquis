...
// dimension nsweeps -- number of sweeps

void qcmaquis_interface_preinit(
    int nel, int L, int irrep, int* site_types, double conv_thresh, int m,
    bool meas_2rdm, bool entropy, bool magnetism, const std::string& init_type,
    const std::string& optimization, int ietl_jcd_maxiter, double ietl_jcd_tol,
    double truncation_initial, double truncation_main, double integral_cutoff,
