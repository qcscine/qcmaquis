...
void operation::extract_profiles(size_t pin){
    this->profiles[0] = get_profile(*static_cast<T0*>(this->arguments[0]));
    this->pin = this->profiles[pin];
}
template < typename T0 > void operation::prototype_template(void (*)( pinned T0& )) { if(!pin) this->extract_profiles< T0 >(0); ((void (*)( pinned T0& ))this->operation_ptr) ( marked *static_cast<T0*>(this->arguments[0]) ); }
...
template < typename T0 , typename T1 > void operation::prototype_template(void (*)( pinned T0& , T1& )) { if(!pin) this->extract_profiles< T0 , T1 >(0); ((void (*)( pinned T0& , T1& ))this->operation_ptr) ( marked *static_cast<T0*>(this->arguments[0]) , *static_cast<T1*>(this->arguments[1]) ); } template < typename T0 , typename T1 > void operation::prototype_template(void (*)( T0& , pinned T1& )) { if(!pin) this->extract_profiles< T0 , T1 >(1); ((void (*)( T0& , pinned T1& ))this->operation_ptr) ( *static_cast<T0*>(this->arguments[0]) , marked *static_cast<T1*>(this->arguments[1]) ); }
...
template < typename T0 , typename T1 , typename T2 , typename T3 > void operation::prototype_template(void (*)( pinned T0& , T1& , T2& , T3& )) { if(!pin) this->extract_profiles< T0 , T1 , T2 , T3 >(0); ((void (*)( pinned T0& , T1& , T2& , T3& ))this->operation_ptr) ( marked *static_cast<T0*>(this->arguments[0]) , *static_cast<T1*>(this->arguments[1]) , *static_cast<T2*>(this->arguments[2]) , *static_cast<T3*>(this->arguments[3]) ); } template < typename T0 , typename T1 , typename T2 , typename T3 > void operation::prototype_template(void (*)( T0& , pinned T1& , T2& , T3& )) { if(!pin) this->extract_profiles< T0 , T1 , T2 , T3 >(1); ((void (*)( T0& , pinned T1& , T2& , T3& ))this->operation_ptr) ( *static_cast<T0*>(this->arguments[0]) , marked *static_cast<T1*>(this->arguments[1]) , *static_cast<T2*>(this->arguments[2]) , *static_cast<T3*>(this->arguments[3]) ); } template < typename T0 , typename T1 , typename T2 , typename T3 > void operation::prototype_template(void (*)( T0& , T1& , pinned T2& , T3& )) { if(!pin) this->extract_profiles< T0 , T1 , T2 , T3 >(2); ((void (*)( T0& , T1& , pinned T2& , T3& ))this->operation_ptr) ( *static_cast<T0*>(this->arguments[0]) , *static_cast<T1*>(this->arguments[1]) , marked *static_cast<T2*>(this->arguments[2]) , *static_cast<T3*>(this->arguments[3]) ); } template < typename T0 , typename T1 , typename T2 , typename T3 > void operation::prototype_template(void (*)( T0& , T1& , T2& , pinned T3& )) { if(!pin) this->extract_profiles< T0 , T1 , T2 , T3 >(3); ((void (*)( T0& , T1& , T2& , pinned T3& ))this->operation_ptr) ( *static_cast<T0*>(this->arguments[0]) , *static_cast<T1*>(this->arguments[1]) , *static_cast<T2*>(this->arguments[2]) , marked *static_cast<T3*>(this->arguments[3]) ); }
}}
