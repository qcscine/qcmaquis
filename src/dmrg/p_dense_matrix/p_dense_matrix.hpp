...
namespace blas {
    ...
    p_dense_matrix<T, MemoryBlock>::p_dense_matrix(size_type rows = 0, size_type columns = 0, T init_value = T() )
    ...
    p_dense_matrix<T, MemoryBlock>::p_dense_matrix(p_dense_matrix<T,OtherMemoryBlock> const& m)
    : size1_(m.size1_), size2_(m.size2_), reserved_size1_(m.size1_), values_()
    {
        ...
        else
        {
            ...
            {
                std::pair<typename p_dense_matrix<T,OtherMemoryBlock>::const_column_element_iterator,
                          typename p_dense_matrix<T,OtherMemoryBlock>::const_column_element_iterator
                         > range(m.column(j));
    ...
    template <typename T, typename MemoryBlock>
    p_dense_matrix<T, MemoryBlock>& p_dense_matrix<T, MemoryBlock>::operator = (p_dense_matrix<T, MemoryBlock> rhs)
    {
        this->swap(rhs);
        return *this;
    }
    ...
    template <typename T, typename MemoryBlock>
    inline T& p_dense_matrix<T, MemoryBlock>::operator()(const size_type i, const size_type j)
    {
    ...
    template <typename T, typename MemoryBlock>
    inline T const& p_dense_matrix<T, MemoryBlock>::operator()(const size_type i, const size_type j) const 
    {
    ...
    template <typename T, typename MemoryBlock>
    bool p_dense_matrix<T, MemoryBlock>::operator == (p_dense_matrix const& rhs) const
    {
    ...
    template <typename T, typename MemoryBlock>
    p_dense_matrix<T,MemoryBlock>& p_dense_matrix<T, MemoryBlock>::operator += (p_dense_matrix const& rhs) 
    {
    ...
    p_dense_matrix<T,MemoryBlock>& p_dense_matrix<T, MemoryBlock>::operator *= (T2 const& t)
    {
    ...
    template <typename T, typename MemoryBlock>
    inline const bool p_dense_matrix<T, MemoryBlock>::empty() const
    {
        return (this->size1_ == 0 || this->size2_ == 0);
    }

    template <typename T, typename MemoryBlock>
    inline const std::size_t p_dense_matrix<T, MemoryBlock>::num_rows() const
    {
        return this->size1_;
    }

    template <typename T, typename MemoryBlock>
    inline const std::size_t p_dense_matrix<T, MemoryBlock>::num_columns() const
    {
        return this->size2_;
    }

    template <typename T, typename MemoryBlock>
    inline const std::ptrdiff_t p_dense_matrix<T, MemoryBlock>::stride1() const
    {
        return 1;
    }

    template <typename T, typename MemoryBlock>
    inline const std::ptrdiff_t p_dense_matrix<T, MemoryBlock>::stride2() const
    {
        return this->reserved_size1_;
    }

    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::resize(size_type size1, size_type size2, T const& init_value = T())
    {
    ...
    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::reserve(size_type size1, size_type size2, T const& init_value = T())
    {
    ...
    template <typename T, typename MemoryBlock>
    std::pair<std::size_t,std::size_t> p_dense_matrix<T, MemoryBlock>::capacity() const
    {
    ...
    template <typename T, typename MemoryBlock>
    bool p_dense_matrix<T, MemoryBlock>::is_shrinkable() const
    {
    ...
    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::clear()
    {
    ...
    void p_dense_matrix<T, MemoryBlock>::append_columns(std::pair<InputIterator,InputIterator> const& range, difference_type k=1)
    {
    ...
    template <typename T, typename MemoryBlock>
    template <typename InputIterator>
    void p_dense_matrix<T, MemoryBlock>::append_rows(std::pair<InputIterator,InputIterator> const& range, difference_type k =1)
    {
    ...
    template <typename T, typename MemoryBlock>
    template <typename InputIterator>
    void p_dense_matrix<T, MemoryBlock>::insert_rows(size_type i, std::pair<InputIterator,InputIterator> const& range, difference_type k = 1)
    {
        assert( i <= this->size1_ );
        assert( std::distance(range.first, range.second) == k*this->size2_ );
    ...
    template <typename T, typename MemoryBlock>
    template <typename InputIterator>
    void p_dense_matrix<T, MemoryBlock>::insert_columns(size_type j, std::pair<InputIterator,InputIterator> const& range, difference_type k = 1)
    {
        assert( j <= this->size2_);
        assert( std::distance(range.first, range.second) == k*this->size1_ );
    ...
    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::remove_rows(size_type i, difference_type k = 1)
    {
    ...
    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::remove_columns(size_type j, difference_type k = 1)
    {
    ...
    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::swap_rows(size_type i1, size_type i2)
    {
    ...
    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::swap_columns(size_type j1, size_type j2)
    {
    ...
    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::plus_assign(p_dense_matrix const& rhs)
    {
    ...
    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::minus_assign(p_dense_matrix const& rhs)
    {
        assert((rhs.size1_ == this->size1_) && (rhs.size2_ == this->size2_));
        if(!(this->is_shrinkable() || rhs.is_shrinkable()) )
        {
    ...
    template <typename T, typename MemoryBlock>
    template <typename T2>
    void p_dense_matrix<T, MemoryBlock>::multiplies_assign (T2 const& t)
    {
        if(!(is_shrinkable()) )
        {
    ...
    template <typename T, typename MemoryBlock>
    void p_dense_matrix<T, MemoryBlock>::inplace_conjugate()
    {
    ...
    template <typename T, typename MemoryBlock>
    inline bool p_dense_matrix<T, MemoryBlock>::automatic_reserve(size_type size1, size_type size2, T const& init_value = T())
    {
	...
	template <typename T, typename MemoryBlock>
    inline void p_dense_matrix<T, MemoryBlock>::serialize(alps::hdf5::iarchive & ar)
    {
	...
	template <typename T, typename MemoryBlock>
    inline void p_dense_matrix<T, MemoryBlock>::serialize(alps::hdf5::oarchive & ar) const
    {
		ar << alps::make_pvp("size1", size1_);
		ar << alps::make_pvp("size2", size2_);
		ar << alps::make_pvp("reserved_size1", reserved_size1_);
...
namespace blas {
    ...
    matrix_vector_multiply(p_dense_matrix<T,MemoryBlock> const& m, vector<T2,MemoryBlock2> const& v)
    {
        ...
        for(typename p_dense_matrix<T,MemoryBlock>::size_type i = 0; i < m.num_rows(); ++i)
        {
            for(typename p_dense_matrix<T,MemoryBlock>::size_type j=0; j <m.num_columns(); ++j)
            {
                result(i) += m(i,j) * v(j);
            }
        }
