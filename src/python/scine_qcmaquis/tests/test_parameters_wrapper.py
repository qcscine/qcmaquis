...
class TestParametersWrapper:
    def test_parameters_wrapper_hf_occupation(self):
    ...
    def test_parameters_wrapper_set_system(self):
        parameters = ParametersWrapper()
        norbs = 10
        nelec = 9
        spin = 3
    ...
    def test_parameters_wrapper_convenience_functions(self):
        parameters = ParametersWrapper()
    ...
    def test_parameters_wrapper_maquis_dump_files(self):
        parameters = ParametersWrapper()
