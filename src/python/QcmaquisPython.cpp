...
PYBIND11_MODULE(_dmrg, module) {
  using ComplexElectronicTranscorrelatedIntegralMap = chem::integral_map<
      std::complex<double>, chem::Hamiltonian::Electronic,
      chem::HamiltonianTransformation::Transcorrelated>;
  using RealElectronicTranscorrelatedIntegralMap = chem::integral_map<
      double, chem::Hamiltonian::Electronic,
      chem::HamiltonianTransformation::Transcorrelated>;
  ...
  py::class_<ComplexElectronicTranscorrelatedIntegralMap>(
      module, "ComplexTCIntegralMap"
  )
      .def(py::init<>())
      .def("set", &ComplexElectronicTranscorrelatedIntegralMap::set)
      .def(
          "at", [](ComplexElectronicTranscorrelatedIntegralMap& map,
                   const std::array<int, 6>& index,
                   double& value) { map.at(index) = value; }
      )
      .def(
          "at", [](const ComplexElectronicTranscorrelatedIntegralMap& map,
                   const std::array<int, 6>& index) { return &map.at(index); }
      )
      .def(
          "__getitem__",
          [](ComplexElectronicTranscorrelatedIntegralMap& map,
             const std::array<int, 6>& index) { return &map[index]; }
      )
      .def(
          "__setitem__",
          [](ComplexElectronicTranscorrelatedIntegralMap& map,
  ...
  py::class_<RealElectronicTranscorrelatedIntegralMap>(module, "TCIntegralMap")
      ...
      .def(
          "at", [](RealElectronicTranscorrelatedIntegralMap& map,
                   const std::array<int, 6>& index,
                   double& value) { map.at(index) = value; }
      )
      .def(
          "at", [](const RealElectronicTranscorrelatedIntegralMap& map,
                   const std::array<int, 6>& index) { return &map.at(index); }
      )
      .def(
          "__getitem__",
          [](RealElectronicTranscorrelatedIntegralMap& map,
             const std::array<int, 6>& index) { return &map[index]; }
      )
      .def(
          "__setitem__",
  ...
  py::class_<chem::integral_map<double>>(module, "IntegralMap")
      ...
      .def(
          "at",
          [](chem::integral_map<double>& map, const std::array<int, 4>& index,
             double& value) { map.at(index) = value; }
      )
      .def(
          "at", [](const chem::integral_map<double>& map,
  ...
  py::class_<chem::integral_map<std::complex<double>>>(
      module, "ComplexIntegralMap"
  )
      .def(py::init<>())
      .def("set", &chem::integral_map<std::complex<double>>::set)
      .def(
          "at", [](chem::integral_map<std::complex<double>>& map,
                   const std::array<int, 4>& index,
                   std::complex<double>& value) { map.at(index) = value; }
      )
      .def(
          "at", [](const chem::integral_map<std::complex<double>>& map,
                   const std::array<int, 4>& index) { return &map.at(index); }
      )
      .def(
          "__getitem__",
          [](chem::integral_map<std::complex<double>>& map,
             const std::array<int, 4>& index) { return &map[index]; }
      )
      .def(
          "__setitem__",
          [](chem::integral_map<std::complex<double>>& map,
  ...
  /* DmrgParameters */
  py::class_<DmrgParameters, BaseParameters>(module, "DmrgParameters")
      .def(py::init<>());

  // TODO: Make srcas work again
  //
  // /* Base Real Electronic SRCAS class */
  // py::class_<maquis::srcas::BaseSRCAS<double,
  // maquis::srcas::Determinant>>(module, "BaseRealElectronicSRCAS")
  //     .def("run", &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::Determinant>::run) .def("currentQueen",
  //     &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::Determinant>::currentQueen) .def("sampledTable",
  //     &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::Determinant>::sampledTable) .def("completeness",
  //     &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::Determinant>::completeness) .def("printSettings",
  //     &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::Determinant>::printSettings) .def("printResults",
  //     &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::Determinant>::printResults);
  // /* Real Electronic SRCAS */
  // py::class_<maquis::srcas::ElectronicSRCAS<double>,
  // maquis::srcas::BaseSRCAS<double, maquis::srcas::Determinant>>(
  //     module, "RealElectronicSRCAS")
  //     .def(py::init<DmrgParameters&,
  //     std::shared_ptr<maquis::DMRGInterface<double>>>());
  //
  // /* Base Complex Electronic SRCAS class */
  // py::class_<maquis::srcas::BaseSRCAS<std::complex<double>,
  // maquis::srcas::Determinant>>(module,
  //                                                                                        "BaseComplexElectronicSRCAS")
  //     .def("run", &maquis::srcas::BaseSRCAS<std::complex<double>,
  //     maquis::srcas::Determinant>::run) .def("currentQueen",
  //     &maquis::srcas::BaseSRCAS<std::complex<double>,
  //     maquis::srcas::Determinant>::currentQueen) .def("sampledTable",
  //     &maquis::srcas::BaseSRCAS<std::complex<double>,
  //     maquis::srcas::Determinant>::sampledTable) .def("completeness",
  //     &maquis::srcas::BaseSRCAS<std::complex<double>,
  ...
  // py::class_<maquis::srcas::ElectronicSRCAS<std::complex<double>>,
  // maquis::srcas::BaseSRCAS<std::complex<double>,
  // maquis::srcas::Determinant>>(
  //     module, "ComplexElectronicSRCAS")
  //     .def(py::init<DmrgParameters&,
  //     std::shared_ptr<maquis::DMRGInterface<std::complex<double>>>>());
  //
  // /* Base Real Electronic SRCAS class */
  // py::class_<maquis::srcas::BaseSRCAS<double, maquis::srcas::VibONV>>(module,
  // "BaseRealVibSRCAS")
  //     .def("run", &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::VibONV>::run) .def("currentQueen",
  //     &maquis::srcas::BaseSRCAS<double, maquis::srcas::VibONV>::currentQueen)
  //     .def("sampledTable", &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::VibONV>::sampledTable) .def("completeness",
  //     &maquis::srcas::BaseSRCAS<double, maquis::srcas::VibONV>::completeness)
  //     .def("printSettings", &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::VibONV>::printSettings) .def("printResults",
  //     &maquis::srcas::BaseSRCAS<double,
  //     maquis::srcas::VibONV>::printResults);
  ...
  // /* Base Complex Electronic SRCAS class */
  // py::class_<maquis::srcas::BaseSRCAS<std::complex<double>,
  // maquis::srcas::VibONV>>(module, "BaseComplexVibSRCAS")
  //     .def("run", &maquis::srcas::BaseSRCAS<std::complex<double>,
  //     maquis::srcas::VibONV>::run) .def("currentQueen",
  //     &maquis::srcas::BaseSRCAS<std::complex<double>,
  //     maquis::srcas::VibONV>::currentQueen) .def("sampledTable",
  //     &maquis::srcas::BaseSRCAS<std::complex<double>,
  //     maquis::srcas::VibONV>::sampledTable) .def("completeness",
  //     &maquis::srcas::BaseSRCAS<std::complex<double>,
  //     maquis::srcas::VibONV>::completeness) .def("printSettings",
  //     &maquis::srcas::BaseSRCAS<std::complex<double>,
  //     maquis::srcas::VibONV>::printSettings) .def("printResults",
  //     &maquis::srcas::BaseSRCAS<std::complex<double>,
  //     maquis::srcas::VibONV>::printResults);
  // /* Complex Vibrational SRCAS */
  // py::class_<maquis::srcas::VibSRCAS<std::complex<double>>>(module,
  // "ComplexVibrationalSRCAS")
  //     .def(py::init<DmrgParameters&,
  //     std::shared_ptr<maquis::DMRGInterface<std::complex<double>>>>());

  /* Real Electronic DMRG Interface */
  py::class_<
      maquis::DMRGInterface<double>,
      std::shared_ptr<maquis::DMRGInterface<double>>>(module, "DmrgReal")
      .def(py::init<DmrgParameters&>())
      ...
      .def(
          "update_integrals",
          py::overload_cast<const chem::integral_map<double>&>(
              &maquis::DMRGInterface<double>::update_integrals
          )
      )
      ...
      .def(
          ...
          &maquis::DMRGInterface<
              double, chem::Hamiltonian::Electronic>::measure_and_save_3rdm
      )
      .def(
  ...
  py::class_<
      ...
      .def(
          "get_last_sweep",
          &maquis::DMRGInterface<std::complex<double>>::get_last_sweep
      )
      .def(
          "run_measure",
          &maquis::DMRGInterface<std::complex<double>>::run_measure
      )
      ...
      .def(
          "update_integrals",
          py::overload_cast<const chem::integral_map<std::complex<double>>&>(
              &maquis::DMRGInterface<std::complex<double>>::update_integrals
          )
      )
      .def(
