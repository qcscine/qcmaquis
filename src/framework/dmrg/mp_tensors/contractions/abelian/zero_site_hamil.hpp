...
Engine<Matrix, OtherMatrix, SymmGroup, SymmType>::zerosite_hamil2(
...
template <class Matrix, class OtherMatrix, class SymmGroup, class SymmType>
block_matrix<Matrix, SymmGroup>
Engine<Matrix, OtherMatrix, SymmGroup, SymmType>::zerosite_hamil2_kernel(
    block_matrix<Matrix, SymmGroup> ket_bm,
    Boundary<OtherMatrix, SymmGroup> const& left,
    Boundary<OtherMatrix, SymmGroup> const& right,
    MPOTensor<Matrix, SymmGroup> const& mpo_left,
    MPOTensor<Matrix, SymmGroup> const& mpo_right, bool isHermitian
  ...
  BoundaryMPSProduct<Matrix, OtherMatrix, SymmGroup, abelian::Gemms> t(
      ket_bm, left, mpo_right, isHermitian, false
  );
