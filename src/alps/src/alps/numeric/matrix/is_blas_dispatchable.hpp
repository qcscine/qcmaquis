...
struct is_blas_dispatchable_helper
    : boost::mpl::and_<
          typename boost::mpl::and_<
              ...
              supports_blas<typename boost::remove_const<T2>::type> >::type,
          is_blas_dispatchable<
              typename T1::value_type, typename T2::value_type> >::type {};
...
struct is_blas_dispatchable_helper<T1, T2, Tag1, tag::scalar>
    : boost::mpl::and_<
          typename boost::mpl::and_<
              supports_blas<typename boost::remove_const<T1>::type>,
              supports_blas<typename boost::remove_const<T2>::type> >::type,
          is_blas_dispatchable<typename T1::value_type, T2> >::type {};
...
struct is_blas_dispatchable_helper<T1, T2, tag::scalar, Tag2>
    : boost::mpl::and_<
          typename boost::mpl::and_<
              supports_blas<typename boost::remove_const<T1>::type>,
              supports_blas<typename boost::remove_const<T2>::type> >::type,
          is_blas_dispatchable<T1, typename T2::value_type> >::type {};
...
template <typename T1, typename T2>
struct is_blas_dispatchable : is_blas_dispatchable_helper<
                                  T1, T2, typename get_entity<T1>::type,
                                  typename get_entity<T2>::type>::type {};
