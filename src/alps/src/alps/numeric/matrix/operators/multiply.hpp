...
struct multiply_return_type<T1, T2, tag::matrix, tag::vector> {
  typedef typename exchange_value_type<
      T2, typename detail::auto_deduce_multiply_return_type<
              typename T1::value_type, typename T2::value_type>::type>::type
      type;
};
...
template <typename T1, typename T2>
typename multiply_return_type_helper<T1, T2>::type operator*(
