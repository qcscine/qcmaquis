...
/* $Id: functional.h 7146 2013-09-22 09:07:28Z hehn $ */
...
struct conj_mult_return_type
    : ::alps::numeric::detail::auto_deduce_multiply_return_type<T1, T2> {};
...
struct conj_mult {
  /// \brief returns x*y
  typename conj_mult_return_type<T1, T2>::type operator()(
...
struct conj_mult<std::complex<T1>, T2> {
  ...
  typename conj_mult_return_type<std::complex<T1>, T2>::type operator()(
      const std::complex<T1>& a, const T2& b
  ) const {
    return std::conj(a) * b;
  }
};
