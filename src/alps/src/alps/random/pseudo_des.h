...
/* $Id: pseudo_des.h 3120 2009-02-25 15:57:16Z wistaria $ */
...
class pseudo_des {
 public:
  ...
  std::istream& read(std::istream& is) { return is >> seed_ >> state_; }

  /// check whether the initial seed and current state of two generators is the
  /// same
