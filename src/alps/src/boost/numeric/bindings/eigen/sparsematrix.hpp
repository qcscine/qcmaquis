...
struct adaptor<Eigen::SparseMatrix<T, Flags>, Id, Enable> {
  ...
  static value_type* begin_value(Id& id) { return id._valuePtr(); }
  ...
  static index_type* begin_index_minor(Id& id) { return id._innerIndexPtr(); }
