...
//
inline void copy(
    const fortran_int_t n, const double* x, const fortran_int_t incx, double* y,
    const fortran_int_t incy
) {
...
inline void copy(
    ...
    const fortran_int_t incx, std::complex<float>* y, const fortran_int_t incy
) {
...
inline void copy(
    ...
    const fortran_int_t incx, std::complex<double>* y, const fortran_int_t incy
) {
...
//
template <typename VectorX, typename VectorY>
inline typename copy_impl<
    typename bindings::value_type<VectorX>::type>::result_type
copy(const VectorX& x, VectorY& y) {
  copy_impl<typename bindings::value_type<VectorX>::type>::invoke(x, y);
}
