...
typename boost::enable_if<
    is_complex<typename bindings::value_type<VectorW>::type>, void>::type
interlace(VectorW& w) {
...
struct real_part_view {
  typedef typename bindings::result_of::vector_view<
      typename bindings::remove_imaginary<
          typename bindings::value_type<VectorW>::type>::type>::type type;
};
...
template <typename VectorW>
typename boost::enable_if<
    is_complex<typename bindings::value_type<VectorW>::type>,
