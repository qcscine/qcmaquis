...
inline std::ptrdiff_t gesv(
    Order, const int n, const int nrhs, float* a, const int lda, int* ipiv,
    float* b, const int ldb
) {
  return clapack_sgesv(
      clapack_option<Order>::value, n, nrhs, a, lda, ipiv, b, ldb
  );
}
...
template <typename Order>
inline std::ptrdiff_t gesv(
    Order, const int n, const int nrhs, double* a, const int lda, int* ipiv,
    double* b, const int ldb
) {
  return clapack_dgesv(
      clapack_option<Order>::value, n, nrhs, a, lda, ipiv, b, ldb
  );
}
...
template <typename Order>
inline std::ptrdiff_t gesv(
    Order, const int n, const int nrhs, std::complex<float>* a, const int lda,
    int* ipiv, std::complex<float>* b, const int ldb
) {
  return clapack_cgesv(
      clapack_option<Order>::value, n, nrhs, a, lda, ipiv, b, ldb
  );
}
...
template <typename Order>
inline std::ptrdiff_t gesv(
    Order, const int n, const int nrhs, std::complex<double>* a, const int lda,
    int* ipiv, std::complex<double>* b, const int ldb
) {
  return clapack_zgesv(
      clapack_option<Order>::value, n, nrhs, a, lda, ipiv, b, ldb
  );
}
...
template <typename Order>
inline std::ptrdiff_t gesv(
    Order, const fortran_int_t n, const fortran_int_t nrhs, float* a,
...
template <typename Order>
inline std::ptrdiff_t gesv(
    Order, const fortran_int_t n, const fortran_int_t nrhs, double* a,
...
template <typename Order>
inline std::ptrdiff_t gesv(
    Order, const fortran_int_t n, const fortran_int_t nrhs,
...
struct gesv_impl {
  ...
  static std::ptrdiff_t invoke(MatrixA& a, VectorIPIV& ipiv, MatrixB& b) {
    ...
    return detail::gesv(
        order(), bindings::size_column(a), bindings::size_column(b),
...
inline std::ptrdiff_t gesv(MatrixA& a, VectorIPIV& ipiv, MatrixB& b) {
  return gesv_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, ipiv, b
  );
}
