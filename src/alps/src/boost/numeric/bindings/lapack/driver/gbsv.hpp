...
inline std::ptrdiff_t gbsv(
    ...
    fortran_int_t* ipiv, std::complex<float>* b, const fortran_int_t ldb
) {
  fortran_int_t info(0);
...
inline std::ptrdiff_t gbsv(
    ...
    const fortran_int_t ldab, fortran_int_t* ipiv, std::complex<double>* b,
...
inline std::ptrdiff_t gbsv(MatrixAB& ab, VectorIPIV& ipiv, MatrixB& b) {
  return gbsv_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      ab, ipiv, b
  );
}
