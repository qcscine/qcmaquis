...
inline std::ptrdiff_t ggglm(
    ...
    const fortran_int_t ldb, std::complex<float>* d, std::complex<float>* x,
    std::complex<float>* y, std::complex<float>* work, const fortran_int_t lwork
) {
  fortran_int_t info(0);
...
inline std::ptrdiff_t ggglm(
    ...
    const fortran_int_t ldb, std::complex<double>* d, std::complex<double>* x,
...
struct ggglm_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename VectorD, typename VectorX,
      typename VectorY, typename WORK>
  static std::ptrdiff_t invoke(
      MatrixA& a, MatrixB& b, VectorD& d, VectorX& x, VectorY& y,
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::ggglm(
        ...
        bindings::stride_major(a), bindings::begin_value(b),
        bindings::stride_major(b), bindings::begin_value(d),
        bindings::begin_value(x), bindings::begin_value(y), &opt_size_work, -1
    );
...
template <
    typename MatrixA, typename MatrixB, typename VectorD, typename VectorX,
    typename VectorY, typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
ggglm(
    MatrixA& a, MatrixB& b, VectorD& d, VectorX& x, VectorY& y, Workspace work
) {
  return ggglm_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, b, d, x, y, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<VectorY>, std::ptrdiff_t>::type
ggglm(MatrixA& a, MatrixB& b, VectorD& d, VectorX& x, VectorY& y) {
  return ggglm_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, b, d, x, y, optimal_workspace()
  );
}
