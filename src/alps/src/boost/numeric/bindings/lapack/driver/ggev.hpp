...
inline std::ptrdiff_t ggev(
    ...
    const fortran_int_t lda, double* b, const fortran_int_t ldb, double* alphar,
    double* alphai, double* beta, double* vl, const fortran_int_t ldvl,
...
//
inline std::ptrdiff_t ggev(
    const char jobvl, const char jobvr, const fortran_int_t n,
    std::complex<float>* a, const fortran_int_t lda, std::complex<float>* b,
  ...
  fortran_int_t info(0);
  LAPACK_CGGEV(
      &jobvl, &jobvr, &n, a, &lda, b, &ldb, alpha, beta, vl, &ldvl, vr, &ldvr,
...
inline std::ptrdiff_t ggev(
    const char jobvl, const char jobvr, const fortran_int_t n,
    std::complex<double>* a, const fortran_int_t lda, std::complex<double>* b,
...
struct ggev_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobvl, const char jobvr, MatrixA& a, MatrixB& b,
      VectorALPHAR& alphar, VectorALPHAI& alphai, VectorBETA& beta,
      MatrixVL& vl, MatrixVR& vr, detail::workspace1<WORK> work
  ) {
    ...
    return detail::ggev(
        jobvl, jobvr, bindings::size_column(a), bindings::begin_value(a),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobvl, jobvr, a, b, alphar, alphai, beta, vl, vr, workspace(tmp_work)
    );
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::ggev(
        ...
        bindings::begin_value(alphai), bindings::begin_value(beta),
        bindings::begin_value(vl), bindings::stride_major(vl),
        bindings::begin_value(vr), bindings::stride_major(vr), &opt_size_work,
        -1
    );
    bindings::detail::array<real_type> tmp_work(
...
struct ggev_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  template <
      ...
      typename VectorBETA, typename MatrixVL, typename MatrixVR, typename WORK,
      typename RWORK>
  static std::ptrdiff_t invoke(
      const char jobvl, const char jobvr, MatrixA& a, MatrixB& b,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobvl, jobvr, a, b, alpha, beta, vl, vr, workspace(tmp_work, tmp_rwork)
    );
  }
...
ggev(
    const char jobvl, const char jobvr, MatrixA& a, MatrixB& b,
    VectorALPHAR& alphar, VectorALPHAI& alphai, VectorBETA& beta, MatrixVL& vl,
    MatrixVR& vr, Workspace work
) {
  return ggev_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvl, jobvr, a, b, alphar, alphai, beta, vl, vr, work
  );
}
...
ggev(
  ...
  return ggev_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvl, jobvr, a, b, alphar, alphai, beta, vl, vr, optimal_workspace()
  );
}
//
// Overloaded function for ggev. Its overload differs for
...
ggev(
  ...
  return ggev_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvl, jobvr, a, b, alpha, beta, vl, vr, work
  );
}
...
ggev(
  ...
  return ggev_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvl, jobvr, a, b, alpha, beta, vl, vr, optimal_workspace()
  );
}
