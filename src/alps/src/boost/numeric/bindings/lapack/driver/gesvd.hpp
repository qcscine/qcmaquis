...
inline std::ptrdiff_t gesvd(
    ...
    float* s, std::complex<float>* u, const fortran_int_t ldu,
    std::complex<float>* vt, const fortran_int_t ldvt,
...
inline std::ptrdiff_t gesvd(
    ...
    double* s, std::complex<double>* u, const fortran_int_t ldu,
...
struct gesvd_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobu, const char jobvt, MatrixA& a, VectorS& s, MatrixU& u,
      MatrixVT& vt, detail::workspace1<WORK> work
  ) {
    ...
    BOOST_ASSERT(
        ...
        min_size_work(
            jobu, jobvt, bindings::size_row(a), bindings::size_column(a)
        )
    );
    ...
    BOOST_ASSERT(jobu == 'A' || jobu == 'S' || jobu == 'O' || jobu == 'N');
    BOOST_ASSERT(jobvt == 'A' || jobvt == 'S' || jobvt == 'O' || jobvt == 'N');
    return detail::gesvd(
        jobu, jobvt, bindings::size_row(a), bindings::size_column(a),
  ...
  static std::ptrdiff_t min_size_work(
      const char jobu, const char jobvt, const std::ptrdiff_t m,
...
struct gesvd_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobu, const char jobvt, MatrixA& a, VectorS& s, MatrixU& u,
      MatrixVT& vt, detail::workspace2<WORK, RWORK> work
  ) {
    namespace bindings = ::boost::numeric::bindings;
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixA>::value));
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixU>::value));
    ...
    BOOST_ASSERT(
        bindings::size(work.select(real_type())) >= min_size_rwork(minmn)
    );
    BOOST_ASSERT(
        bindings::size(work.select(value_type())) >=
        min_size_work(
            jobu, jobvt, bindings::size_row(a), bindings::size_column(a), minmn
        )
    );
    BOOST_ASSERT(bindings::size_column(a) >= 0);
    BOOST_ASSERT(
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(jobu, jobvt, a, s, u, vt, workspace(tmp_work, tmp_rwork));
  }
...
gesvd(
  ...
  return gesvd_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobu, jobvt, a, s, u, vt, work
  );
}
...
gesvd(
  ...
  return gesvd_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobu, jobvt, a, s, u, vt, optimal_workspace()
  );
}
