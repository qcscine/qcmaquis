...
inline std::ptrdiff_t heevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    float* a, const fortran_int_t lda, const float vl, const float vu,
  ...
  LAPACK_SSYEVX(
      &jobz, &range, &lapack_option<UpLo>::value, &n, a, &lda, &vl, &vu, &il,
...
inline std::ptrdiff_t heevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    double* a, const fortran_int_t lda, const double vl, const double vu,
...
inline std::ptrdiff_t heevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    std::complex<float>* a, const fortran_int_t lda, const float vl,
...
inline std::ptrdiff_t heevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    std::complex<double>* a, const fortran_int_t lda, const double vl,
    const double vu, const fortran_int_t il, const fortran_int_t iu,
    const double abstol, fortran_int_t& m, double* w, std::complex<double>* z,
...
struct heevx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename VectorW, typename MatrixZ,
      typename VectorIFAIL, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobz, const char range, MatrixA& a, const real_type vl,
      const real_type vu, const fortran_int_t il, const fortran_int_t iu,
      const real_type abstol, fortran_int_t& m, VectorW& w, MatrixZ& z,
      VectorIFAIL& ifail, detail::workspace2<WORK, IWORK> work
  ) {
    ...
    return detail::heevx(
        jobz, range, uplo(), bindings::size_column(a), bindings::begin_value(a),
        bindings::stride_major(a), vl, vu, il, iu, abstol, m,
  ...
  static std::ptrdiff_t invoke(
      ...
      const real_type vu, const fortran_int_t il, const fortran_int_t iu,
      const real_type abstol, fortran_int_t& m, VectorW& w, MatrixZ& z,
      VectorIFAIL& ifail, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
    ...
    return invoke(
        jobz, range, a, vl, vu, il, iu, abstol, m, w, z, ifail,
  ...
  static std::ptrdiff_t invoke(
      ...
      const real_type vu, const fortran_int_t il, const fortran_int_t iu,
      const real_type abstol, fortran_int_t& m, VectorW& w, MatrixZ& z,
      VectorIFAIL& ifail, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
    ...
    detail::heevx(
        ...
        bindings::begin_value(tmp_iwork), bindings::begin_value(ifail)
    );
    bindings::detail::array<real_type> tmp_work(
...
struct heevx_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  template <
      typename MatrixA, typename VectorW, typename MatrixZ,
      typename VectorIFAIL, typename WORK, typename RWORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobz, const char range, MatrixA& a, const real_type vl,
      const real_type vu, const fortran_int_t il, const fortran_int_t iu,
      const real_type abstol, fortran_int_t& m, VectorW& w, MatrixZ& z,
      VectorIFAIL& ifail, detail::workspace3<WORK, RWORK, IWORK> work
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixA>::value));
...
//
template <
    typename MatrixA, typename VectorW, typename MatrixZ, typename VectorIFAIL,
    typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
heevx(
    const char jobz, const char range, MatrixA& a,
  ...
  return heevx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobz, range, a, vl, vu, il, iu, abstol, m, w, z, ifail, work
  );
}
