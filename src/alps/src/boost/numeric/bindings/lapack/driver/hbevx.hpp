...
inline std::ptrdiff_t hbevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    const fortran_int_t kd, float* ab, const fortran_int_t ldab, float* q,
  ...
  LAPACK_SSBEVX(
      &jobz, &range, &lapack_option<UpLo>::value, &n, &kd, ab, &ldab, q, &ldq,
...
inline std::ptrdiff_t hbevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    const fortran_int_t kd, double* ab, const fortran_int_t ldab, double* q,
...
inline std::ptrdiff_t hbevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    const fortran_int_t kd, std::complex<float>* ab, const fortran_int_t ldab,
...
inline std::ptrdiff_t hbevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    const fortran_int_t kd, std::complex<double>* ab, const fortran_int_t ldab,
...
struct hbevx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAB, typename MatrixQ, typename VectorW, typename MatrixZ,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobz, range, ab, q, vl, vu, il, iu, abstol, m, w, z, ifail,
...
hbevx(
  ...
  return hbevx_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      jobz, range, ab, q, vl, vu, il, iu, abstol, m, w, z, ifail, work
  );
}
