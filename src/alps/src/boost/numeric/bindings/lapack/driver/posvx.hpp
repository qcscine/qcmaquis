...
inline std::ptrdiff_t posvx(
    const char fact, const UpLo, const fortran_int_t n,
  ...
  LAPACK_SPOSVX(
      &fact, &lapack_option<UpLo>::value, &n, &nrhs, a, &lda, af, &ldaf, &equed,
...
inline std::ptrdiff_t posvx(
    ...
    std::complex<float>* af, const fortran_int_t ldaf, char& equed, float* s,
...
inline std::ptrdiff_t posvx(
    ...
    std::complex<double>* af, const fortran_int_t ldaf, char& equed, double* s,
    std::complex<double>* b, const fortran_int_t ldb, std::complex<double>* x,
...
struct posvx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixAF, typename VectorS, typename MatrixB,
      typename MatrixX, typename VectorFERR, typename VectorBERR, typename WORK,
      typename IWORK>
  static std::ptrdiff_t invoke(
      const char fact, MatrixA& a, MatrixAF& af, char& equed, VectorS& s,
    ...
    return detail::posvx(
        fact, uplo(), bindings::size_column(a), bindings::size_column(b),
        bindings::begin_value(a), bindings::stride_major(a),
        bindings::begin_value(af), bindings::stride_major(af), equed,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        fact, a, af, equed, s, b, x, rcond, ferr, berr,
  ...
  static std::ptrdiff_t invoke(
    ...
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
    return invoke(
        fact, a, af, equed, s, b, x, rcond, ferr, berr, minimal_workspace()
    );
  }
...
posvx(
  ...
  return posvx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      fact, a, af, equed, s, b, x, rcond, ferr, berr, work
  );
}
...
posvx(
  ...
  return posvx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      fact, a, af, equed, s, b, x, rcond, ferr, berr, optimal_workspace()
  );
}
