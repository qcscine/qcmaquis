...
spev(const char jobz, MatrixAP& ap, VectorW& w, MatrixZ& z, Workspace work) {
  return spev_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      jobz, ap, w, z, work
  );
}
