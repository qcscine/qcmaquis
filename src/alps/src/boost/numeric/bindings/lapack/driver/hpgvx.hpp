...
inline std::ptrdiff_t hpgvx(
    const fortran_int_t itype, const char jobz, const char range, const UpLo,
    const fortran_int_t n, float* ap, float* bp, const float vl, const float vu,
  ...
  LAPACK_SSPGVX(
      &itype, &jobz, &range, &lapack_option<UpLo>::value, &n, ap, bp, &vl, &vu,
...
inline std::ptrdiff_t hpgvx(
    const fortran_int_t itype, const char jobz, const char range, const UpLo,
    const fortran_int_t n, double* ap, double* bp, const double vl,
...
inline std::ptrdiff_t hpgvx(
    const fortran_int_t itype, const char jobz, const char range, const UpLo,
    const fortran_int_t n, std::complex<float>* ap, std::complex<float>* bp,
    const float vl, const float vu, const fortran_int_t il,
    const fortran_int_t iu, const float abstol, fortran_int_t& m, float* w,
    std::complex<float>* z, const fortran_int_t ldz, std::complex<float>* work,
...
inline std::ptrdiff_t hpgvx(
    const fortran_int_t itype, const char jobz, const char range, const UpLo,
    const fortran_int_t n, std::complex<double>* ap, std::complex<double>* bp,
...
struct hpgvx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAP, typename MatrixBP, typename VectorW, typename MatrixZ,
  ...
  static std::ptrdiff_t invoke(
      ...
      MatrixAP& ap, MatrixBP& bp, const real_type vl, const real_type vu,
    ...
    return detail::hpgvx(
        itype, jobz, range, uplo(), bindings::size_column(ap),
        bindings::begin_value(ap), bindings::begin_value(bp), vl, vu, il, iu,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        itype, jobz, range, ap, bp, vl, vu, il, iu, abstol, m, w, z, ifail,
...
hpgvx(
    const fortran_int_t itype, const char jobz, const char range, MatrixAP& ap,
    MatrixBP& bp,
  ...
  return hpgvx_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      itype, jobz, range, ap, bp, vl, vu, il, iu, abstol, m, w, z, ifail, work
  );
}
