...
inline std::ptrdiff_t gbsvx(
    const char fact, const Trans, const fortran_int_t n, const fortran_int_t kl,
  ...
  LAPACK_SGBSVX(
      &fact, &lapack_option<Trans>::value, &n, &kl, &ku, &nrhs, ab, &ldab, afb,
      &ldafb, ipiv, &equed, r, c, b, &ldb, x, &ldx, &rcond, ferr, berr, work,
      iwork, &info
  );
  return info;
}
...
inline std::ptrdiff_t gbsvx(
    const char fact, const Trans, const fortran_int_t n, const fortran_int_t kl,
    const fortran_int_t ku, const fortran_int_t nrhs, std::complex<float>* ab,
    ...
    std::complex<float>* x, const fortran_int_t ldx, float& rcond, float* ferr,
...
inline std::ptrdiff_t gbsvx(
    const char fact, const Trans, const fortran_int_t n, const fortran_int_t kl,
    const fortran_int_t ku, const fortran_int_t nrhs, std::complex<double>* ab,
...
struct gbsvx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAB, typename MatrixAFB, typename VectorIPIV,
  ...
  static std::ptrdiff_t invoke(
      const char fact, MatrixAB& ab, MatrixAFB& afb, VectorIPIV& ipiv,
    ...
    BOOST_ASSERT(
        ...
        std::max<std::ptrdiff_t>(1, bindings::size_column_op(ab, trans()))
    );
    BOOST_ASSERT(
    ...
    return detail::gbsvx(
        fact, trans(), bindings::size_column_op(ab, trans()),
        bindings::bandwidth_lower_op(ab, trans()),
        (bindings::bandwidth_upper_op(ab, trans()) -
         bindings::bandwidth_lower_op(ab, trans())),
        bindings::size_column(b), bindings::begin_value(ab),
        bindings::stride_major(ab), bindings::begin_value(afb),
        bindings::stride_major(afb), bindings::begin_value(ipiv), equed,
  ...
  static std::ptrdiff_t invoke(
      const char fact, MatrixAB& ab, MatrixAFB& afb, VectorIPIV& ipiv,
      char& equed, VectorR& r, VectorC& c, MatrixB& b, MatrixX& x,
      real_type& rcond, VectorFERR& ferr, VectorBERR& berr, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::data_order<MatrixAFB>::type order;
    typedef typename result_of::trans_tag<MatrixAB, order>::type trans;
    ...
    return invoke(
        fact, ab, afb, ipiv, equed, r, c, b, x, rcond, ferr, berr,
  ...
  static std::ptrdiff_t invoke(
      const char fact, MatrixAB& ab, MatrixAFB& afb, VectorIPIV& ipiv,
      char& equed, VectorR& r, VectorC& c, MatrixB& b, MatrixX& x,
      real_type& rcond, VectorFERR& ferr, VectorBERR& berr, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::data_order<MatrixAFB>::type order;
    typedef typename result_of::trans_tag<MatrixAB, order>::type trans;
...
gbsvx(
  ...
  return gbsvx_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      fact, ab, afb, ipiv, equed, r, c, b, x, rcond, ferr, berr, work
  );
}
