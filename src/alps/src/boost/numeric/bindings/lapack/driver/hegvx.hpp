...
inline std::ptrdiff_t hegvx(
  ...
  LAPACK_SSYGVX(
      &itype, &jobz, &range, &lapack_option<UpLo>::value, &n, a, &lda, b, &ldb,
...
struct hegvx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename VectorW, typename MatrixZ,
      typename VectorIFAIL, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const fortran_int_t itype, const char jobz, const char range, MatrixA& a,
    ...
    return detail::hegvx(
        itype, jobz, range, uplo(), bindings::size_column(a),
        bindings::begin_value(a), bindings::stride_major(a),
        bindings::begin_value(b), bindings::stride_major(b), vl, vu, il, iu,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        itype, jobz, range, a, b, vl, vu, il, iu, abstol, m, w, z, ifail,
...
hegvx(
  ...
  return hegvx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      itype, jobz, range, a, b, vl, vu, il, iu, abstol, m, w, z, ifail, work
  );
}
