...
inline std::ptrdiff_t gejsv(
  ...
  LAPACK_SGEJSV(
      &joba, &jobu, &jobv, &jobr, &jobt, &jobp, &m, &n, a, &lda, sva, u, &ldu,
...
struct gejsv_impl {
  ...
  //
  template <
      typename MatrixA, typename VectorSVA, typename MatrixU, typename MatrixV,
      typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const char joba, const char jobu, const char jobv, const char jobr,
      const char jobt, const char jobp, MatrixA& a, VectorSVA& sva, MatrixU& u,
    ...
    BOOST_STATIC_ASSERT(
        (std::is_same<
            ...
            typename remove_const<
                typename bindings::value_type<VectorSVA>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (std::is_same<
            typename remove_const<
    ...
    BOOST_ASSERT(
        ...
        min_size_iwork(bindings::size_row(a), bindings::size_column(a))
    );
    BOOST_ASSERT(
        bindings::size(work.select(real_type())) >=
        min_size_work(
            joba, jobu, jobv, bindings::size_row(a), bindings::size_column(a)
        )
    );
    BOOST_ASSERT(
    ...
    return detail::gejsv(
        joba, jobu, jobv, jobr, jobt, jobp, bindings::size_row(a),
        bindings::size_column(a), bindings::begin_value(a),
        bindings::stride_major(a), bindings::begin_value(sva),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        joba, jobu, jobv, jobr, jobt, jobp, a, sva, u, v,
  ...
  static std::ptrdiff_t invoke(
    ...
    namespace bindings = ::boost::numeric::bindings;
    return invoke(
        joba, jobu, jobv, jobr, jobt, jobp, a, sva, u, v, minimal_workspace()
    );
  }
  ...
  static std::ptrdiff_t min_size_work(
      const char joba, const char jobu, const char jobv, const std::ptrdiff_t m,
      const std::ptrdiff_t n
  ) {
    if (jobu == 'N' && jobv == 'N') {
      if (joba != 'E' && joba != 'G')
        return std::max<std::ptrdiff_t>(
            std::max<std::ptrdiff_t>(2 * m + n, 4 * n + 1), 7
        );
      else
        return std::max<std::ptrdiff_t>(
            std::max<std::ptrdiff_t>(2 * m + n, n * n + 4 * n), 7
        );
...
gejsv(
    const char joba, const char jobu, const char jobv, const char jobr,
    const char jobt, const char jobp, MatrixA& a, VectorSVA& sva, MatrixU& u,
    MatrixV& v, Workspace work
) {
  return gejsv_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      joba, jobu, jobv, jobr, jobt, jobp, a, sva, u, v, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<MatrixV>, std::ptrdiff_t>::type
gejsv(
    const char joba, const char jobu, const char jobv, const char jobr,
    const char jobt, const char jobp, MatrixA& a, VectorSVA& sva, MatrixU& u,
    MatrixV& v
  ...
  return gejsv_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      joba, jobu, jobv, jobr, jobt, jobp, a, sva, u, v, optimal_workspace()
  );
}
