...
inline std::ptrdiff_t gglse(
    ...
    const fortran_int_t ldb, std::complex<float>* c, std::complex<float>* d,
    std::complex<float>* x, std::complex<float>* work, const fortran_int_t lwork
) {
  fortran_int_t info(0);
...
inline std::ptrdiff_t gglse(
    ...
    const fortran_int_t ldb, std::complex<double>* c, std::complex<double>* d,
...
struct gglse_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename VectorC, typename VectorD,
      typename VectorX, typename WORK>
  static std::ptrdiff_t invoke(
      MatrixA& a, MatrixB& b, VectorC& c, VectorD& d, VectorX& x,
    ...
    return detail::gglse(
        bindings::size_row(a), bindings::size_column(a), bindings::size_row(b),
        bindings::begin_value(a), bindings::stride_major(a),
        bindings::begin_value(b), bindings::stride_major(b),
        bindings::begin_value(c), bindings::begin_value(d),
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::gglse(
        ...
        bindings::begin_value(b), bindings::stride_major(b),
        bindings::begin_value(c), bindings::begin_value(d),
        bindings::begin_value(x), &opt_size_work, -1
    );
  ...
  static std::ptrdiff_t min_size_work(
      const std::ptrdiff_t m, const std::ptrdiff_t n, const std::ptrdiff_t p
  ) {
...
template <
    typename MatrixA, typename MatrixB, typename VectorC, typename VectorD,
    typename VectorX, typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
gglse(
    MatrixA& a, MatrixB& b, VectorC& c, VectorD& d, VectorX& x, Workspace work
) {
  return gglse_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, b, c, d, x, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<VectorX>, std::ptrdiff_t>::type
gglse(MatrixA& a, MatrixB& b, VectorC& c, VectorD& d, VectorX& x) {
  return gglse_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, b, c, d, x, optimal_workspace()
  );
}
