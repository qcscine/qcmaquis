...
inline std::ptrdiff_t hbgvx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    const fortran_int_t ka, const fortran_int_t kb, float* ab,
    const fortran_int_t ldab, float* bb, const fortran_int_t ldbb, float* q,
  ...
  LAPACK_SSBGVX(
      &jobz, &range, &lapack_option<UpLo>::value, &n, &ka, &kb, ab, &ldab, bb,
...
inline std::ptrdiff_t hbgvx(
    ...
    const fortran_int_t ldab, double* bb, const fortran_int_t ldbb, double* q,
...
inline std::ptrdiff_t hbgvx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    const fortran_int_t ka, const fortran_int_t kb, std::complex<float>* ab,
    const fortran_int_t ldab, std::complex<float>* bb, const fortran_int_t ldbb,
    std::complex<float>* q, const fortran_int_t ldq, const float vl,
    const float vu, const fortran_int_t il, const fortran_int_t iu,
    const float abstol, fortran_int_t& m, float* w, std::complex<float>* z,
...
inline std::ptrdiff_t hbgvx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    const fortran_int_t ka, const fortran_int_t kb, std::complex<double>* ab,
    const fortran_int_t ldab, std::complex<double>* bb,
    const fortran_int_t ldbb, std::complex<double>* q, const fortran_int_t ldq,
...
struct hbgvx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAB, typename MatrixBB, typename MatrixQ, typename VectorW,
      typename MatrixZ, typename VectorIFAIL, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobz, const char range, MatrixAB& ab, MatrixBB& bb, MatrixQ& q,
      const real_type vl, const real_type vu, const fortran_int_t il,
      const fortran_int_t iu, const real_type abstol, fortran_int_t& m,
    ...
    BOOST_STATIC_ASSERT(
        (std::is_same<
            ...
            typename remove_const<
                typename bindings::value_type<MatrixBB>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (std::is_same<
            typename remove_const<
    ...
    BOOST_ASSERT(
        bindings::size_minor(bb) == 1 || bindings::stride_minor(bb) == 1
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(
        bindings::stride_major(bb) >= bindings::bandwidth(bb, uplo()) + 1
    );
    BOOST_ASSERT(jobz == 'N' || jobz == 'V');
    BOOST_ASSERT(range == 'A' || range == 'V' || range == 'I');
    return detail::hbgvx(
        jobz, range, uplo(), bindings::size_column(ab),
        bindings::bandwidth(ab, uplo()), bindings::bandwidth(bb, uplo()),
        bindings::begin_value(ab), bindings::stride_major(ab),
        bindings::begin_value(bb), bindings::stride_major(bb),
        bindings::begin_value(q), bindings::stride_major(q), vl, vu, il, iu,
        abstol, m, bindings::begin_value(w), bindings::begin_value(z),
  ...
  static std::ptrdiff_t invoke(
      ...
      const real_type vl, const real_type vu, const fortran_int_t il,
      const fortran_int_t iu, const real_type abstol, fortran_int_t& m,
      VectorW& w, MatrixZ& z, VectorIFAIL& ifail, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAB>::type uplo;
    ...
    return invoke(
        jobz, range, ab, bb, q, vl, vu, il, iu, abstol, m, w, z, ifail,
  ...
  static std::ptrdiff_t invoke(
      ...
      const real_type vl, const real_type vu, const fortran_int_t il,
      const fortran_int_t iu, const real_type abstol, fortran_int_t& m,
      VectorW& w, MatrixZ& z, VectorIFAIL& ifail, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAB>::type uplo;
    return invoke(
  ...
  //
  static std::ptrdiff_t min_size_work(const std::ptrdiff_t n) { return 7 * n; }
...
struct hbgvx_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  template <
      typename MatrixAB, typename MatrixBB, typename MatrixQ, typename VectorW,
      typename MatrixZ, typename VectorIFAIL, typename WORK, typename RWORK,
      typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobz, const char range, MatrixAB& ab, MatrixBB& bb, MatrixQ& q,
      const real_type vl, const real_type vu, const fortran_int_t il,
  ...
  //
  static std::ptrdiff_t min_size_rwork(const std::ptrdiff_t n) { return 7 * n; }
...
hbgvx(
    ...
    fortran_int_t& m, VectorW& w, MatrixZ& z, VectorIFAIL& ifail, Workspace work
) {
  return hbgvx_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      jobz, range, ab, bb, q, vl, vu, il, iu, abstol, m, w, z, ifail, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<VectorIFAIL>, std::ptrdiff_t>::type
hbgvx(
    const char jobz, const char range, MatrixAB& ab, MatrixBB& bb, MatrixQ& q,
    const typename remove_imaginary<
        typename bindings::value_type<MatrixAB>::type>::type vl,
