...
inline std::ptrdiff_t geev(
    ...
    std::complex<float>* a, const fortran_int_t lda, std::complex<float>* w,
    std::complex<float>* vl, const fortran_int_t ldvl, std::complex<float>* vr,
...
inline std::ptrdiff_t geev(
    const char jobvl, const char jobvr, const fortran_int_t n,
    std::complex<double>* a, const fortran_int_t lda, std::complex<double>* w,
...
struct geev_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobvl, const char jobvr, MatrixA& a, VectorWR& wr,
      VectorWI& wi, MatrixVL& vl, MatrixVR& vr, detail::workspace1<WORK> work
  ) {
  ...
  static std::ptrdiff_t invoke(
      const char jobvl, const char jobvr, MatrixA& a, VectorWR& wr,
      VectorWI& wi, MatrixVL& vl, MatrixVR& vr, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    bindings::detail::array<real_type> tmp_work(
        min_size_work(jobvl, jobvr, bindings::size_column(a))
    );
    return invoke(jobvl, jobvr, a, wr, wi, vl, vr, workspace(tmp_work));
  }
  ...
  static std::ptrdiff_t invoke(
      const char jobvl, const char jobvr, MatrixA& a, VectorWR& wr,
      VectorWI& wi, MatrixVL& vl, MatrixVR& vr, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
  ...
  static std::ptrdiff_t min_size_work(
      const char jobvl, const char jobvr, const std::ptrdiff_t n
  ) {
    if (jobvl == 'V' || jobvr == 'V')
...
struct geev_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobvl, const char jobvr, MatrixA& a, VectorW& w, MatrixVL& vl,
      MatrixVR& vr, detail::workspace2<WORK, RWORK> work
  ) {
    namespace bindings = ::boost::numeric::bindings;
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixA>::value));
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixVL>::value));
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(jobvl, jobvr, a, w, vl, vr, workspace(tmp_work, tmp_rwork));
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::geev(
        ...
        -1, bindings::begin_value(tmp_rwork)
    );
    bindings::detail::array<value_type> tmp_work(
        traits::detail::to_int(opt_size_work)
    );
...
geev(
    const char jobvl, const char jobvr, MatrixA& a, VectorWR& wr, VectorWI& wi,
    MatrixVL& vl, MatrixVR& vr, Workspace work
) {
  return geev_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvl, jobvr, a, wr, wi, vl, vr, work
  );
}
...
geev(
  ...
  return geev_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvl, jobvr, a, wr, wi, vl, vr, optimal_workspace()
  );
}
//
// Overloaded function for geev. Its overload differs for
...
geev(
  ...
  return geev_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvl, jobvr, a, w, vl, vr, optimal_workspace()
  );
}
