...
inline std::ptrdiff_t heevr(
    ...
    const fortran_int_t ldz, fortran_int_t* isuppz, std::complex<float>* work,
  ...
  LAPACK_CHEEVR(
      &jobz, &range, &lapack_option<UpLo>::value, &n, a, &lda, &vl, &vu, &il,
      &iu, &abstol, &m, w, z, &ldz, isuppz, work, &lwork, rwork, &lrwork, iwork,
      &liwork, &info
  );
  return info;
}
...
inline std::ptrdiff_t heevr(
    ...
    const fortran_int_t ldz, fortran_int_t* isuppz, std::complex<double>* work,
...
struct heevr_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      ...
      VectorISUPPZ& isuppz, detail::workspace2<WORK, IWORK> work
  ) {
  ...
  static std::ptrdiff_t invoke(
      ...
      const real_type vu, const fortran_int_t il, const fortran_int_t iu,
      const real_type abstol, fortran_int_t& m, VectorW& w, MatrixZ& z,
      VectorISUPPZ& isuppz, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
    ...
    return invoke(
        jobz, range, a, vl, vu, il, iu, abstol, m, w, z, isuppz,
  ...
  static std::ptrdiff_t invoke(
      ...
      const real_type vu, const fortran_int_t il, const fortran_int_t iu,
      const real_type abstol, fortran_int_t& m, VectorW& w, MatrixZ& z,
      VectorISUPPZ& isuppz, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
...
struct heevr_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  template <
      typename MatrixA, typename VectorW, typename MatrixZ,
      typename VectorISUPPZ, typename WORK, typename RWORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobz, const char range, MatrixA& a, const real_type vl,
      const real_type vu, const fortran_int_t il, const fortran_int_t iu,
      const real_type abstol, fortran_int_t& m, VectorW& w, MatrixZ& z,
      VectorISUPPZ& isuppz, detail::workspace3<WORK, RWORK, IWORK> work
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixA>::value));
...
//
template <
    typename MatrixA, typename VectorW, typename MatrixZ, typename VectorISUPPZ,
    typename Workspace>
...
heevr(
  ...
  return heevr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobz, range, a, vl, vu, il, iu, abstol, m, w, z, isuppz, work
  );
}
