...
// * float value-type.
//
inline std::ptrdiff_t ggesx(
    const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
    const char sense, const fortran_int_t n, float* a, const fortran_int_t lda,
    float* b, const fortran_int_t ldb, fortran_int_t& sdim, float* alphar,
  ...
  LAPACK_SGGESX(
      &jobvsl, &jobvsr, &sort, selctg, &sense, &n, a, &lda, b, &ldb, &sdim,
...
inline std::ptrdiff_t ggesx(
    const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
    const char sense, const fortran_int_t n, double* a, const fortran_int_t lda,
    double* b, const fortran_int_t ldb, fortran_int_t& sdim, double* alphar,
    double* alphai, double* beta, double* vsl, const fortran_int_t ldvsl,
    double* vsr, const fortran_int_t ldvsr, double* rconde, double* rcondv,
...
inline std::ptrdiff_t ggesx(
    const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
    const char sense, const fortran_int_t n, std::complex<float>* a,
    const fortran_int_t lda, std::complex<float>* b, const fortran_int_t ldb,
    fortran_int_t& sdim, std::complex<float>* alpha, std::complex<float>* beta,
...
inline std::ptrdiff_t ggesx(
    const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
    const char sense, const fortran_int_t n, std::complex<double>* a,
    ...
    const fortran_int_t ldvsl, std::complex<double>* vsr,
    const fortran_int_t ldvsr, double* rconde, double* rcondv,
...
struct ggesx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
      const char sense, MatrixA& a, MatrixB& b, fortran_int_t& sdim,
    ...
    BOOST_STATIC_ASSERT(
        (std::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<MatrixVSL>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (std::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<MatrixVSR>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT((
        std::is_same<
            typename remove_const<
    ...
    BOOST_ASSERT(
        bindings::size_minor(vsl) == 1 || bindings::stride_minor(vsl) == 1
    );
    BOOST_ASSERT(
        bindings::size_minor(vsr) == 1 || bindings::stride_minor(vsr) == 1
    );
    BOOST_ASSERT(
    ...
    return detail::ggesx(
        jobvsl, jobvsr, sort, selctg, sense, bindings::size_column(a),
        bindings::begin_value(a), bindings::stride_major(a),
        bindings::begin_value(b), bindings::stride_major(b), sdim,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobvsl, jobvsr, sort, selctg, sense, a, b, sdim, alphar, alphai, beta,
        vsl, vsr, rconde, rcondv, workspace(tmp_work, tmp_iwork, tmp_bwork)
    );
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::ggesx(
        ...
        bindings::begin_value(tmp_iwork), -1, bindings::begin_value(tmp_bwork)
    );
    bindings::detail::array<real_type> tmp_work(
  ...
  static std::ptrdiff_t min_size_work(
      const std::ptrdiff_t n, const char sense
  ) {
    if (n == 0) return 1;
    if (sense == 'N')
      ...
      return std::max<std::ptrdiff_t>(
          8 * n, std::max<std::ptrdiff_t>(6 * n + 16, n * n / 2)
      );
  }
  ...
  static std::ptrdiff_t min_size_bwork(
      const std::ptrdiff_t n, const char sort
  ) {
    if (sort == 'N')
      return 0;
    else
...
struct ggesx_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return detail::ggesx(
        ...
        bindings::begin_value(vsl), bindings::stride_major(vsl),
        bindings::begin_value(vsr), bindings::stride_major(vsr),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobvsl, jobvsr, sort, selctg, sense, a, b, sdim, alpha, beta, vsl, vsr,
        rconde, rcondv, workspace(tmp_work, tmp_rwork, tmp_iwork, tmp_bwork)
    );
  }
  ...
  static std::ptrdiff_t min_size_work(
    ...
    if (sense == 'N')
      ...
      return std::max<std::ptrdiff_t>(
          1, std::max<std::ptrdiff_t>(2 * n, n * n / 2)
      );
  }
  ...
  //
  static std::ptrdiff_t min_size_rwork(const std::ptrdiff_t n) { return 8 * n; }
...
ggesx(
    ...
    const char sense, MatrixA& a, MatrixB& b, fortran_int_t& sdim,
    VectorALPHAR& alphar, VectorALPHAI& alphai, VectorBETA& beta,
    MatrixVSL& vsl, MatrixVSR& vsr, VectorRCONDE& rconde, VectorRCONDV& rcondv,
    Workspace work
) {
  return ggesx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvsl, jobvsr, sort, selctg, sense, a, b, sdim, alphar, alphai, beta,
      vsl, vsr, rconde, rcondv, work
  );
}
...
ggesx(
  ...
  return ggesx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvsl, jobvsr, sort, selctg, sense, a, b, sdim, alphar, alphai, beta,
      vsl, vsr, rconde, rcondv, optimal_workspace()
  );
}
//
// Overloaded function for ggesx. Its overload differs for
