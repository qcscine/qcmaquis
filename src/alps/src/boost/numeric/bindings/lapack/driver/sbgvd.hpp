...
sbgvd(
  ...
  return sbgvd_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      jobz, ab, bb, w, z, work
  );
}
...
sbgvd(const char jobz, MatrixAB& ab, MatrixBB& bb, VectorW& w, MatrixZ& z) {
  return sbgvd_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
