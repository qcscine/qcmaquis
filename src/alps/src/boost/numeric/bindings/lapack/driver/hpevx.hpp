...
inline std::ptrdiff_t hpevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    float* ap, const float vl, const float vu, const fortran_int_t il,
  ...
  LAPACK_SSPEVX(
      &jobz, &range, &lapack_option<UpLo>::value, &n, ap, &vl, &vu, &il, &iu,
...
inline std::ptrdiff_t hpevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    double* ap, const double vl, const double vu, const fortran_int_t il,
...
inline std::ptrdiff_t hpevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    std::complex<float>* ap, const float vl, const float vu,
    const fortran_int_t il, const fortran_int_t iu, const float abstol,
    fortran_int_t& m, float* w, std::complex<float>* z, const fortran_int_t ldz,
...
inline std::ptrdiff_t hpevx(
    const char jobz, const char range, const UpLo, const fortran_int_t n,
    std::complex<double>* ap, const double vl, const double vu,
...
struct hpevx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAP, typename VectorW, typename MatrixZ,
      typename VectorIFAIL, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobz, const char range, MatrixAP& ap, const real_type vl,
    ...
    return detail::hpevx(
        jobz, range, uplo(), bindings::size_column(ap),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobz, range, ap, vl, vu, il, iu, abstol, m, w, z, ifail,
  ...
  //
  static std::ptrdiff_t min_size_work(const std::ptrdiff_t n) { return 8 * n; }
...
//
template <
    typename MatrixAP, typename VectorW, typename MatrixZ, typename VectorIFAIL,
    typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
hpevx(
    const char jobz, const char range, MatrixAP& ap,
  ...
  return hpevx_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      jobz, range, ap, vl, vu, il, iu, abstol, m, w, z, ifail, work
  );
}
