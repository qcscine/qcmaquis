...
inline std::ptrdiff_t geesx(
  ...
  LAPACK_SGEESX(
      &jobvs, &sort, select, &sense, &n, a, &lda, &sdim, wr, wi, vs, &ldvs,
...
struct geesx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobvs, const char sort, external_fp select, const char sense,
      MatrixA& a, fortran_int_t& sdim, VectorWR& wr, VectorWI& wi, MatrixVS& vs,
      real_type& rconde, real_type& rcondv,
    ...
    return detail::geesx(
        jobvs, sort, select, sense, bindings::size_column(a),
        bindings::begin_value(a), bindings::stride_major(a), sdim,
        bindings::begin_value(wr), bindings::begin_value(wi),
        bindings::begin_value(vs), bindings::stride_major(vs), rconde, rcondv,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobvs, sort, select, sense, a, sdim, wr, wi, vs, rconde, rcondv,
...
struct geesx_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobvs, sort, select, sense, a, sdim, w, vs, rconde, rcondv,
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::geesx(
        ...
        bindings::begin_value(a), bindings::stride_major(a), sdim,
        bindings::begin_value(w), bindings::begin_value(vs),
        bindings::stride_major(vs), rconde, rcondv, &opt_size_work, -1,
        bindings::begin_value(tmp_rwork), bindings::begin_value(tmp_bwork)
    );
    bindings::detail::array<value_type> tmp_work(
        traits::detail::to_int(opt_size_work)
    );
...
geesx(
  ...
  return geesx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvs, sort, select, sense, a, sdim, wr, wi, vs, rconde, rcondv, work
  );
}
...
geesx(
  ...
  return geesx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvs, sort, select, sense, a, sdim, w, vs, rconde, rcondv, work
  );
}
