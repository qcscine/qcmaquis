...
inline std::ptrdiff_t ppsvx(
  ...
  LAPACK_SPPSVX(
      &fact, &lapack_option<UpLo>::value, &n, &nrhs, ap, afp, &equed, s, b,
...
inline std::ptrdiff_t ppsvx(
    const char fact, const UpLo, const fortran_int_t n,
    const fortran_int_t nrhs, std::complex<float>* ap, std::complex<float>* afp,
    char& equed, float* s, std::complex<float>* b, const fortran_int_t ldb,
...
inline std::ptrdiff_t ppsvx(
    ...
    std::complex<double>* afp, char& equed, double* s, std::complex<double>* b,
...
struct ppsvx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAP, typename VectorAFP, typename VectorS, typename MatrixB,
      typename MatrixX, typename VectorFERR, typename VectorBERR, typename WORK,
      typename IWORK>
  static std::ptrdiff_t invoke(
      const char fact, MatrixAP& ap, VectorAFP& afp, char& equed, VectorS& s,
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            ...
            typename remove_const<
                typename bindings::value_type<VectorAFP>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
    ...
    return detail::ppsvx(
        fact, uplo(), bindings::size_column(ap), bindings::size_column(b),
        bindings::begin_value(ap), bindings::begin_value(afp), equed,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        fact, ap, afp, equed, s, b, x, rcond, ferr, berr,
  ...
  static std::ptrdiff_t invoke(
    ...
    typedef typename result_of::uplo_tag<MatrixAP>::type uplo;
    return invoke(
        fact, ap, afp, equed, s, b, x, rcond, ferr, berr, minimal_workspace()
    );
  }
...
ppsvx(
  ...
  return ppsvx_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      fact, ap, afp, equed, s, b, x, rcond, ferr, berr, work
  );
}
...
ppsvx(
  ...
  return ppsvx_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      fact, ap, afp, equed, s, b, x, rcond, ferr, berr, optimal_workspace()
  );
}
