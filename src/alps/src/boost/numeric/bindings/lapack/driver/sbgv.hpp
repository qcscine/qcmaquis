...
sbgv(
  ...
  return sbgv_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      jobz, ab, bb, w, z, work
  );
}
...
sbgv(const char jobz, MatrixAB& ab, MatrixBB& bb, VectorW& w, MatrixZ& z) {
  return sbgv_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
