...
inline std::ptrdiff_t posv(
    Order, const UpLo, const int n, const int nrhs, float* a, const int lda,
    float* b, const int ldb
) {
  return clapack_sposv(
      clapack_option<Order>::value, clapack_option<UpLo>::value, n, nrhs, a,
      lda, b, ldb
  );
}
...
template <typename Order, typename UpLo>
inline std::ptrdiff_t posv(
    Order, const UpLo, const int n, const int nrhs, double* a, const int lda,
    double* b, const int ldb
) {
  return clapack_dposv(
      clapack_option<Order>::value, clapack_option<UpLo>::value, n, nrhs, a,
      lda, b, ldb
  );
}
...
template <typename Order, typename UpLo>
inline std::ptrdiff_t posv(
    Order, const UpLo, const int n, const int nrhs, std::complex<float>* a,
    const int lda, std::complex<float>* b, const int ldb
) {
  return clapack_cposv(
      clapack_option<Order>::value, clapack_option<UpLo>::value, n, nrhs, a,
      lda, b, ldb
  );
}
...
template <typename Order, typename UpLo>
inline std::ptrdiff_t posv(
    Order, const UpLo, const int n, const int nrhs, std::complex<double>* a,
    const int lda, std::complex<double>* b, const int ldb
) {
  return clapack_zposv(
      clapack_option<Order>::value, clapack_option<UpLo>::value, n, nrhs, a,
      lda, b, ldb
  );
}
...
template <typename Order, typename UpLo>
inline std::ptrdiff_t posv(
    Order, const UpLo, const fortran_int_t n, const fortran_int_t nrhs,
    float* a, const fortran_int_t lda, float* b, const fortran_int_t ldb
) {
  BOOST_STATIC_ASSERT((is_same<Order, tag::column_major>::value));
  fortran_int_t info(0);
  LAPACK_SPOSV(&lapack_option<UpLo>::value, &n, &nrhs, a, &lda, b, &ldb, &info);
  return info;
}
...
inline std::ptrdiff_t posv(
  ...
  BOOST_STATIC_ASSERT((is_same<Order, tag::column_major>::value));
  fortran_int_t info(0);
  LAPACK_DPOSV(&lapack_option<UpLo>::value, &n, &nrhs, a, &lda, b, &ldb, &info);
  return info;
}
...
inline std::ptrdiff_t posv(
  ...
  BOOST_STATIC_ASSERT((is_same<Order, tag::column_major>::value));
  fortran_int_t info(0);
  LAPACK_CPOSV(&lapack_option<UpLo>::value, &n, &nrhs, a, &lda, b, &ldb, &info);
  return info;
}
...
inline std::ptrdiff_t posv(
  ...
  BOOST_STATIC_ASSERT((is_same<Order, tag::column_major>::value));
  fortran_int_t info(0);
  LAPACK_ZPOSV(&lapack_option<UpLo>::value, &n, &nrhs, a, &lda, b, &ldb, &info);
  return info;
}
...
struct posv_impl {
  ...
  static std::ptrdiff_t invoke(MatrixA& a, MatrixB& b) {
    ...
    return detail::posv(
        order(), uplo(), bindings::size_column(a), bindings::size_column(b),
...
inline std::ptrdiff_t posv(MatrixA& a, MatrixB& b) {
  return posv_impl<typename bindings::value_type<MatrixA>::type>::invoke(a, b);
}
