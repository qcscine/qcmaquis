...
struct hpgv_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(itype, jobz, ap, bp, w, z, workspace(tmp_work, tmp_rwork));
  }
...
hpgv(
  ...
  return hpgv_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
