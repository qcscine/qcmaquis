...
sbevd(const char jobz, MatrixAB& ab, VectorW& w, MatrixZ& z, Workspace work) {
  return sbevd_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      jobz, ab, w, z, work
  );
}
