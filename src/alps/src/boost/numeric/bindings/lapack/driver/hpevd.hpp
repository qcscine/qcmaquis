...
inline std::ptrdiff_t hpevd(
    const char jobz, const UpLo, const fortran_int_t n, float* ap, float* w,
    float* z, const fortran_int_t ldz, float* work, const fortran_int_t lwork,
    fortran_int_t* iwork, const fortran_int_t liwork
) {
  fortran_int_t info(0);
  LAPACK_SSPEVD(
      &jobz, &lapack_option<UpLo>::value, &n, ap, w, z, &ldz, work, &lwork,
      iwork, &liwork, &info
  );
  return info;
}
...
template <typename UpLo>
inline std::ptrdiff_t hpevd(
    const char jobz, const UpLo, const fortran_int_t n, double* ap, double* w,
    double* z, const fortran_int_t ldz, double* work, const fortran_int_t lwork,
    fortran_int_t* iwork, const fortran_int_t liwork
) {
  fortran_int_t info(0);
  LAPACK_DSPEVD(
...
template <typename UpLo>
inline std::ptrdiff_t hpevd(
    const char jobz, const UpLo, const fortran_int_t n, std::complex<float>* ap,
...
template <typename UpLo>
inline std::ptrdiff_t hpevd(
    const char jobz, const UpLo, const fortran_int_t n,
...
struct hpevd_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAP, typename VectorW, typename MatrixZ, typename WORK,
      typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobz, MatrixAP& ap, VectorW& w, MatrixZ& z,
    ...
    return detail::hpevd(
        jobz, uplo(), bindings::size_column(ap), bindings::begin_value(ap),
  ...
  static std::ptrdiff_t invoke(
      const char jobz, MatrixAP& ap, VectorW& w, MatrixZ& z, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAP>::type uplo;
  ...
  template <typename MatrixAP, typename VectorW, typename MatrixZ>
  static std::ptrdiff_t invoke(
      const char jobz, MatrixAP& ap, VectorW& w, MatrixZ& z, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAP>::type uplo;
...
struct hpevd_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(jobz, ap, w, z, workspace(tmp_work, tmp_rwork, tmp_iwork));
  }
...
//
template <
    typename MatrixAP, typename VectorW, typename MatrixZ, typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
hpevd(const char jobz, MatrixAP& ap, VectorW& w, MatrixZ& z, Workspace work) {
  return hpevd_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      jobz, ap, w, z, work
  );
}
