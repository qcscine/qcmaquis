...
inline std::ptrdiff_t hpsvx(
  ...
  LAPACK_SSPSVX(
      &fact, &lapack_option<UpLo>::value, &n, &nrhs, ap, afp, ipiv, b, &ldb, x,
...
inline std::ptrdiff_t hpsvx(
    ...
    std::complex<float>* afp, fortran_int_t* ipiv, const std::complex<float>* b,
...
struct hpsvx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAP, typename MatrixAFP, typename VectorIPIV,
      typename MatrixB, typename MatrixX, typename VectorFERR,
      typename VectorBERR, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const char fact, const MatrixAP& ap, MatrixAFP& afp, VectorIPIV& ipiv,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        fact, ap, afp, ipiv, b, x, rcond, ferr, berr,
  ...
  static std::ptrdiff_t invoke(
    ...
    typedef typename result_of::uplo_tag<MatrixAP>::type uplo;
    return invoke(
        fact, ap, afp, ipiv, b, x, rcond, ferr, berr, minimal_workspace()
    );
  }
...
hpsvx(
  ...
  return hpsvx_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      fact, ap, afp, ipiv, b, x, rcond, ferr, berr, work
  );
}
...
hpsvx(
  ...
  return hpsvx_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      fact, ap, afp, ipiv, b, x, rcond, ferr, berr, optimal_workspace()
  );
}
