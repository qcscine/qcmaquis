...
inline std::ptrdiff_t trsna(
  ...
  LAPACK_STRSNA(
      &job, &howmny, select, &n, t, &ldt, vl, &ldvl, vr, &ldvr, s, sep, &mm, &m,
...
inline std::ptrdiff_t trsna(
    const char job, const char howmny, const fortran_bool_t* select,
    const fortran_int_t n, const std::complex<float>* t,
    const fortran_int_t ldt, const std::complex<float>* vl,
    const fortran_int_t ldvl, const std::complex<float>* vr,
    const fortran_int_t ldvr, float* s, float* sep, const fortran_int_t mm,
    fortran_int_t& m, std::complex<float>* work, const fortran_int_t ldwork,
    float* rwork
) {
  fortran_int_t info(0);
  LAPACK_CTRSNA(
...
inline std::ptrdiff_t trsna(
    const char job, const char howmny, const fortran_bool_t* select,
    const fortran_int_t n, const std::complex<double>* t,
    const fortran_int_t ldt, const std::complex<double>* vl,
    const fortran_int_t ldvl, const std::complex<double>* vr,
    const fortran_int_t ldvr, double* s, double* sep, const fortran_int_t mm,
    fortran_int_t& m, std::complex<double>* work, const fortran_int_t ldwork,
    double* rwork
) {
  fortran_int_t info(0);
  LAPACK_ZTRSNA(
...
struct trsna_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename VectorSELECT, typename MatrixT, typename MatrixVL,
      typename MatrixVR, typename VectorS, typename VectorSEP, typename WORK,
      typename IWORK>
  static std::ptrdiff_t invoke(
      ...
      const fortran_int_t ldwork, detail::workspace2<WORK, IWORK> work
  ) {
    ...
    BOOST_STATIC_ASSERT(
        (std::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixT>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorSEP>::type>::type>::value)
    );
    ...
    return detail::trsna(
        job, howmny, bindings::begin_value(select), bindings::size_column(t),
        ...
        bindings::begin_value(s), bindings::begin_value(sep), mm, m,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        job, howmny, select, t, vl, vr, s, sep, mm, m, ldwork,
  ...
  static std::ptrdiff_t min_size_work(
      const char job, const std::ptrdiff_t ldwork, const std::ptrdiff_t n
  ) {
...
struct trsna_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      ...
      const MatrixT& t, const MatrixVL& vl, const MatrixVR& vr, VectorS& s,
      VectorSEP& sep, const fortran_int_t mm, fortran_int_t& m,
      const fortran_int_t ldwork, detail::workspace2<WORK, RWORK> work
  ) {
    namespace bindings = ::boost::numeric::bindings;
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixT>::value));
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixVL>::value));
  ...
  //
  static std::ptrdiff_t min_size_rwork(const char job, const std::ptrdiff_t n) {
...
template <
    typename VectorSELECT, typename MatrixT, typename MatrixVL,
    typename MatrixVR, typename VectorS, typename VectorSEP, typename Workspace>
...
trsna(
  ...
  return trsna_impl<typename bindings::value_type<MatrixT>::type>::invoke(
      job, howmny, select, t, vl, vr, s, sep, mm, m, ldwork, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<VectorSEP>, std::ptrdiff_t>::type
trsna(
    const char job, const char howmny, const VectorSELECT& select,
    const MatrixT& t, const MatrixVL& vl, const MatrixVR& vr, VectorS& s,
    VectorSEP& sep, const fortran_int_t mm, fortran_int_t& m,
  ...
  return trsna_impl<typename bindings::value_type<MatrixT>::type>::invoke(
      job, howmny, select, t, vl, vr, s, sep, mm, m, ldwork, optimal_workspace()
  );
}
