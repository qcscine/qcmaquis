...
inline std::ptrdiff_t gghrd(
    const char compq, const char compz, const fortran_int_t n,
    const fortran_int_t ilo, const fortran_int_t ihi, std::complex<float>* a,
...
inline std::ptrdiff_t gghrd(
    const char compq, const char compz, const fortran_int_t n,
    const fortran_int_t ilo, const fortran_int_t ihi, std::complex<double>* a,
...
struct gghrd_impl {
  ...
  static std::ptrdiff_t invoke(
      const char compq, const char compz, const fortran_int_t ilo, MatrixA& a,
    ...
    return detail::gghrd(
        compq, compz, bindings::size_column(a), ilo, bindings::size_column(a),
...
inline std::ptrdiff_t gghrd(
  ...
  return gghrd_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      compq, compz, ilo, a, b, q, z
  );
}
