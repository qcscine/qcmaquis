...
inline std::ptrdiff_t geqp3(
    ...
    const fortran_int_t lda, fortran_int_t* jpvt, std::complex<float>* tau,
...
inline std::ptrdiff_t geqp3(
    ...
    const fortran_int_t lda, fortran_int_t* jpvt, std::complex<double>* tau,
...
struct geqp3_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename VectorJPVT, typename VectorTAU, typename WORK>
  static std::ptrdiff_t invoke(
      MatrixA& a, VectorJPVT& jpvt, VectorTAU& tau,
  ...
  static std::ptrdiff_t invoke(
      MatrixA& a, VectorJPVT& jpvt, VectorTAU& tau, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
  ...
  template <typename MatrixA, typename VectorJPVT, typename VectorTAU>
  static std::ptrdiff_t invoke(
      MatrixA& a, VectorJPVT& jpvt, VectorTAU& tau, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    ...
    detail::geqp3(
        bindings::size_row(a), bindings::size_column(a),
        bindings::begin_value(a), bindings::stride_major(a),
        bindings::begin_value(jpvt), bindings::begin_value(tau), &opt_size_work,
        -1
    );
    bindings::detail::array<real_type> tmp_work(
...
struct geqp3_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  // workspace-array work.
  //
  static std::ptrdiff_t min_size_work(const std::ptrdiff_t n) { return n + 1; }
...
//
template <
    typename MatrixA, typename VectorJPVT, typename VectorTAU,
    typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
geqp3(MatrixA& a, VectorJPVT& jpvt, VectorTAU& tau, Workspace work) {
  return geqp3_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, jpvt, tau, work
  );
}
