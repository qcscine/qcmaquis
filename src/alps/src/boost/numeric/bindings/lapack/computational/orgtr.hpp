...
orgtr(const fortran_int_t n, MatrixA& a, const VectorTAU& tau, Workspace work) {
  return orgtr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      n, a, tau, work
  );
}
