...
struct ptrfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return detail::ptrfs(
        bindings::size(d), bindings::size_column(b), bindings::begin_value(d),
...
struct ptrfs_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char uplo, const VectorD& d, const VectorE& e, const VectorDF& df,
      const VectorEF& ef, const MatrixB& b, MatrixX& x, VectorFERR& ferr,
    ...
    return detail::ptrfs(
        uplo, bindings::size(d), bindings::size_column(b),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        uplo, d, e, df, ef, b, x, ferr, berr, workspace(tmp_work, tmp_rwork)
    );
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    namespace bindings = ::boost::numeric::bindings;
    return invoke(uplo, d, e, df, ef, b, x, ferr, berr, minimal_workspace());
  }
...
ptrfs(
    const VectorD& d, const VectorE& e, const VectorDF& df, const VectorEF& ef,
    const MatrixB& b, MatrixX& x, VectorFERR& ferr, VectorBERR& berr,
    Workspace work
) {
  return ptrfs_impl<typename bindings::value_type<VectorE>::type>::invoke(
...
ptrfs(
  ...
  return ptrfs_impl<typename bindings::value_type<VectorE>::type>::invoke(
      uplo, d, e, df, ef, b, x, ferr, berr, work
  );
}
...
ptrfs(
  ...
  return ptrfs_impl<typename bindings::value_type<VectorE>::type>::invoke(
      uplo, d, e, df, ef, b, x, ferr, berr, optimal_workspace()
  );
}
