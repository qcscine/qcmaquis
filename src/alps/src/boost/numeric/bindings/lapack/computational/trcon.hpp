...
inline std::ptrdiff_t trcon(
    const char norm, const UpLo, const Diag, const fortran_int_t n,
    const float* a, const fortran_int_t lda, float& rcond, float* work,
    fortran_int_t* iwork
) {
  fortran_int_t info(0);
  LAPACK_STRCON(
      &norm, &lapack_option<UpLo>::value, &lapack_option<Diag>::value, &n, a,
...
inline std::ptrdiff_t trcon(
    const char norm, const UpLo, const Diag, const fortran_int_t n,
    const double* a, const fortran_int_t lda, double& rcond, double* work,
    fortran_int_t* iwork
) {
  fortran_int_t info(0);
  LAPACK_DTRCON(
...
inline std::ptrdiff_t trcon(
    const char norm, const UpLo, const Diag, const fortran_int_t n,
    const std::complex<float>* a, const fortran_int_t lda, float& rcond,
...
inline std::ptrdiff_t trcon(
    const char norm, const UpLo, const Diag, const fortran_int_t n,
    const std::complex<double>* a, const fortran_int_t lda, double& rcond,
...
struct trcon_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char norm, const MatrixA& a, real_type& rcond,
    ...
    return detail::trcon(
        norm, uplo(), diag(), bindings::size_column(a),
  ...
  static std::ptrdiff_t invoke(
      const char norm, const MatrixA& a, real_type& rcond, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
    typedef typename result_of::diag_tag<MatrixA>::type diag;
  ...
  template <typename MatrixA>
  static std::ptrdiff_t invoke(
      const char norm, const MatrixA& a, real_type& rcond, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
    typedef typename result_of::diag_tag<MatrixA>::type diag;
...
trcon(
    const char norm, const MatrixA& a,
    typename remove_imaginary<
        typename bindings::value_type<MatrixA>::type>::type& rcond,
    Workspace work
) {
  return trcon_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      norm, a, rcond, work
  );
}
...
trcon(
  ...
  return trcon_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      norm, a, rcond, optimal_workspace()
  );
}
