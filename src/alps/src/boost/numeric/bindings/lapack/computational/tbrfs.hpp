...
inline std::ptrdiff_t tbrfs(
    const UpLo, const Trans, const Diag, const fortran_int_t n,
  ...
  LAPACK_STBRFS(
      &lapack_option<UpLo>::value, &lapack_option<Trans>::value,
      &lapack_option<Diag>::value, &n, &kd, &nrhs, ab, &ldab, b, &ldb, x, &ldx,
...
struct tbrfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAB, typename MatrixB, typename MatrixX,
  ...
  static std::ptrdiff_t invoke(
    ...
    BOOST_ASSERT(kd >= 0);
    return detail::tbrfs(
        uplo(), trans(), diag(), bindings::size_column_op(ab, trans()), kd,
  ...
  static std::ptrdiff_t invoke(
      const fortran_int_t kd, const MatrixAB& ab, const MatrixB& b,
      const MatrixX& x, VectorFERR& ferr, VectorBERR& berr, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::data_order<MatrixB>::type order;
    typedef typename result_of::trans_tag<MatrixAB, order>::type trans;
    ...
    return invoke(kd, ab, b, x, ferr, berr, workspace(tmp_work, tmp_iwork));
  }
  ...
  static std::ptrdiff_t invoke(
      const fortran_int_t kd, const MatrixAB& ab, const MatrixB& b,
      const MatrixX& x, VectorFERR& ferr, VectorBERR& berr, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::data_order<MatrixB>::type order;
    typedef typename result_of::trans_tag<MatrixAB, order>::type trans;
...
struct tbrfs_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(kd, ab, b, x, ferr, berr, workspace(tmp_work, tmp_rwork));
  }
...
//
template <
    typename MatrixAB, typename MatrixB, typename MatrixX, typename VectorFERR,
    typename VectorBERR, typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
tbrfs(
    const fortran_int_t kd, const MatrixAB& ab, const MatrixB& b,
    const MatrixX& x, VectorFERR& ferr, VectorBERR& berr, Workspace work
) {
  return tbrfs_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
