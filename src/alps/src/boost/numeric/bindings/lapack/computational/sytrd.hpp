...
sytrd(MatrixA& a, VectorD& d, VectorE& e, VectorTAU& tau, Workspace work) {
  return sytrd_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, d, e, tau, work
  );
}
