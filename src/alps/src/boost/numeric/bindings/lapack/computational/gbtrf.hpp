...
inline std::ptrdiff_t gbtrf(
    const fortran_int_t m, const fortran_int_t n, const fortran_int_t kl,
    const fortran_int_t ku, std::complex<float>* ab, const fortran_int_t ldab,
    fortran_int_t* ipiv
) {
  fortran_int_t info(0);
...
inline std::ptrdiff_t gbtrf(
    const fortran_int_t m, const fortran_int_t n, const fortran_int_t kl,
    const fortran_int_t ku, std::complex<double>* ab, const fortran_int_t ldab,
    fortran_int_t* ipiv
) {
  fortran_int_t info(0);
...
inline std::ptrdiff_t gbtrf(MatrixAB& ab, VectorIPIV& ipiv) {
  return gbtrf_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      ab, ipiv
  );
}
