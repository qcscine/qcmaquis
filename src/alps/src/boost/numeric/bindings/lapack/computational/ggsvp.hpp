...
// * float value-type.
//
inline std::ptrdiff_t ggsvp(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t p, const fortran_int_t n, float* a,
  ...
  LAPACK_SGGSVP(
      &jobu, &jobv, &jobq, &m, &p, &n, a, &lda, b, &ldb, &tola, &tolb, &k, &l,
...
inline std::ptrdiff_t ggsvp(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t p, const fortran_int_t n, double* a,
...
inline std::ptrdiff_t ggsvp(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t p, const fortran_int_t n, std::complex<float>* a,
...
inline std::ptrdiff_t ggsvp(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t p, const fortran_int_t n, std::complex<double>* a,
    const fortran_int_t lda, std::complex<double>* b, const fortran_int_t ldb,
    const double tola, const double tolb, fortran_int_t& k, fortran_int_t& l,
    std::complex<double>* u, const fortran_int_t ldu, std::complex<double>* v,
    const fortran_int_t ldv, std::complex<double>* q, const fortran_int_t ldq,
...
struct ggsvp_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename MatrixU, typename MatrixV,
      typename MatrixQ, typename IWORK, typename TAU, typename WORK>
  static std::ptrdiff_t invoke(
      const char jobu, const char jobv, const char jobq, MatrixA& a, MatrixB& b,
      const real_type tola, const real_type tolb, fortran_int_t& k,
    ...
    return detail::ggsvp(
        jobu, jobv, jobq, bindings::size_row(a), bindings::size_row(b),
        bindings::size_column(a), bindings::begin_value(a),
        bindings::stride_major(a), bindings::begin_value(b),
        bindings::stride_major(b), tola, tolb, k, l, bindings::begin_value(u),
  ...
  static std::ptrdiff_t invoke(
      const char jobu, const char jobv, const char jobq, MatrixA& a, MatrixB& b,
      const real_type tola, const real_type tolb, fortran_int_t& k,
      fortran_int_t& l, MatrixU& u, MatrixV& v, MatrixQ& q, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    bindings::detail::array<fortran_int_t> tmp_iwork(
        min_size_iwork(bindings::size_column(a))
    );
    bindings::detail::array<real_type> tmp_tau(
        min_size_tau(bindings::size_column(a))
    );
    ...
    return invoke(
        jobu, jobv, jobq, a, b, tola, tolb, k, l, u, v, q,
  ...
  static std::ptrdiff_t invoke(
      const char jobu, const char jobv, const char jobq, MatrixA& a, MatrixB& b,
      const real_type tola, const real_type tolb, fortran_int_t& k,
      fortran_int_t& l, MatrixU& u, MatrixV& v, MatrixQ& q, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    return invoke(
        jobu, jobv, jobq, a, b, tola, tolb, k, l, u, v, q, minimal_workspace()
    );
  }
  ...
  // workspace-array tau.
  //
  static std::ptrdiff_t min_size_tau(const std::ptrdiff_t n) { return n; }
...
struct ggsvp_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  template <
      typename MatrixA, typename MatrixB, typename MatrixU, typename MatrixV,
      typename MatrixQ, typename IWORK, typename RWORK, typename TAU,
      typename WORK>
  static std::ptrdiff_t invoke(
      const char jobu, const char jobv, const char jobq, MatrixA& a, MatrixB& b,
      const real_type tola, const real_type tolb, fortran_int_t& k,
  ...
  static std::ptrdiff_t invoke(
    ...
    bindings::detail::array<value_type> tmp_tau(
        min_size_tau(bindings::size_column(a))
    );
...
ggsvp(
    ...
    const typename remove_imaginary<
        typename bindings::value_type<MatrixA>::type>::type tolb,
    fortran_int_t& k, fortran_int_t& l, MatrixU& u, MatrixV& v, MatrixQ& q,
    Workspace work
) {
  return ggsvp_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobu, jobv, jobq, a, b, tola, tolb, k, l, u, v, q, work
  );
}
...
ggsvp(
  ...
  return ggsvp_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobu, jobv, jobq, a, b, tola, tolb, k, l, u, v, q, optimal_workspace()
  );
}
