...
inline std::ptrdiff_t gerfs(
  ...
  LAPACK_SGERFS(
      &lapack_option<Trans>::value, &n, &nrhs, a, &lda, af, &ldaf, ipiv, b,
...
inline std::ptrdiff_t gerfs(
    ...
    const std::complex<float>* af, const fortran_int_t ldaf,
...
inline std::ptrdiff_t gerfs(
    ...
    const std::complex<double>* af, const fortran_int_t ldaf,
...
struct gerfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const MatrixA& a, const MatrixAF& af, const VectorIPIV& ipiv,
    ...
    BOOST_ASSERT(bindings::size(ipiv) >= bindings::size_column_op(a, trans()));
    BOOST_ASSERT(
    ...
    return detail::gerfs(
        trans(), bindings::size_column_op(a, trans()), bindings::size_column(b),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        a, af, ipiv, b, x, ferr, berr, workspace(tmp_work, tmp_iwork)
    );
  }
...
struct gerfs_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        a, af, ipiv, b, x, ferr, berr, workspace(tmp_work, tmp_rwork)
    );
  }
...
gerfs(
  ...
  return gerfs_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, af, ipiv, b, x, ferr, berr, work
  );
}
...
gerfs(
  ...
  return gerfs_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, af, ipiv, b, x, ferr, berr, optimal_workspace()
  );
}
