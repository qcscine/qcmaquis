...
inline std::ptrdiff_t hsein(
    const Side, const char eigsrc, const char initv, fortran_bool_t* select,
    const fortran_int_t n, const float* h, const fortran_int_t ldh, float* wr,
    const float* wi, float* vl, const fortran_int_t ldvl, float* vr,
    const fortran_int_t ldvr, const fortran_int_t mm, fortran_int_t& m,
    float* work, fortran_int_t* ifaill, fortran_int_t* ifailr
) {
  fortran_int_t info(0);
  LAPACK_SHSEIN(
      &lapack_option<Side>::value, &eigsrc, &initv, select, &n, h, &ldh, wr, wi,
...
inline std::ptrdiff_t hsein(
    const Side, const char eigsrc, const char initv, fortran_bool_t* select,
    const fortran_int_t n, const double* h, const fortran_int_t ldh, double* wr,
...
template <typename Side>
inline std::ptrdiff_t hsein(
    const Side, const char eigsrc, const char initv,
    ...
    std::complex<float>* vr, const fortran_int_t ldvr, const fortran_int_t mm,
    fortran_int_t& m, std::complex<float>* work, float* rwork,
    fortran_int_t* ifaill, fortran_int_t* ifailr
) {
  fortran_int_t info(0);
  LAPACK_CHSEIN(
      &lapack_option<Side>::value, &eigsrc, &initv, select, &n, h, &ldh, w, vl,
...
inline std::ptrdiff_t hsein(
    ...
    std::complex<double>* vr, const fortran_int_t ldvr, const fortran_int_t mm,
...
struct hsein_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename Side, typename VectorSELECT, typename MatrixH, typename VectorWR,
  ...
  static std::ptrdiff_t invoke(
      const Side side, const char eigsrc, const char initv,
      VectorSELECT& select, const MatrixH& h, VectorWR& wr, const VectorWI& wi,
      MatrixVL& vl, MatrixVR& vr, const fortran_int_t mm, fortran_int_t& m,
      VectorIFAILL& ifaill, VectorIFAILR& ifailr, detail::workspace1<WORK> work
  ) {
    ...
    BOOST_STATIC_ASSERT((
        std::is_same<
            ...
            typename remove_const<
                typename bindings::value_type<VectorIFAILR>::type>::type>::value
    ));
    ...
    return detail::hsein(
        side, eigsrc, initv, bindings::begin_value(select),
        bindings::size_column(h), bindings::begin_value(h),
        bindings::stride_major(h), bindings::begin_value(wr),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        side, eigsrc, initv, select, h, wr, wi, vl, vr, mm, m, ifaill, ifailr,
        workspace(tmp_work)
    );
  }
...
struct hsein_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  //
  template <
      typename Side, typename VectorSELECT, typename MatrixH, typename VectorW,
      typename MatrixVL, typename MatrixVR, typename VectorIFAILL,
      typename VectorIFAILR, typename WORK, typename RWORK>
  static std::ptrdiff_t invoke(
      const Side side, const char eigsrc, const char initv,
      const VectorSELECT& select, const MatrixH& h, VectorW& w, MatrixVL& vl,
    ...
    return detail::hsein(
        side, eigsrc, initv, bindings::begin_value(select),
        bindings::size_column(h), bindings::begin_value(h),
        bindings::stride_major(h), bindings::begin_value(w),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        side, eigsrc, initv, select, h, w, vl, vr, mm, m, ifaill, ifailr,
  ...
  // workspace-array work.
  //
  static std::ptrdiff_t min_size_work(const std::ptrdiff_t n) { return n * n; }
...
hsein(
    const Side side, const char eigsrc, const char initv, VectorSELECT& select,
    const MatrixH& h, VectorWR& wr, const VectorWI& wi, MatrixVL& vl,
    MatrixVR& vr, const fortran_int_t mm, fortran_int_t& m,
    VectorIFAILL& ifaill, VectorIFAILR& ifailr, Workspace work
) {
  return hsein_impl<typename bindings::value_type<MatrixH>::type>::invoke(
      side, eigsrc, initv, select, h, wr, wi, vl, vr, mm, m, ifaill, ifailr,
      work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<VectorIFAILR>, std::ptrdiff_t>::type
hsein(
    const Side side, const char eigsrc, const char initv, VectorSELECT& select,
    const MatrixH& h, VectorWR& wr, const VectorWI& wi, MatrixVL& vl,
    MatrixVR& vr, const fortran_int_t mm, fortran_int_t& m,
...
hsein(
  ...
  return hsein_impl<typename bindings::value_type<MatrixH>::type>::invoke(
      side, eigsrc, initv, select, h, w, vl, vr, mm, m, ifaill, ifailr, work
  );
}
