...
inline std::ptrdiff_t unmhr(
  ...
  LAPACK_SORMHR(
      &lapack_option<Side>::value, &lapack_option<Trans>::value, &m, &n, &ilo,
...
struct unmhr_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const Side side, const fortran_int_t ilo, const fortran_int_t ihi,
    ...
    return detail::unmhr(
        side, trans(), bindings::size_row(c), bindings::size_column(c), ilo,
        ihi, bindings::begin_value(a), bindings::stride_major(a),
  ...
  static std::ptrdiff_t invoke(
      const Side side, const fortran_int_t ilo, const fortran_int_t ihi,
      const MatrixA& a, const VectorTAU& tau, MatrixC& c, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::data_order<MatrixC>::type order;
    typedef typename result_of::trans_tag<MatrixA, order>::type trans;
  ...
  static std::ptrdiff_t invoke(
      const Side side, const fortran_int_t ilo, const fortran_int_t ihi,
      const MatrixA& a, const VectorTAU& tau, MatrixC& c, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::data_order<MatrixC>::type order;
    typedef typename result_of::trans_tag<MatrixA, order>::type trans;
...
unmhr(
  ...
  return unmhr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      side, ilo, ihi, a, tau, c, work
  );
}
...
unmhr(
  ...
  return unmhr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      side, ilo, ihi, a, tau, c, optimal_workspace()
  );
}
