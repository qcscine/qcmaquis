...
opgtr(
  ...
  return opgtr_impl<typename bindings::value_type<VectorAP>::type>::invoke(
      uplo, ap, tau, q, work
  );
}
...
opgtr(const char uplo, const VectorAP& ap, const VectorTAU& tau, MatrixQ& q) {
  return opgtr_impl<typename bindings::value_type<VectorAP>::type>::invoke(
