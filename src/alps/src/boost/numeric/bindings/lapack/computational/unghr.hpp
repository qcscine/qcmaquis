...
struct unghr_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    BOOST_ASSERT(
        bindings::size(work.select(real_type())) >= min_size_work(ihi, ilo)
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(n >= 0);
    return detail::unghr(
        n, ilo, ihi, bindings::begin_value(a), bindings::stride_major(a),
  ...
  static std::ptrdiff_t invoke(
    ...
    namespace bindings = ::boost::numeric::bindings;
    bindings::detail::array<real_type> tmp_work(min_size_work(ihi, ilo));
  ...
  static std::ptrdiff_t min_size_work(
      const std::ptrdiff_t ihi, const std::ptrdiff_t ilo
  ) {
    return ihi - ilo;
  }
};
...
struct unghr_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    BOOST_ASSERT(bindings::size(tau) >= n - 1);
    BOOST_ASSERT(
        bindings::size(work.select(value_type())) >= min_size_work(ihi, ilo)
    );
    BOOST_ASSERT(
        bindings::size_minor(a) == 1 || bindings::stride_minor(a) == 1
    );
  ...
  static std::ptrdiff_t invoke(
    ...
    namespace bindings = ::boost::numeric::bindings;
    bindings::detail::array<value_type> tmp_work(min_size_work(ihi, ilo));
    return invoke(n, ilo, ihi, a, tau, workspace(tmp_work));
  }
...
unghr(
  ...
  return unghr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      n, ilo, ihi, a, tau, work
  );
}
...
unghr(
  ...
  return unghr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      n, ilo, ihi, a, tau, optimal_workspace()
  );
}
