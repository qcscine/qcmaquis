...
inline std::ptrdiff_t unmrq(
  ...
  LAPACK_SORMRQ(
      &lapack_option<Side>::value, &lapack_option<Trans>::value, &m, &n, &k, a,
...
unmrq(
  ...
  return unmrq_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      side, a, tau, c, work
  );
}
...
unmrq(const Side side, const MatrixA& a, const VectorTAU& tau, MatrixC& c) {
  return unmrq_impl<typename bindings::value_type<MatrixA>::type>::invoke(
