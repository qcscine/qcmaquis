...
// * float value-type.
//
inline std::ptrdiff_t stebz(
    const char range, const char order, const fortran_int_t n, const float vl,
    const float vu, const fortran_int_t il, const fortran_int_t iu,
    const float abstol, const float* d, const float* e, fortran_int_t& m,
...
//
inline std::ptrdiff_t stebz(
    const char range, const char order, const fortran_int_t n, const double vl,
    const double vu, const fortran_int_t il, const fortran_int_t iu,
    const double abstol, const double* d, const double* e, fortran_int_t& m,
...
struct stebz_impl {
  ...
  //
  template <
      typename VectorD, typename VectorE, typename VectorW,
  ...
  static std::ptrdiff_t invoke(
      ...
      const fortran_int_t iu, const real_type abstol, const VectorD& d,
      const VectorE& e, fortran_int_t& m, fortran_int_t& nsplit, VectorW& w,
    ...
    BOOST_STATIC_ASSERT((
        std::is_same<
            ...
            typename remove_const<
                typename bindings::value_type<VectorISPLIT>::type>::type>::value
    ));
    ...
    return detail::stebz(
        range, order, n, vl, vu, il, iu, abstol, bindings::begin_value(d),
        bindings::begin_value(e), m, nsplit, bindings::begin_value(w),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        ...
        isplit, workspace(tmp_work, tmp_iwork)
    );
  }
  ...
  //
  static std::ptrdiff_t min_size_iwork(const std::ptrdiff_t n) { return 3 * n; }
};
...
//
template <
    typename VectorD, typename VectorE, typename VectorW, typename VectorIBLOCK,
    typename VectorISPLIT, typename Workspace>
...
stebz(
    ...
    const VectorD& d, const VectorE& e, fortran_int_t& m, fortran_int_t& nsplit,
    VectorW& w, VectorIBLOCK& iblock, VectorISPLIT& isplit, Workspace work
) {
  return stebz_impl<typename bindings::value_type<VectorD>::type>::invoke(
      range, order, n, vl, vu, il, iu, abstol, d, e, m, nsplit, w, iblock,
      isplit, work
  );
}
...
template <
    typename VectorD, typename VectorE, typename VectorW, typename VectorIBLOCK,
    typename VectorISPLIT>
inline typename boost::disable_if<
    detail::is_workspace<VectorISPLIT>, std::ptrdiff_t>::type
stebz(
    const char range, const char order, const fortran_int_t n,
    const typename remove_imaginary<
        typename bindings::value_type<VectorD>::type>::type vl,
