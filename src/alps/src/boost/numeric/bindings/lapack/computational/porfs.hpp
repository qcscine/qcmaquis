...
inline std::ptrdiff_t porfs(
    const UpLo, const fortran_int_t n, const fortran_int_t nrhs, const float* a,
    const fortran_int_t lda, const float* af, const fortran_int_t ldaf,
  ...
  LAPACK_SPORFS(
      &lapack_option<UpLo>::value, &n, &nrhs, a, &lda, af, &ldaf, b, &ldb, x,
...
struct porfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixAF, typename MatrixB, typename MatrixX,
      typename VectorFERR, typename VectorBERR, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const MatrixA& a, const MatrixAF& af, const MatrixB& b, MatrixX& x,
    ...
    return detail::porfs(
        uplo(), bindings::size_column(a), bindings::size_column(b),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(a, af, b, x, ferr, berr, workspace(tmp_work, tmp_iwork));
  }
...
struct porfs_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(a, af, b, x, ferr, berr, workspace(tmp_work, tmp_rwork));
  }
...
porfs(
  ...
  return porfs_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, af, b, x, ferr, berr, work
  );
}
...
porfs(
  ...
  return porfs_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, af, b, x, ferr, berr, optimal_workspace()
  );
}
