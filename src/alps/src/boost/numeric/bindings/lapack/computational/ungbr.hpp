...
inline std::ptrdiff_t ungbr(
    const char vect, const fortran_int_t m, const fortran_int_t n,
    const fortran_int_t k, std::complex<float>* a, const fortran_int_t lda,
...
inline std::ptrdiff_t ungbr(
    const char vect, const fortran_int_t m, const fortran_int_t n,
    const fortran_int_t k, std::complex<double>* a, const fortran_int_t lda,
...
struct ungbr_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    BOOST_ASSERT(
        bindings::size(work.select(real_type())) >= min_size_work(m, n)
    );
    BOOST_ASSERT(
    ...
    return detail::ungbr(
        vect, m, n, k, bindings::begin_value(a), bindings::stride_major(a),
  ...
  static std::ptrdiff_t invoke(
      const char vect, const fortran_int_t m, const fortran_int_t n,
      const fortran_int_t k, MatrixA& a, const VectorTAU& tau, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
  ...
  static std::ptrdiff_t invoke(
      const char vect, const fortran_int_t m, const fortran_int_t n,
      const fortran_int_t k, MatrixA& a, const VectorTAU& tau, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
...
struct ungbr_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    BOOST_STATIC_ASSERT((bindings::is_mutable<MatrixA>::value));
    BOOST_ASSERT(
        bindings::size(work.select(value_type())) >= min_size_work(m, n)
    );
    BOOST_ASSERT(
        bindings::size_minor(a) == 1 || bindings::stride_minor(a) == 1
    );
  ...
  static std::ptrdiff_t invoke(
    ...
    namespace bindings = ::boost::numeric::bindings;
    bindings::detail::array<value_type> tmp_work(min_size_work(m, n));
    return invoke(vect, m, n, k, a, tau, workspace(tmp_work));
  }
...
ungbr(
    const char vect, const fortran_int_t m, const fortran_int_t n,
    const fortran_int_t k, MatrixA& a, const VectorTAU& tau, Workspace work
) {
  return ungbr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      vect, m, n, k, a, tau, work
  );
}
...
ungbr(
  ...
  return ungbr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      vect, m, n, k, a, tau, optimal_workspace()
  );
}
