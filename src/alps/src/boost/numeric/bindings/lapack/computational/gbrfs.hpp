...
inline std::ptrdiff_t gbrfs(
    const Trans, const fortran_int_t n, const fortran_int_t kl,
  ...
  LAPACK_SGBRFS(
      &lapack_option<Trans>::value, &n, &kl, &ku, &nrhs, ab, &ldab, afb, &ldafb,
...
struct gbrfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    BOOST_ASSERT(bindings::size(ipiv) >= bindings::size_column_op(ab, trans()));
    BOOST_ASSERT(
    ...
    return detail::gbrfs(
        trans(), bindings::size_column_op(ab, trans()),
        bindings::bandwidth_lower_op(ab, trans()),
        (bindings::bandwidth_upper_op(ab, trans()) -
         bindings::bandwidth_lower_op(ab, trans())),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        ab, afb, ipiv, b, x, ferr, berr, workspace(tmp_work, tmp_iwork)
    );
  }
...
struct gbrfs_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        ab, afb, ipiv, b, x, ferr, berr, workspace(tmp_work, tmp_rwork)
    );
  }
...
gbrfs(
  ...
  return gbrfs_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      ab, afb, ipiv, b, x, ferr, berr, work
  );
}
...
gbrfs(
  ...
  return gbrfs_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      ab, afb, ipiv, b, x, ferr, berr, optimal_workspace()
  );
}
