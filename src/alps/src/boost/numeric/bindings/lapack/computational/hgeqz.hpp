...
// * float value-type.
//
inline std::ptrdiff_t hgeqz(
    const char job, const char compq, const char compz, const fortran_int_t n,
    const fortran_int_t ilo, const fortran_int_t ihi, float* h,
    const fortran_int_t ldh, float* t, const fortran_int_t ldt, float* alphar,
    float* alphai, float* beta, float* q, const fortran_int_t ldq, float* z,
    const fortran_int_t ldz, float* work, const fortran_int_t lwork
) {
  fortran_int_t info(0);
  LAPACK_SHGEQZ(
      &job, &compq, &compz, &n, &ilo, &ihi, h, &ldh, t, &ldt, alphar, alphai,
...
inline std::ptrdiff_t hgeqz(
    ...
    const fortran_int_t ldh, double* t, const fortran_int_t ldt, double* alphar,
    double* alphai, double* beta, double* q, const fortran_int_t ldq, double* z,
...
inline std::ptrdiff_t hgeqz(
    const char job, const char compq, const char compz, const fortran_int_t n,
    const fortran_int_t ilo, const fortran_int_t ihi, std::complex<float>* h,
    const fortran_int_t ldh, std::complex<float>* t, const fortran_int_t ldt,
    std::complex<float>* alpha, std::complex<float>* beta,
    std::complex<float>* q, const fortran_int_t ldq, std::complex<float>* z,
    const fortran_int_t ldz, std::complex<float>* work,
    const fortran_int_t lwork, float* rwork
) {
  fortran_int_t info(0);
  LAPACK_CHGEQZ(
      &job, &compq, &compz, &n, &ilo, &ihi, h, &ldh, t, &ldt, alpha, beta, q,
...
inline std::ptrdiff_t hgeqz(
    const char job, const char compq, const char compz, const fortran_int_t n,
    const fortran_int_t ilo, const fortran_int_t ihi, std::complex<double>* h,
    const fortran_int_t ldh, std::complex<double>* t, const fortran_int_t ldt,
    std::complex<double>* alpha, std::complex<double>* beta,
    std::complex<double>* q, const fortran_int_t ldq, std::complex<double>* z,
...
struct hgeqz_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixH, typename MatrixT, typename VectorALPHAR,
  ...
  static std::ptrdiff_t invoke(
      ...
      const fortran_int_t ilo, MatrixH& h, MatrixT& t, VectorALPHAR& alphar,
    ...
    BOOST_ASSERT(
        bindings::size_minor(h) == 1 || bindings::stride_minor(h) == 1
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(
        bindings::stride_major(h) >=
        std::max<std::ptrdiff_t>(1, bindings::size_column(h))
    );
    BOOST_ASSERT(
    ...
    return detail::hgeqz(
        job, compq, compz, bindings::size_column(h), ilo,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        job, compq, compz, ilo, h, t, alphar, alphai, beta, q, z,
        workspace(tmp_work)
    );
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::hgeqz(
        ...
        bindings::begin_value(alphai), bindings::begin_value(beta),
        bindings::begin_value(q), bindings::stride_major(q),
        bindings::begin_value(z), bindings::stride_major(z), &opt_size_work, -1
    );
    bindings::detail::array<real_type> tmp_work(
...
struct hgeqz_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  //
  template <
      typename MatrixH, typename MatrixT, typename VectorALPHA,
      typename VectorBETA, typename MatrixQ, typename MatrixZ, typename WORK,
      typename RWORK>
  static std::ptrdiff_t invoke(
      const char job, const char compq, const char compz,
      const fortran_int_t ilo, MatrixH& h, MatrixT& t, VectorALPHA& alpha,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        job, compq, compz, ilo, h, t, alpha, beta, q, z,
...
hgeqz(
    const char job, const char compq, const char compz, const fortran_int_t ilo,
    MatrixH& h, MatrixT& t, VectorALPHAR& alphar, VectorALPHAI& alphai,
    VectorBETA& beta, MatrixQ& q, MatrixZ& z, Workspace work
) {
  return hgeqz_impl<typename bindings::value_type<MatrixH>::type>::invoke(
      job, compq, compz, ilo, h, t, alphar, alphai, beta, q, z, work
  );
}
...
template <
    typename MatrixH, typename MatrixT, typename VectorALPHA,
    typename VectorBETA, typename MatrixQ, typename MatrixZ, typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
hgeqz(
    const char job, const char compq, const char compz, const fortran_int_t ilo,
    MatrixH& h, MatrixT& t, VectorALPHA& alpha, VectorBETA& beta, MatrixQ& q,
    MatrixZ& z, Workspace work
) {
  return hgeqz_impl<typename bindings::value_type<MatrixH>::type>::invoke(
      job, compq, compz, ilo, h, t, alpha, beta, q, z, work
  );
}
...
hgeqz(
  ...
  return hgeqz_impl<typename bindings::value_type<MatrixH>::type>::invoke(
      job, compq, compz, ilo, h, t, alpha, beta, q, z, optimal_workspace()
  );
}
