...
ormqr(
  ...
  return ormqr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      side, a, tau, c, work
  );
}
...
ormqr(const Side side, const MatrixA& a, const VectorTAU& tau, MatrixC& c) {
  return ormqr_impl<typename bindings::value_type<MatrixA>::type>::invoke(
