...
inline std::ptrdiff_t tgsen(
    ...
    const fortran_int_t lwork, fortran_int_t* iwork, const fortran_int_t liwork
) {
  fortran_int_t info(0);
  LAPACK_STGSEN(
      &ijob, &wantq, &wantz, select, &n, a, &lda, b, &ldb, alphar, alphai, beta,
...
inline std::ptrdiff_t tgsen(
    ...
    std::complex<float>* beta, std::complex<float>* q, const fortran_int_t ldq,
  ...
  fortran_int_t info(0);
  LAPACK_CTGSEN(
      &ijob, &wantq, &wantz, select, &n, a, &lda, b, &ldb, alpha, beta, q, &ldq,
...
struct tgsen_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  template <
      ...
      typename MatrixQ, typename MatrixZ, typename VectorDIF, typename WORK,
      typename IWORK>
  static std::ptrdiff_t invoke(
      const fortran_int_t ijob, const fortran_bool_t wantq,
      const fortran_bool_t wantz, const VectorSELECT& select, MatrixA& a,
      MatrixB& b, VectorALPHAR& alphar, VectorALPHAI& alphai, VectorBETA& beta,
      MatrixQ& q, MatrixZ& z, fortran_int_t& m, real_type& pl, real_type& pr,
    ...
    return detail::tgsen(
        ijob, wantq, wantz, bindings::begin_value(select),
        ...
        bindings::begin_value(z), bindings::stride_major(z), m, pl, pr,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        ijob, wantq, wantz, select, a, b, alphar, alphai, beta, q, z, m, pl, pr,
        dif, workspace(tmp_work, tmp_iwork)
    );
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::tgsen(
        ...
        bindings::begin_value(q), bindings::stride_major(q),
        bindings::begin_value(z), bindings::stride_major(z), m, pl, pr,
        bindings::begin_value(dif), &opt_size_work, -1, &opt_size_iwork, -1
    );
    bindings::detail::array<real_type> tmp_work(
        traits::detail::to_int(opt_size_work)
    );
    bindings::detail::array<fortran_int_t> tmp_iwork(opt_size_iwork);
    return invoke(
        ijob, wantq, wantz, select, a, b, alphar, alphai, beta, q, z, m, pl, pr,
        dif, workspace(tmp_work, tmp_iwork)
    );
  ...
  static std::ptrdiff_t min_size_work(
      const std::ptrdiff_t ijob, const std::ptrdiff_t n, fortran_int_t& m
  ) {
...
struct tgsen_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  template <
      ...
      typename MatrixZ, typename VectorDIF, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const fortran_int_t ijob, const fortran_bool_t wantq,
      const fortran_bool_t wantz, const VectorSELECT& select, MatrixA& a,
      MatrixB& b, VectorALPHA& alpha, VectorBETA& beta, MatrixQ& q, MatrixZ& z,
      fortran_int_t& m, real_type& pl, real_type& pr, VectorDIF& dif,
    ...
    return detail::tgsen(
        ...
        bindings::stride_major(z), m, pl, pr, bindings::begin_value(dif),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        ijob, wantq, wantz, select, a, b, alpha, beta, q, z, m, pl, pr, dif,
...
template <
    typename VectorSELECT, typename MatrixA, typename MatrixB,
    typename VectorALPHAR, typename VectorALPHAI, typename VectorBETA,
    typename MatrixQ, typename MatrixZ, typename VectorDIF, typename Workspace>
...
tgsen(
  ...
  return tgsen_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      ijob, wantq, wantz, select, a, b, alphar, alphai, beta, q, z, m, pl, pr,
      dif, work
  );
}
...
tgsen(
  ...
  return tgsen_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      ijob, wantq, wantz, select, a, b, alpha, beta, q, z, m, pl, pr, dif, work
  );
}
