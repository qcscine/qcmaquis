...
inline std::ptrdiff_t pprfs(
  ...
  LAPACK_SPPRFS(
      &lapack_option<UpLo>::value, &n, &nrhs, ap, afp, b, &ldb, x, &ldx, ferr,
...
struct pprfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAP, typename MatrixAFP, typename MatrixB, typename MatrixX,
      typename VectorFERR, typename VectorBERR, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const MatrixAP& ap, const MatrixAFP& afp, const MatrixB& b, MatrixX& x,
    ...
    BOOST_STATIC_ASSERT(
        (std::is_same<
            ...
            typename remove_const<
                typename bindings::value_type<MatrixAFP>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (std::is_same<
            typename remove_const<
    ...
    return detail::pprfs(
        ...
        bindings::begin_value(ap), bindings::begin_value(afp),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(ap, afp, b, x, ferr, berr, workspace(tmp_work, tmp_iwork));
  }
...
struct pprfs_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(ap, afp, b, x, ferr, berr, workspace(tmp_work, tmp_rwork));
  }
...
pprfs(
  ...
  return pprfs_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      ap, afp, b, x, ferr, berr, work
  );
}
...
pprfs(
  ...
  return pprfs_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      ap, afp, b, x, ferr, berr, optimal_workspace()
  );
}
