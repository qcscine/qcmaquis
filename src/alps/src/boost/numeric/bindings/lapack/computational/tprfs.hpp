...
inline std::ptrdiff_t tprfs(
  ...
  LAPACK_STPRFS(
      ...
      &lapack_option<Diag>::value, &n, &nrhs, ap, b, &ldb, x, &ldx, ferr, berr,
      work, iwork, &info
  );
  return info;
}
...
struct tprfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAP, typename MatrixB, typename MatrixX,
      typename VectorFERR, typename VectorBERR, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const MatrixAP& ap, const MatrixB& b, const MatrixX& x, VectorFERR& ferr,
    ...
    BOOST_ASSERT(
        ...
        std::max<std::ptrdiff_t>(1, bindings::size_column_op(ap, trans()))
    );
    BOOST_ASSERT(
    ...
    return detail::tprfs(
        uplo(), trans(), diag(), bindings::size_column_op(ap, trans()),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(ap, b, x, ferr, berr, workspace(tmp_work, tmp_iwork));
  }
...
struct tprfs_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(ap, b, x, ferr, berr, workspace(tmp_work, tmp_rwork));
  }
...
//
template <
    typename MatrixAP, typename MatrixB, typename MatrixX, typename VectorFERR,
...
tprfs(
  ...
  return tprfs_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      ap, b, x, ferr, berr, work
  );
}
...
tprfs(
  ...
  return tprfs_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      ap, b, x, ferr, berr, optimal_workspace()
  );
}
