...
inline std::ptrdiff_t trevc(
    const Side, const char howmny, fortran_bool_t* select,
  ...
  LAPACK_STREVC(
      &lapack_option<Side>::value, &howmny, select, &n, t, &ldt, vl, &ldvl, vr,
      &ldvr, &mm, &m, work, &info
  );
  return info;
}
...
inline std::ptrdiff_t trevc(
    const Side, const char howmny, fortran_bool_t* select,
    const fortran_int_t n, const double* t, const fortran_int_t ldt, double* vl,
...
inline std::ptrdiff_t trevc(
    ...
    const fortran_int_t n, std::complex<float>* t, const fortran_int_t ldt,
...
inline std::ptrdiff_t trevc(
    const Side, const char howmny, const fortran_bool_t* select,
    const fortran_int_t n, std::complex<double>* t, const fortran_int_t ldt,
...
struct trevc_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename Side, typename VectorSELECT, typename MatrixT, typename MatrixVL,
      typename MatrixVR, typename WORK>
  static std::ptrdiff_t invoke(
      const Side side, const char howmny, VectorSELECT& select,
      const MatrixT& t, MatrixVL& vl, MatrixVR& vr, const fortran_int_t mm,
    ...
    return detail::trevc(
        side, howmny, bindings::begin_value(select), bindings::size_column(t),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(side, howmny, select, t, vl, vr, mm, m, workspace(tmp_work));
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    namespace bindings = ::boost::numeric::bindings;
    return invoke(side, howmny, select, t, vl, vr, mm, m, minimal_workspace());
  }
...
struct trevc_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        side, howmny, select, t, vl, vr, mm, m, workspace(tmp_work, tmp_rwork)
    );
  }
...
trevc(
    const Side side, const char howmny, VectorSELECT& select, MatrixT& t,
    MatrixVL& vl, MatrixVR& vr, const fortran_int_t mm, fortran_int_t& m,
    Workspace work
) {
  return trevc_impl<typename bindings::value_type<MatrixT>::type>::invoke(
      side, howmny, select, t, vl, vr, mm, m, work
  );
}
...
trevc(
  ...
  return trevc_impl<typename bindings::value_type<MatrixT>::type>::invoke(
      side, howmny, select, t, vl, vr, mm, m, optimal_workspace()
  );
}
...
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
trevc(
    const Side side, const char howmny, const VectorSELECT& select, MatrixT& t,
    MatrixVL& vl, MatrixVR& vr, const fortran_int_t mm, fortran_int_t& m,
    Workspace work
) {
  return trevc_impl<typename bindings::value_type<MatrixT>::type>::invoke(
...
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
trevc(
    const Side side, const char howmny, VectorSELECT& select, const MatrixT& t,
    MatrixVL& vl, MatrixVR& vr, const fortran_int_t mm, fortran_int_t& m,
    Workspace work
) {
  return trevc_impl<typename bindings::value_type<MatrixT>::type>::invoke(
