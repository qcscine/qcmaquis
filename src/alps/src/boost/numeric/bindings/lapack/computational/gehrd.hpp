...
inline std::ptrdiff_t gehrd(
    const fortran_int_t n, const fortran_int_t ilo, const fortran_int_t ihi,
    std::complex<float>* a, const fortran_int_t lda, std::complex<float>* tau,
...
inline std::ptrdiff_t gehrd(
    const fortran_int_t n, const fortran_int_t ilo, const fortran_int_t ihi,
    std::complex<double>* a, const fortran_int_t lda, std::complex<double>* tau,
...
struct gehrd_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return detail::gehrd(
        bindings::size_column(a), ilo, ihi, bindings::begin_value(a),
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::gehrd(
        bindings::size_column(a), ilo, ihi, bindings::begin_value(a),
        bindings::stride_major(a), bindings::begin_value(tau), &opt_size_work,
        -1
    );
    bindings::detail::array<real_type> tmp_work(
...
gehrd(
  ...
  return gehrd_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      ilo, ihi, a, tau, work
  );
}
...
gehrd(
    const fortran_int_t ilo, const fortran_int_t ihi, MatrixA& a, VectorTAU& tau
) {
  return gehrd_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      ilo, ihi, a, tau, optimal_workspace()
  );
}
