...
inline std::ptrdiff_t trrfs(
  ...
  LAPACK_STRRFS(
      ...
      &lapack_option<Diag>::value, &n, &nrhs, a, &lda, b, &ldb, x, &ldx, ferr,
...
struct trrfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename MatrixX, typename VectorFERR,
      typename VectorBERR, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const MatrixA& a, const MatrixB& b, const MatrixX& x, VectorFERR& ferr,
    ...
    return detail::trrfs(
        uplo(), trans(), diag(), bindings::size_column_op(a, trans()),
...
trrfs(
  ...
  return trrfs_impl<typename bindings::value_type<MatrixA>::type>::invoke(
