...
inline std::ptrdiff_t getrf(
    Order, const int m, const int n, float* a, const int lda, int* ipiv
) {
  return clapack_sgetrf(clapack_option<Order>::value, m, n, a, lda, ipiv);
}
...
template <typename Order>
inline std::ptrdiff_t getrf(
    Order, const int m, const int n, double* a, const int lda, int* ipiv
) {
  return clapack_dgetrf(clapack_option<Order>::value, m, n, a, lda, ipiv);
}
...
template <typename Order>
inline std::ptrdiff_t getrf(
    Order, const int m, const int n, std::complex<float>* a, const int lda,
    int* ipiv
) {
  return clapack_cgetrf(clapack_option<Order>::value, m, n, a, lda, ipiv);
}
...
template <typename Order>
inline std::ptrdiff_t getrf(
    Order, const int m, const int n, std::complex<double>* a, const int lda,
    int* ipiv
) {
  return clapack_zgetrf(clapack_option<Order>::value, m, n, a, lda, ipiv);
}
...
template <typename Order>
inline std::ptrdiff_t getrf(
    Order, const fortran_int_t m, const fortran_int_t n, float* a,
...
template <typename Order>
inline std::ptrdiff_t getrf(
    Order, const fortran_int_t m, const fortran_int_t n, double* a,
    const fortran_int_t lda, fortran_int_t* ipiv
) {
  BOOST_STATIC_ASSERT((is_same<Order, tag::column_major>::value));
  fortran_int_t info(0);
...
template <typename Order>
inline std::ptrdiff_t getrf(
    Order, const fortran_int_t m, const fortran_int_t n, std::complex<float>* a,
    const fortran_int_t lda, fortran_int_t* ipiv
) {
  BOOST_STATIC_ASSERT((is_same<Order, tag::column_major>::value));
  fortran_int_t info(0);
...
template <typename Order>
inline std::ptrdiff_t getrf(
    Order, const fortran_int_t m, const fortran_int_t n,
...
struct getrf_impl {
  ...
  static std::ptrdiff_t invoke(MatrixA& a, VectorIPIV& ipiv) {
    ...
    return detail::getrf(
        order(), bindings::size_row(a), bindings::size_column(a),
...
inline std::ptrdiff_t getrf(MatrixA& a, VectorIPIV& ipiv) {
  return getrf_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, ipiv
  );
}
