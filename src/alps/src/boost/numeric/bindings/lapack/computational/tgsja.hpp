...
// * float value-type.
//
inline std::ptrdiff_t tgsja(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t p, const fortran_int_t n, const fortran_int_t k,
    const fortran_int_t l, float* a, const fortran_int_t lda, float* b,
    const fortran_int_t ldb, const float tola, const float tolb, float* alpha,
    float* beta, float* u, const fortran_int_t ldu, float* v,
    const fortran_int_t ldv, float* q, const fortran_int_t ldq, float* work,
    fortran_int_t& ncycle
) {
  fortran_int_t info(0);
  LAPACK_STGSJA(
      &jobu, &jobv, &jobq, &m, &p, &n, &k, &l, a, &lda, b, &ldb, &tola, &tolb,
...
inline std::ptrdiff_t tgsja(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t p, const fortran_int_t n, const fortran_int_t k,
    const fortran_int_t l, double* a, const fortran_int_t lda, double* b,
    const fortran_int_t ldb, const double tola, const double tolb,
    double* alpha, double* beta, double* u, const fortran_int_t ldu, double* v,
    const fortran_int_t ldv, double* q, const fortran_int_t ldq, double* work,
    fortran_int_t& ncycle
) {
  fortran_int_t info(0);
  LAPACK_DTGSJA(
...
inline std::ptrdiff_t tgsja(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t p, const fortran_int_t n, const fortran_int_t k,
    const fortran_int_t l, std::complex<float>* a, const fortran_int_t lda,
    std::complex<float>* b, const fortran_int_t ldb, const float tola,
    const float tolb, float* alpha, float* beta, std::complex<float>* u,
    const fortran_int_t ldu, std::complex<float>* v, const fortran_int_t ldv,
    std::complex<float>* q, const fortran_int_t ldq, std::complex<float>* work,
    fortran_int_t& ncycle
) {
  fortran_int_t info(0);
  LAPACK_CTGSJA(
...
inline std::ptrdiff_t tgsja(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t p, const fortran_int_t n, const fortran_int_t k,
    const fortran_int_t l, std::complex<double>* a, const fortran_int_t lda,
    std::complex<double>* b, const fortran_int_t ldb, const double tola,
    const double tolb, double* alpha, double* beta, std::complex<double>* u,
    const fortran_int_t ldu, std::complex<double>* v, const fortran_int_t ldv,
    std::complex<double>* q, const fortran_int_t ldq,
    std::complex<double>* work, fortran_int_t& ncycle
) {
  fortran_int_t info(0);
  LAPACK_ZTGSJA(
      &jobu, &jobv, &jobq, &m, &p, &n, &k, &l, a, &lda, b, &ldb, &tola, &tolb,
...
struct tgsja_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobu, const char jobv, const char jobq, const fortran_int_t k,
      const fortran_int_t l, MatrixA& a, MatrixB& b, const real_type tola,
      const real_type tolb, VectorALPHA& alpha, VectorBETA& beta, MatrixU& u,
    ...
    return detail::tgsja(
        ...
        bindings::size_column(a), k, l, bindings::begin_value(a),
        bindings::stride_major(a), bindings::begin_value(b),
        bindings::stride_major(b), tola, tolb, bindings::begin_value(alpha),
  ...
  static std::ptrdiff_t invoke(
      ...
      const fortran_int_t l, MatrixA& a, MatrixB& b, const real_type tola,
      const real_type tolb, VectorALPHA& alpha, VectorBETA& beta, MatrixU& u,
      MatrixV& v, MatrixQ& q, fortran_int_t& ncycle, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    ...
    return invoke(
        jobu, jobv, jobq, k, l, a, b, tola, tolb, alpha, beta, u, v, q, ncycle,
        workspace(tmp_work)
    );
  }
  ...
  static std::ptrdiff_t invoke(
      ...
      const fortran_int_t l, MatrixA& a, MatrixB& b, const real_type tola,
      const real_type tolb, VectorALPHA& alpha, VectorBETA& beta, MatrixU& u,
      MatrixV& v, MatrixQ& q, fortran_int_t& ncycle, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    return invoke(
        jobu, jobv, jobq, k, l, a, b, tola, tolb, alpha, beta, u, v, q, ncycle,
...
tgsja(
    ...
    VectorALPHA& alpha, VectorBETA& beta, MatrixU& u, MatrixV& v, MatrixQ& q,
    fortran_int_t& ncycle, Workspace work
) {
  return tgsja_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobu, jobv, jobq, k, l, a, b, tola, tolb, alpha, beta, u, v, q, ncycle,
      work
  );
}
