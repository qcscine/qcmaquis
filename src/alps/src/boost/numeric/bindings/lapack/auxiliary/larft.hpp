...
// * float value-type.
//
inline std::ptrdiff_t larft(
    const char direct, const char storev, const fortran_int_t n,
    const fortran_int_t k, float* v, const fortran_int_t ldv, const float* tau,
    float* t, const fortran_int_t ldt
) {
...
inline std::ptrdiff_t larft(
    const char direct, const char storev, const fortran_int_t n,
    const fortran_int_t k, std::complex<float>* v, const fortran_int_t ldv,
    const std::complex<float>* tau, std::complex<float>* t,
...
inline std::ptrdiff_t larft(
    const char direct, const char storev, const fortran_int_t n,
    const fortran_int_t k, std::complex<double>* v, const fortran_int_t ldv,
    const std::complex<double>* tau, std::complex<double>* t,
    const fortran_int_t ldt
) {
  fortran_int_t info(0);
...
struct larft_impl {
  ...
  static std::ptrdiff_t invoke(
      const char direct, const char storev, const fortran_int_t n,
      const fortran_int_t k, MatrixV& v, const VectorTAU& tau, MatrixT& t
  ) {
    ...
    return detail::larft(
        direct, storev, n, k, bindings::begin_value(v),
...
inline std::ptrdiff_t larft(
  ...
  return larft_impl<typename bindings::value_type<MatrixV>::type>::invoke(
      direct, storev, n, k, v, tau, t
  );
}
