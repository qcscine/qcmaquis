...
inline std::ptrdiff_t lalsd(
  ...
  LAPACK_SLALSD(
      &uplo, &smlsiz, &n, &nrhs, d, e, b, &ldb, &rcond, &rank, work, iwork,
      &info
  );
  return info;
}
...
inline std::ptrdiff_t lalsd(
    const char uplo, const fortran_int_t smlsiz, const fortran_int_t n,
    const fortran_int_t nrhs, float* d, float* e, std::complex<float>* b,
    const fortran_int_t ldb, const float rcond, fortran_int_t& rank,
    std::complex<float>* work, float* rwork, fortran_int_t* iwork
) {
  fortran_int_t info(0);
  LAPACK_CLALSD(
      &uplo, &smlsiz, &n, &nrhs, d, e, b, &ldb, &rcond, &rank, work, rwork,
      iwork, &info
  );
  return info;
}
...
inline std::ptrdiff_t lalsd(
    const char uplo, const fortran_int_t smlsiz, const fortran_int_t n,
    const fortran_int_t nrhs, double* d, double* e, std::complex<double>* b,
    const fortran_int_t ldb, const double rcond, fortran_int_t& rank,
...
struct lalsd_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename VectorD, typename VectorE, typename MatrixB, typename WORK,
      typename IWORK>
  static std::ptrdiff_t invoke(
    ...
    std::ptrdiff_t nlvl = std::max<std::ptrdiff_t>(
        0,
        static_cast<std::ptrdiff_t>(
            std::log(
                static_cast<real_type>(n) / static_cast<real_type>(smlsiz + 1)
            ) /
            std::log(static_cast<real_type>(2.))
        ) + 1
    );
    BOOST_ASSERT(bindings::size(e) >= n - 1);
    BOOST_ASSERT(
        bindings::size(work.select(fortran_int_t())) >= min_size_iwork(n, nlvl)
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(n >= 0);
    return detail::lalsd(
        uplo, smlsiz, n, bindings::size_column(b), bindings::begin_value(d),
        bindings::begin_value(e), bindings::begin_value(b),
        bindings::stride_major(b), rcond, rank,
  ...
  static std::ptrdiff_t invoke(
    ...
    bindings::detail::array<fortran_int_t> tmp_iwork(min_size_iwork(n, nlvl));
    return invoke(
        uplo, smlsiz, n, d, e, b, rcond, rank, workspace(tmp_work, tmp_iwork)
    );
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    namespace bindings = ::boost::numeric::bindings;
    return invoke(uplo, smlsiz, n, d, e, b, rcond, rank, minimal_workspace());
  }
  ...
  static std::ptrdiff_t min_size_work(
      const std::ptrdiff_t n, const std::ptrdiff_t smlsiz,
      const std::ptrdiff_t nlvl, const std::ptrdiff_t nrhs
  ) {
  ...
  static std::ptrdiff_t min_size_iwork(
      const std::ptrdiff_t n, const std::ptrdiff_t nlvl
  ) {
...
struct lalsd_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char uplo, const fortran_int_t smlsiz, const fortran_int_t n,
      VectorD& d, VectorE& e, MatrixB& b, const real_type rcond,
      fortran_int_t& rank, detail::workspace3<WORK, RWORK, IWORK> work
  ) {
    namespace bindings = ::boost::numeric::bindings;
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixB>::value));
    BOOST_STATIC_ASSERT(
  ...
  static std::ptrdiff_t invoke(
    ...
    bindings::detail::array<fortran_int_t> tmp_iwork(min_size_iwork(n, nlvl));
    return invoke(
        uplo, smlsiz, n, d, e, b, rcond, rank,
...
//
template <
    typename VectorD, typename VectorE, typename MatrixB, typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
lalsd(
    const char uplo, const fortran_int_t smlsiz, const fortran_int_t n,
    VectorD& d, VectorE& e, MatrixB& b,
    const typename remove_imaginary<
        typename bindings::value_type<MatrixB>::type>::type rcond,
    fortran_int_t& rank, Workspace work
) {
  return lalsd_impl<typename bindings::value_type<MatrixB>::type>::invoke(
      uplo, smlsiz, n, d, e, b, rcond, rank, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<MatrixB>, std::ptrdiff_t>::type
lalsd(
    const char uplo, const fortran_int_t smlsiz, const fortran_int_t n,
    VectorD& d, VectorE& e, MatrixB& b,
    const typename remove_imaginary<
  ...
  return lalsd_impl<typename bindings::value_type<MatrixB>::type>::invoke(
      uplo, smlsiz, n, d, e, b, rcond, rank, optimal_workspace()
  );
}
