...
inline std::ptrdiff_t lansp(
    const char norm, const UpLo, const fortran_int_t n, const float* ap,
    float* work
) {
...
template <typename UpLo>
inline std::ptrdiff_t lansp(
    const char norm, const UpLo, const fortran_int_t n, const double* ap,
    double* work
) {
  fortran_int_t info(0);
...
template <typename UpLo>
inline std::ptrdiff_t lansp(
    const char norm, const UpLo, const fortran_int_t n,
...
struct lansp_impl {
  ...
  static std::ptrdiff_t invoke(
      const char norm, const MatrixAP& ap, detail::workspace1<WORK> work
  ) {
    ...
    return detail::lansp(
        norm, uplo(), bindings::size_column(ap), bindings::begin_value(ap),
  ...
  static std::ptrdiff_t invoke(
      const char norm, const MatrixAP& ap, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAP>::type uplo;
  ...
  template <typename MatrixAP>
  static std::ptrdiff_t invoke(
      const char norm, const MatrixAP& ap, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAP>::type uplo;
...
lansp(const char norm, const MatrixAP& ap, Workspace work) {
  return lansp_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      norm, ap, work
  );
}
