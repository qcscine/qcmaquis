...
inline std::ptrdiff_t lantp(
    const char norm, const char uplo, const Diag, const fortran_int_t n,
...
struct lantp_impl {
  ...
  static std::ptrdiff_t invoke(
      const char norm, const char uplo, const MatrixAP& ap,
  ...
  static std::ptrdiff_t invoke(
      const char norm, const char uplo, const MatrixAP& ap, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::diag_tag<MatrixAP>::type diag;
  ...
  template <typename MatrixAP>
  static std::ptrdiff_t invoke(
      const char norm, const char uplo, const MatrixAP& ap, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::diag_tag<MatrixAP>::type diag;
...
lantp(const char norm, const char uplo, const MatrixAP& ap, Workspace work) {
  return lantp_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      norm, uplo, ap, work
  );
}
...
lantp(const char norm, const char uplo, const MatrixAP& ap) {
  return lantp_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      norm, uplo, ap, optimal_workspace()
  );
}
