...
struct adaptor<boost::numeric::ublas::matrix_unary2<T, U>, Id, Enable> {
  ...
  typedef mpl::map<
      ...
      mpl::pair<
          tag::size_type<1>, typename mpl::at<map, tag::size_type<1> >::type>,
      mpl::pair<
          tag::size_type<2>, typename mpl::at<map, tag::size_type<2> >::type>,
      mpl::pair<
          tag::data_structure,
          typename mpl::at<map, tag::data_structure>::type>,

      mpl::pair<
          tag::data_order,
          typename mpl::if_<
              is_same<
                  typename mpl::at<map, tag::data_order>::type, tag::row_major>,
              tag::column_major, tag::row_major>::type>,
