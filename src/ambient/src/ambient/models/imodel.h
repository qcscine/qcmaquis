...
namespace ambient { namespace models {
    ...
    public:
        ...
        class layout {
            ...
            class path {
            public:
                virtual void add_node(size_t n) = 0;
            };
            virtual void add_path(size_t i, size_t j, size_t node) = 0;
        ...
        virtual void update_revision(channels::group* scope, revision* object) = 0;
