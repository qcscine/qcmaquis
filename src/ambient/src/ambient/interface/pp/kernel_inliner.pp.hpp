...
struct kernel_inliner<void(K::*)( T0& , T1& , T2& , T3& , T4& , T5& , T6& , T7& , T8& , T9& , T10& ), fp> {
    ...
    static inline void invoke(K* o){
        (o->*fp)( info<T0>::typed::revised<0>(o) , info<T1>::typed::revised<1>(o) , info<T2>::typed::revised<2>(o) , info<T3>::typed::revised<3>(o) , info<T4>::typed::revised<4>(o) , info<T5>::typed::revised<5>(o) , info<T6>::typed::revised<6>(o) , info<T7>::typed::revised<7>(o) , info<T8>::typed::revised<8>(o) , info<T9>::typed::revised<9>(o) , info<T10>::typed::revised<10>(o) );
    }
    static inline void cleanup(sfunctor* o){
    ...
    static inline void weight(cfunctor* o){
        info<T0>::typed::weight<0>(o); info<T1>::typed::weight<1>(o); info<T2>::typed::weight<2>(o); info<T3>::typed::weight<3>(o); info<T4>::typed::weight<4>(o); info<T5>::typed::weight<5>(o); info<T6>::typed::weight<6>(o); info<T7>::typed::weight<7>(o); info<T8>::typed::weight<8>(o); info<T9>::typed::weight<9>(o); info<T10>::typed::weight<10>(o);
    }
    static inline void place(sfunctor* o){
