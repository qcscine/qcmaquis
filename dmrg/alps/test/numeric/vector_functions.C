...
int main(int argc, char** argv) {
  ...
  std::cout << "\nA: \n";
  std::copy(
      vecA.begin(), vecA.end(), std::ostream_iterator<double>(std::cout, "\n")
  );

  std::cout << "\nB: \n";
  std::copy(
      vecB.begin(), vecB.end(), std::ostream_iterator<double>(std::cout, "\n")
  );
  ...
  std::cout << "\n+A: \n";
  std::copy(
      res.begin(), res.end(), std::ostream_iterator<double>(std::cout, "\n")
  );
