...
BOOST_AUTO_TEST_CASE_TEMPLATE(
    transpose_matrix_matrix_multiply_test, T, test_types
) {
  matrix<T> a(30, 20);
  matrix<T> b(30, 50);
  fill_matrix_with_numbers(a);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(
    matrix_transpose_matrix_multiply_test, T, test_types
) {
  matrix<T> a(20, 30);
  matrix<T> b(50, 30);
  fill_matrix_with_numbers(a);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(
    transpose_conugate_matrix_matrix_multiply_test, T, test_types
) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(
    transpose_transpose_multiply_test, T, test_types
) {
  matrix<T> a(50, 60);
  matrix<T> b(40, 50);
  fill_matrix_with_numbers(a);
