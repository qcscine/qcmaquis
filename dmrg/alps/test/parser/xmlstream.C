...
/* $Id: xmlstream.C 6149 2012-05-14 05:59:33Z wistaria $ */
...
int main() {
  ...
  try {
    ...
    oxs << alps::start_tag("tag0") << alps::attribute("name0", 1)

        << "this is a text"

        << alps::start_tag("tag1") << alps::start_tag("tag2")
        ...
        << alps::start_tag("tag3") << alps::end_tag

        << alps::precision(x, 6)

        << alps::start_tag("tag4") << alps::no_linebreak << "no linebreak"
        << alps::end_tag

        << alps::end_tag("tag2") << alps::end_tag("tag1") << alps::end_tag;
