...
#define ALPS_ACCUMULATOR_VALUE_TYPES                                         \
  double, int, std::array<double, 3>, std::vector<double>, std::vector<int>, \
...
BOOST_AUTO_TEST_CASE(ngs_alea_next) {
  ...
  accumulator_set::register_serializable_type<impl::Accumulator<
      double, mean_tag,
      impl::Accumulator<double, count_tag, impl::AccumulatorBase<double> > > >(
  );
  ...
  accumulator_set::register_serializable_type<impl::Accumulator<
      ...
      impl::Accumulator<
          double, mean_tag,
          impl::Accumulator<
              double, count_tag, impl::AccumulatorBase<double> > > > >();

  accumulator_set::register_serializable_type<impl::Accumulator<
      double,
      weight_holder_tag<impl::Accumulator<
          double, mean_tag,
          impl::Accumulator<
              double, count_tag, impl::AccumulatorBase<double> > > >,
      impl::Accumulator<
  ...
  accumulator_set::register_serializable_type<impl::Accumulator<
      std::vector<double>, mean_tag,
      impl::Accumulator<
          std::vector<double>, count_tag,
          impl::AccumulatorBase<std::vector<double> > > > >();

  accumulator_set::register_serializable_type<impl::Accumulator<
      std::vector<double>, max_num_binning_tag,
      impl::Accumulator<
          std::vector<double>, error_tag,
          impl::Accumulator<
              std::vector<double>, mean_tag,
              impl::Accumulator<
                  std::vector<double>, count_tag,
  ...
  accumulator_set::register_serializable_type<impl::Accumulator<
      alps::multi_array<double, 3>, mean_tag,
      impl::Accumulator<
          alps::multi_array<double, 3>, count_tag,
          impl::AccumulatorBase<alps::multi_array<double, 3> > > > >();

  accumulator_set::register_serializable_type<impl::Accumulator<
      alps::multi_array<double, 3>, max_num_binning_tag,
      impl::Accumulator<
          alps::multi_array<double, 3>, error_tag,
          impl::Accumulator<
              alps::multi_array<double, 3>, mean_tag,
              impl::Accumulator<
                  alps::multi_array<double, 3>, count_tag,
                  impl::AccumulatorBase<
                      alps::multi_array<double, 3> > > > > > >();

  accumulator_set accumulators;
  accumulators.insert(
      "mean", boost::shared_ptr<accumulator_wrapper>(new accumulator_wrapper(
                  impl::Accumulator<
                      double, mean_tag,
                      impl::Accumulator<
                          double, count_tag, impl::AccumulatorBase<double> > >()
  ...
  accumulators.insert(
      "count",
      boost::shared_ptr<accumulator_wrapper>(new accumulator_wrapper(
          impl::Accumulator<double, count_tag, impl::AccumulatorBase<double> >()
      ))
  );
  for (int i = 0; i < 10; ++i) accumulators["count"] << 1.;
  ...
  accumulators.insert(
      "vector", boost::shared_ptr<accumulator_wrapper>(new accumulator_wrapper(
                    impl::Accumulator<
                        std::vector<double>, mean_tag,
                        impl::Accumulator<
                            std::vector<double>, count_tag,
  ...
  BOOST_REQUIRE(std::equal(
      vector_mean.begin(), vector_mean.end(),
      mean(accumulators["vector"].get<std::vector<double> >()).begin()
  ));
  ...
  accumulators.insert(
      ...
      boost::shared_ptr<accumulator_wrapper>(new accumulator_wrapper(
          impl::Accumulator<
              int, mean_tag,
              impl::Accumulator<int, count_tag, impl::AccumulatorBase<int> > >()
      ))
  );
  accumulators["int"](1);
  ...
  accumulators.insert(
      "vecint", boost::shared_ptr<accumulator_wrapper>(new accumulator_wrapper(
                    impl::Accumulator<
                        std::vector<int>, mean_tag,
                        impl::Accumulator<
                            std::vector<int>, count_tag,
                            impl::AccumulatorBase<std::vector<int> > > >()
                ))
  );
  ...
  BOOST_REQUIRE(std::equal(
      vecint_mean.begin(), vecint_mean.end(),
      mean(accumulators["vecint"].get<std::vector<int> >()).begin()
  ));

  accumulators.insert(
      "array", boost::shared_ptr<accumulator_wrapper>(new accumulator_wrapper(
                   impl::Accumulator<
                       std::array<double, 3>, mean_tag,
                       impl::Accumulator<
                           std::array<double, 3>, count_tag,
                           impl::AccumulatorBase<std::array<double, 3> > > >()
               ))
  );
  ...
  BOOST_REQUIRE(std::equal(
      array_val.begin(), array_val.end(),
      mean(accumulators["array"].get<std::array<double, 3> >()).begin()
  ));
  ...
  BOOST_REQUIRE(std::equal(
      multi_array_val.begin(), multi_array_val.end(),
      mean(accumulators["multi_array"].get<alps::multi_array<double, 3> >())
          .begin()
  ));
  ...
  BOOST_REQUIRE(std::equal(
      vectormaxbin_mean.begin(), vectormaxbin_mean.end(),
      mean(accumulators["vectormaxbin"].get<std::vector<double> >()).begin()
  ));
  // TODO: check error ...
  // TODO: check binning ...
  ...
  std::fill(
      multi_array_max_bin_val.origin(), multi_array_max_bin_val.origin() + 8, 1.
  );
...

  {
    ...
    for (accumulator_set::const_iterator it = accumulators.begin();
      ...
      std::cout << it->first << ": " << sa.str() << " <=> " << sa2.str()
                << std::endl;
...

  {
    std::cout << "> \"vector\" + \"vector\":  "
              << results["vector"] + results["vector"] << std::endl;
    std::vector<double> required(3, 6.2 + 6.2);
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean((results["vector"] + results["vector"]).get<std::vector<double> >()
        )
            .begin()
    ));
  }
...

  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean((results["vector"] + 1).get<std::vector<double> >()).begin()
    ));
  }
  {
    std::cout << "> \"vector\" - 1:  " << results["vector"] - 1 << std::endl;
  ...
  }
  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean((results["vector"] * 2).get<std::vector<double> >()).begin()
    ));
  }
  {
    std::cout << "> \"vector\" / 2:  " << results["vector"] / 2 << std::endl;
...

  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean((1 + results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    std::cout << "> 1 - \"vector\":  " << 1 - results["vector"] << std::endl;
  ...
  }
  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean((2 * results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    std::cout << "> 1 / \"vector\":  " << 1 / results["vector"] << std::endl;
...

  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(sin(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(cos(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(tan(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    std::cout << "> sinh(\"vector\"):  " << sinh(results["vector"])
              << std::endl;
    std::vector<double> required(3, std::sinh(6.2));
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(sinh(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    std::cout << "> cosh(\"vector\"):  " << cosh(results["vector"])
              << std::endl;
    std::vector<double> required(3, std::cosh(6.2));
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(cosh(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    std::cout << "> tanh(\"vector\"):  " << tanh(results["vector"])
              << std::endl;
    std::vector<double> required(3, std::tanh(6.2));
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(tanh(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  // TODO: implement
  // {
  // 	std::cout << "> asin(\"vector\"):  " << asin(results["vector"]) <<
  // std::endl; 	std::vector<double> required(3, std::asin(1. / 6.2));
  // 	BOOST_REQUIRE(std::equal(required.begin(), required.end(), mean(asin(1.
  // / results["vector"]).get<std::vector<double> >()).begin()));
  // }
  // {
  // 	std::cout << "> acos(\"vector\"):  " << acos(results["vector"]) <<
  // std::endl; 	std::vector<double> required(3, std::acos(1. / 6.2));
  // 	BOOST_REQUIRE(std::equal(required.begin(), required.end(), mean(acos(1.
  // / results["vector"]).get<std::vector<double> >()).begin()));
  // }
  // {
  // 	std::cout << "> atan(\"vector\"):  " << atan(results["vector"]) <<
  // std::endl; 	std::vector<double> required(3, std::atan(1. / 6.2));
  // 	BOOST_REQUIRE(std::equal(required.begin(), required.end(), mean(atan(1.
  // / results["vector"]).get<std::vector<double> >()).begin()));
  // }
  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(abs(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    std::cout << "> sqrt(\"vector\"):  " << sqrt(results["vector"])
              << std::endl;
    std::vector<double> required(3, std::sqrt(6.2));
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(sqrt(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(log(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(sq(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    ...
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(cb(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  {
    std::cout << "> cbrt(\"vector\"):  " << cbrt(results["vector"])
              << std::endl;
    std::vector<double> required(3, std::pow(6.2, 1. / 3.));
    BOOST_REQUIRE(std::equal(
        required.begin(), required.end(),
        mean(cbrt(results["vector"]).get<std::vector<double> >()).begin()
    ));
  }
  std::cout << std::endl;
...

  {
    ...
    for (result_set::const_iterator it = results.begin(); it != results.end();
         ++it) {
      std::stringstream sa;
      sa << *it->second;
      std::stringstream sa2;
...

  {
    ...
    accumulators << alps::accumulator::RealObservable(
        "obs2", max_bin_number = 4
    );
    ...
    std::cout
        << "bin number: obs(): "
        << max_num_binning(accumulators["obs1"].get<double>()).bins().size()
        << ", "
        << "obs(max_bin_number = 4): "
        << max_num_binning(accumulators["obs1"].get<double>()).bins().size()
        << std::endl;
    BOOST_REQUIRE(accumulators["obs1"].count() == 16);
    BOOST_REQUIRE(
        max_num_binning(accumulators["obs1"].get<double>()).bins().size() == 16
    );
    BOOST_REQUIRE(accumulators["obs2"].count() == 16);
    BOOST_REQUIRE(
        max_num_binning(accumulators["obs2"].get<double>()).bins().size() == 4
    );
  }
