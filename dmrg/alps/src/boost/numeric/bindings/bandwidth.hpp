...
inline typename result_of::bandwidth<const T, Tag>::type bandwidth(
    const T& t, Tag
) {
...
// bandwidth( const T& t ) {
//     return detail::bandwidth_impl< const T, tag::addressing_index<1>
//     >::invoke( t );
// }
