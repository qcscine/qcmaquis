...
inline std::ptrdiff_t pbsvx(
    const char fact, const UpLo, const fortran_int_t n, const fortran_int_t kd,
    const fortran_int_t nrhs, float* ab, const fortran_int_t ldab, float* afb,
    const fortran_int_t ldafb, char& equed, float* s, float* b,
  ...
  LAPACK_SPBSVX(
      &fact, &lapack_option<UpLo>::value, &n, &kd, &nrhs, ab, &ldab, afb,
      &ldafb, &equed, s, b, &ldb, x, &ldx, &rcond, ferr, berr, work, iwork,
      &info
  );
  return info;
}
...
inline std::ptrdiff_t pbsvx(
    const char fact, const UpLo, const fortran_int_t n, const fortran_int_t kd,
    const fortran_int_t nrhs, double* ab, const fortran_int_t ldab, double* afb,
    const fortran_int_t ldafb, char& equed, double* s, double* b,
    const fortran_int_t ldb, double* x, const fortran_int_t ldx, double& rcond,
...
inline std::ptrdiff_t pbsvx(
    const char fact, const UpLo, const fortran_int_t n, const fortran_int_t kd,
    const fortran_int_t nrhs, std::complex<float>* ab, const fortran_int_t ldab,
    std::complex<float>* afb, const fortran_int_t ldafb, char& equed, float* s,
    std::complex<float>* b, const fortran_int_t ldb, std::complex<float>* x,
  ...
  LAPACK_CPBSVX(
      &fact, &lapack_option<UpLo>::value, &n, &kd, &nrhs, ab, &ldab, afb,
      &ldafb, &equed, s, b, &ldb, x, &ldx, &rcond, ferr, berr, work, rwork,
      &info
  );
  return info;
}
...
inline std::ptrdiff_t pbsvx(
    ...
    const fortran_int_t ldafb, char& equed, double* s, std::complex<double>* b,
...
struct pbsvx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAB, typename MatrixAFB, typename VectorS, typename MatrixB,
      typename MatrixX, typename VectorFERR, typename VectorBERR, typename WORK,
      typename IWORK>
  static std::ptrdiff_t invoke(
      const char fact, MatrixAB& ab, MatrixAFB& afb, char& equed, VectorS& s,
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            ...
            typename remove_const<
                typename bindings::value_type<MatrixAFB>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
    ...
    BOOST_ASSERT(
        bindings::size_minor(afb) == 1 || bindings::stride_minor(afb) == 1
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(
        bindings::stride_major(afb) >= bindings::bandwidth(ab, uplo()) + 1
    );
    BOOST_ASSERT(
        bindings::stride_major(b) >=
        std::max<std::ptrdiff_t>(1, bindings::size_column(ab))
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(fact == 'F' || fact == 'Y' || fact == 'N' || fact == 'E');
    return detail::pbsvx(
        fact, uplo(), bindings::size_column(ab),
        bindings::bandwidth(ab, uplo()), bindings::size_column(b),
        bindings::begin_value(ab), bindings::stride_major(ab),
        bindings::begin_value(afb), bindings::stride_major(afb), equed,
        bindings::begin_value(s), bindings::begin_value(b),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        fact, ab, afb, equed, s, b, x, rcond, ferr, berr,
  ...
  static std::ptrdiff_t invoke(
    ...
    typedef typename result_of::uplo_tag<MatrixAB>::type uplo;
    return invoke(
        fact, ab, afb, equed, s, b, x, rcond, ferr, berr, minimal_workspace()
    );
  }
  ...
  //
  static std::ptrdiff_t min_size_work(const std::ptrdiff_t n) { return 3 * n; }
...
pbsvx(
  ...
  return pbsvx_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      fact, ab, afb, equed, s, b, x, rcond, ferr, berr, work
  );
}
...
pbsvx(
  ...
  return pbsvx_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      fact, ab, afb, equed, s, b, x, rcond, ferr, berr, optimal_workspace()
  );
}
