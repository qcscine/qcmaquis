...
inline std::ptrdiff_t ggevx(
  ...
  LAPACK_SGGEVX(
      &balanc, &jobvl, &jobvr, &sense, &n, a, &lda, b, &ldb, alphar, alphai,
...
inline std::ptrdiff_t ggevx(
    ...
    double* vl, const fortran_int_t ldvl, double* vr, const fortran_int_t ldvr,
...
inline std::ptrdiff_t ggevx(
    const char balanc, const char jobvl, const char jobvr, const char sense,
    const fortran_int_t n, std::complex<float>* a, const fortran_int_t lda,
    std::complex<float>* b, const fortran_int_t ldb, std::complex<float>* alpha,
    std::complex<float>* beta, std::complex<float>* vl,
    const fortran_int_t ldvl, std::complex<float>* vr, const fortran_int_t ldvr,
    fortran_int_t& ilo, fortran_int_t& ihi, float* lscale, float* rscale,
  ...
  fortran_int_t info(0);
  LAPACK_CGGEVX(
      &balanc, &jobvl, &jobvr, &sense, &n, a, &lda, b, &ldb, alpha, beta, vl,
...
inline std::ptrdiff_t ggevx(
    const char balanc, const char jobvl, const char jobvr, const char sense,
    const fortran_int_t n, std::complex<double>* a, const fortran_int_t lda,
    std::complex<double>* b, const fortran_int_t ldb,
    std::complex<double>* alpha, std::complex<double>* beta,
    std::complex<double>* vl, const fortran_int_t ldvl,
    std::complex<double>* vr, const fortran_int_t ldvr, fortran_int_t& ilo,
    fortran_int_t& ihi, double* lscale, double* rscale, double& abnrm,
    double& bbnrm, double* rconde, double* rcondv, std::complex<double>* work,
...
struct ggevx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename VectorALPHAR,
  ...
  static std::ptrdiff_t invoke(
      ...
      VectorRCONDV& rcondv, detail::workspace3<WORK, IWORK, BWORK> work
  ) {
    ...
    BOOST_STATIC_ASSERT((
        boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorALPHAR>::type>::type>::value
    ));
    BOOST_STATIC_ASSERT((
        boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorALPHAI>::type>::type>::value
    ));
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorBETA>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<MatrixVR>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT((
        boost::is_same<
            typename remove_const<
    ...
    BOOST_STATIC_ASSERT((
        boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorRCONDE>::type>::type>::value
    ));
    BOOST_STATIC_ASSERT((
        boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorRCONDV>::type>::type>::value
    ));
    ...
    BOOST_ASSERT(
        bindings::size(work.select(fortran_bool_t())) >=
        min_size_bwork(sense, bindings::size_column(a))
    );
    BOOST_ASSERT(
        bindings::size(work.select(real_type())) >=
        min_size_work(balanc, jobvl, jobvr, sense, bindings::size_column(a))
    );
    ...
    BOOST_ASSERT(
        bindings::size_minor(vl) == 1 || bindings::stride_minor(vl) == 1
    );
    BOOST_ASSERT(
        bindings::size_minor(vr) == 1 || bindings::stride_minor(vr) == 1
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(sense == 'N' || sense == 'E' || sense == 'V' || sense == 'B');
    return detail::ggevx(
        balanc, jobvl, jobvr, sense, bindings::size_column(a),
        ...
        bindings::stride_major(vr), ilo, ihi, bindings::begin_value(lscale),
  ...
  static std::ptrdiff_t invoke(
      ...
      fortran_int_t& ihi, VectorLSCALE& lscale, VectorRSCALE& rscale,
      real_type& abnrm, real_type& bbnrm, VectorRCONDE& rconde,
      VectorRCONDV& rcondv, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    ...
    bindings::detail::array<fortran_bool_t> tmp_bwork(
        min_size_bwork(sense, bindings::size_column(a))
    );
    return invoke(
        balanc, jobvl, jobvr, sense, a, b, alphar, alphai, beta, vl, vr, ilo,
  ...
  static std::ptrdiff_t invoke(
      ...
      fortran_int_t& ihi, VectorLSCALE& lscale, VectorRSCALE& rscale,
      real_type& abnrm, real_type& bbnrm, VectorRCONDE& rconde,
      VectorRCONDV& rcondv, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
  ...
  static std::ptrdiff_t min_size_work(
    ...
    if (sense == 'E') return std::max<std::ptrdiff_t>(1, 10 * n);
    if (sense == 'V' || sense == 'B') return 2 * n * n + 8 * n + 16;
  ...
  //
  static std::ptrdiff_t min_size_iwork(
      const char sense, const std::ptrdiff_t n
  ) {
    if (sense == 'E')
      return 0;
    else
  ...
  //
  static std::ptrdiff_t min_size_bwork(
      const char sense, const std::ptrdiff_t n
  ) {
    if (sense == 'N')
      return 0;
...
struct ggevx_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename VectorALPHA,
      typename VectorBETA, typename MatrixVL, typename MatrixVR,
      typename VectorLSCALE, typename VectorRSCALE, typename VectorRCONDE,
      typename VectorRCONDV, typename WORK, typename RWORK, typename IWORK,
      typename BWORK>
  static std::ptrdiff_t invoke(
      const char balanc, const char jobvl, const char jobvr, const char sense,
      MatrixA& a, MatrixB& b, VectorALPHA& alpha, VectorBETA& beta,
      MatrixVL& vl, MatrixVR& vr, fortran_int_t& ilo, fortran_int_t& ihi,
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorALPHA>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
    ...
    return detail::ggevx(
        ...
        bindings::begin_value(vr), bindings::stride_major(vr), ilo, ihi,
        bindings::begin_value(lscale), bindings::begin_value(rscale), abnrm,
        bbnrm, bindings::begin_value(rconde), bindings::begin_value(rcondv),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        balanc, jobvl, jobvr, sense, a, b, alpha, beta, vl, vr, ilo, ihi,
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::ggevx(
        ...
        bindings::begin_value(tmp_iwork), bindings::begin_value(tmp_bwork)
    );
    bindings::detail::array<value_type> tmp_work(
        traits::detail::to_int(opt_size_work)
    );
  ...
  //
  static std::ptrdiff_t min_size_rwork(
      const char balanc, const std::ptrdiff_t n
  ) {
...
ggevx(
  ...
  return ggevx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      balanc, jobvl, jobvr, sense, a, b, alphar, alphai, beta, vl, vr, ilo, ihi,
...
inline typename boost::disable_if<
    detail::is_workspace<VectorRCONDV>, std::ptrdiff_t>::type
ggevx(
    const char balanc, const char jobvl, const char jobvr, const char sense,
    MatrixA& a, MatrixB& b, VectorALPHAR& alphar, VectorALPHAI& alphai,
    VectorBETA& beta, MatrixVL& vl, MatrixVR& vr, fortran_int_t& ilo,
  ...
  return ggevx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      balanc, jobvl, jobvr, sense, a, b, alphar, alphai, beta, vl, vr, ilo, ihi,
      lscale, rscale, abnrm, bbnrm, rconde, rcondv, optimal_workspace()
  );
}
//
// Overloaded function for ggevx. Its overload differs for
...
ggevx(
    const char balanc, const char jobvl, const char jobvr, const char sense,
    MatrixA& a, MatrixB& b, VectorALPHA& alpha, VectorBETA& beta, MatrixVL& vl,
    MatrixVR& vr, fortran_int_t& ilo, fortran_int_t& ihi, VectorLSCALE& lscale,
    VectorRSCALE& rscale,
    typename remove_imaginary<
        typename bindings::value_type<MatrixA>::type>::type& abnrm,
    typename remove_imaginary<
  ...
  return ggevx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      balanc, jobvl, jobvr, sense, a, b, alpha, beta, vl, vr, ilo, ihi, lscale,
      rscale, abnrm, bbnrm, rconde, rcondv, work
  );
}
...
ggevx(
  ...
  return ggevx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      balanc, jobvl, jobvr, sense, a, b, alpha, beta, vl, vr, ilo, ihi, lscale,
      rscale, abnrm, bbnrm, rconde, rcondv, optimal_workspace()
  );
}
