...
inline std::ptrdiff_t hbevd(
    const char jobz, const UpLo, const fortran_int_t n, const fortran_int_t kd,
    float* ab, const fortran_int_t ldab, float* w, float* z,
    const fortran_int_t ldz, float* work, const fortran_int_t lwork,
    fortran_int_t* iwork, const fortran_int_t liwork
) {
  fortran_int_t info(0);
  LAPACK_SSBEVD(
      &jobz, &lapack_option<UpLo>::value, &n, &kd, ab, &ldab, w, z, &ldz, work,
...
inline std::ptrdiff_t hbevd(
    const char jobz, const UpLo, const fortran_int_t n, const fortran_int_t kd,
    double* ab, const fortran_int_t ldab, double* w, double* z,
...
struct hbevd_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAB, typename VectorW, typename MatrixZ, typename WORK,
      typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobz, MatrixAB& ab, VectorW& w, MatrixZ& z,
  ...
  static std::ptrdiff_t invoke(
      const char jobz, MatrixAB& ab, VectorW& w, MatrixZ& z, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAB>::type uplo;
  ...
  template <typename MatrixAB, typename VectorW, typename MatrixZ>
  static std::ptrdiff_t invoke(
      const char jobz, MatrixAB& ab, VectorW& w, MatrixZ& z, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAB>::type uplo;
...
struct hbevd_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(jobz, ab, w, z, workspace(tmp_work, tmp_rwork, tmp_iwork));
  }
...
//
template <
    typename MatrixAB, typename VectorW, typename MatrixZ, typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
hbevd(const char jobz, MatrixAB& ab, VectorW& w, MatrixZ& z, Workspace work) {
  return hbevd_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      jobz, ab, w, z, work
  );
}
