...
inline std::ptrdiff_t hbgvd(
    const char jobz, const UpLo, const fortran_int_t n, const fortran_int_t ka,
    const fortran_int_t kb, float* ab, const fortran_int_t ldab, float* bb,
  ...
  LAPACK_SSBGVD(
      &jobz, &lapack_option<UpLo>::value, &n, &ka, &kb, ab, &ldab, bb, &ldbb, w,
...
inline std::ptrdiff_t hbgvd(
    const char jobz, const UpLo, const fortran_int_t n, const fortran_int_t ka,
    const fortran_int_t kb, double* ab, const fortran_int_t ldab, double* bb,
    const fortran_int_t ldbb, double* w, double* z, const fortran_int_t ldz,
...
inline std::ptrdiff_t hbgvd(
    const char jobz, const UpLo, const fortran_int_t n, const fortran_int_t ka,
    const fortran_int_t kb, std::complex<float>* ab, const fortran_int_t ldab,
...
inline std::ptrdiff_t hbgvd(
    const char jobz, const UpLo, const fortran_int_t n, const fortran_int_t ka,
    const fortran_int_t kb, std::complex<double>* ab, const fortran_int_t ldab,
...
struct hbgvd_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAB, typename MatrixBB, typename VectorW, typename MatrixZ,
      typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobz, MatrixAB& ab, MatrixBB& bb, VectorW& w, MatrixZ& z,
    ...
    return detail::hbgvd(
        jobz, uplo(), bindings::size_column(ab),
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::hbgvd(
        ...
        bindings::begin_value(bb), bindings::stride_major(bb),
        bindings::begin_value(w), bindings::begin_value(z),
        bindings::stride_major(z), &opt_size_work, -1, &opt_size_iwork, -1
    );
    bindings::detail::array<real_type> tmp_work(
...
struct hbgvd_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobz, ab, bb, w, z, workspace(tmp_work, tmp_rwork, tmp_iwork)
    );
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::hbgvd(
        ...
        bindings::begin_value(bb), bindings::stride_major(bb),
        bindings::begin_value(w), bindings::begin_value(z),
        bindings::stride_major(z), &opt_size_work, -1, &opt_size_rwork, -1,
        &opt_size_iwork, -1
    );
    bindings::detail::array<value_type> tmp_work(
        traits::detail::to_int(opt_size_work)
...
hbgvd(
  ...
  return hbgvd_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      jobz, ab, bb, w, z, work
  );
}
...
hbgvd(const char jobz, MatrixAB& ab, MatrixBB& bb, VectorW& w, MatrixZ& z) {
  return hbgvd_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      jobz, ab, bb, w, z, optimal_workspace()
  );
}
