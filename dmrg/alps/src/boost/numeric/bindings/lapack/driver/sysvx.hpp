...
inline std::ptrdiff_t sysvx(
  ...
  LAPACK_SSYSVX(
      &fact, &lapack_option<UpLo>::value, &n, &nrhs, a, &lda, af, &ldaf, ipiv,
...
inline std::ptrdiff_t sysvx(
    ...
    double* ferr, double* berr, double* work, const fortran_int_t lwork,
    fortran_int_t* iwork
) {
  fortran_int_t info(0);
  LAPACK_DSYSVX(
...
inline std::ptrdiff_t sysvx(
    ...
    const fortran_int_t lda, std::complex<float>* af, const fortran_int_t ldaf,
    fortran_int_t* ipiv, const std::complex<float>* b, const fortran_int_t ldb,
    std::complex<float>* x, const fortran_int_t ldx, float& rcond, float* ferr,
    float* berr, std::complex<float>* work, const fortran_int_t lwork,
    float* rwork
) {
  fortran_int_t info(0);
  LAPACK_CSYSVX(
...
inline std::ptrdiff_t sysvx(
    ...
    const fortran_int_t lda, std::complex<double>* af, const fortran_int_t ldaf,
    fortran_int_t* ipiv, const std::complex<double>* b, const fortran_int_t ldb,
...
struct sysvx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char fact, const MatrixA& a, MatrixAF& af, VectorIPIV& ipiv,
    ...
    return detail::sysvx(
        ...
        bindings::begin_value(af), bindings::stride_major(af),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        fact, a, af, ipiv, b, x, rcond, ferr, berr,
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::sysvx(
        ...
        bindings::stride_major(b), bindings::begin_value(x),
        bindings::stride_major(x), rcond, bindings::begin_value(ferr),
        bindings::begin_value(berr), &opt_size_work, -1,
...
//
template <
    typename MatrixA, typename MatrixAF, typename VectorIPIV, typename MatrixB,
...
sysvx(
  ...
  return sysvx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      fact, a, af, ipiv, b, x, rcond, ferr, berr, work
  );
}
...
sysvx(
  ...
  return sysvx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      fact, a, af, ipiv, b, x, rcond, ferr, berr, optimal_workspace()
  );
}
