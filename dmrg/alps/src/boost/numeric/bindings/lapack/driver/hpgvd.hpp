...
inline std::ptrdiff_t hpgvd(
  ...
  LAPACK_SSPGVD(
      &itype, &jobz, &lapack_option<UpLo>::value, &n, ap, bp, w, z, &ldz, work,
...
struct hpgvd_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const fortran_int_t itype, const char jobz, MatrixAP& ap, MatrixBP& bp,
    ...
    return detail::hpgvd(
        itype, jobz, uplo(), bindings::size_column(ap),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(itype, jobz, ap, bp, w, z, workspace(tmp_work, tmp_iwork));
  }
...
struct hpgvd_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const fortran_int_t itype, const char jobz, MatrixAP& ap, MatrixBP& bp,
      VectorW& w, MatrixZ& z, detail::workspace3<WORK, RWORK, IWORK> work
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAP>::type uplo;
    BOOST_STATIC_ASSERT((bindings::is_column_major<MatrixZ>::value));
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        itype, jobz, ap, bp, w, z, workspace(tmp_work, tmp_rwork, tmp_iwork)
    );
  }
...
hpgvd(
  ...
  return hpgvd_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      itype, jobz, ap, bp, w, z, work
  );
}
...
hpgvd(
  ...
  return hpgvd_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      itype, jobz, ap, bp, w, z, optimal_workspace()
  );
}
