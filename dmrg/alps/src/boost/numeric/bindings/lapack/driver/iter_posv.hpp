...
inline std::ptrdiff_t iter_posv(
  ...
  LAPACK_DSPOSV(
      &lapack_option<UpLo>::value, &n, &nrhs, a, &lda, b, &ldb, x, &ldx, work,
      swork, &iter, &info
  );
  return info;
}
...
struct iter_posv_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename MatrixX, typename WORK,
      typename SWORK>
  static std::ptrdiff_t invoke(
      MatrixA& a, const MatrixB& b, MatrixX& x, fortran_int_t& iter,
...
struct iter_posv_impl<
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(a, b, x, iter, workspace(tmp_work, tmp_swork, tmp_rwork));
  }
...
//
template <
    typename MatrixA, typename MatrixB, typename MatrixX, typename Workspace>
...
iter_posv(
  ...
  return iter_posv_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, b, x, iter, work
  );
}
