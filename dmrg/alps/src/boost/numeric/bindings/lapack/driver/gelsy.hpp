...
inline std::ptrdiff_t gelsy(
    ...
    fortran_int_t& rank, std::complex<float>* work, const fortran_int_t lwork,
    float* rwork
) {
  fortran_int_t info(0);
  LAPACK_CGELSY(
      &m, &n, &nrhs, a, &lda, b, &ldb, jpvt, &rcond, &rank, work, &lwork, rwork,
      &info
  );
  return info;
}
...
inline std::ptrdiff_t gelsy(
    ...
    fortran_int_t& rank, std::complex<double>* work, const fortran_int_t lwork,
    double* rwork
) {
  fortran_int_t info(0);
  LAPACK_ZGELSY(
...
struct gelsy_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename VectorJPVT, typename WORK>
  static std::ptrdiff_t invoke(
      MatrixA& a, MatrixB& b, VectorJPVT& jpvt, const real_type rcond,
    ...
    return detail::gelsy(
        ...
        bindings::stride_major(b), bindings::begin_value(jpvt), rcond, rank,
  ...
  static std::ptrdiff_t min_size_work(
    ...
    return std::max<std::ptrdiff_t>(
        1, std::max<std::ptrdiff_t>(minmn + 3 * n + 1, 2 * minmn + nrhs)
    );
  }
};
...
struct gelsy_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(a, b, jpvt, rcond, rank, workspace(tmp_work, tmp_rwork));
  }
  ...
  static std::ptrdiff_t min_size_work(
    ...
    return std::max<std::ptrdiff_t>(
        1, std::max<std::ptrdiff_t>(
               std::max<std::ptrdiff_t>(2 * minmn, n + 1), minmn + nrhs
           )
    );
  }
...
//
template <
    typename MatrixA, typename MatrixB, typename VectorJPVT, typename Workspace>
inline typename boost::enable_if<
    detail::is_workspace<Workspace>, std::ptrdiff_t>::type
gelsy(
    MatrixA& a, MatrixB& b, VectorJPVT& jpvt,
    const typename remove_imaginary<
        typename bindings::value_type<MatrixA>::type>::type rcond,
    fortran_int_t& rank, Workspace work
) {
  return gelsy_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, b, jpvt, rcond, rank, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<VectorJPVT>, std::ptrdiff_t>::type
gelsy(
    MatrixA& a, MatrixB& b, VectorJPVT& jpvt,
    const typename remove_imaginary<
        typename bindings::value_type<MatrixA>::type>::type rcond,
  ...
  return gelsy_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, b, jpvt, rcond, rank, optimal_workspace()
  );
}
