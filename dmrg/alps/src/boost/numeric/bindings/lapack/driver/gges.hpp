...
inline std::ptrdiff_t gges(
    ...
    const fortran_int_t ldb, fortran_int_t& sdim, float* alphar, float* alphai,
    float* beta, float* vsl, const fortran_int_t ldvsl, float* vsr,
...
inline std::ptrdiff_t gges(
    ...
    double* vsr, const fortran_int_t ldvsr, double* work,
...
inline std::ptrdiff_t gges(
  ...
  fortran_int_t info(0);
  LAPACK_CGGES(
      &jobvsl, &jobvsr, &sort, selctg, &n, a, &lda, b, &ldb, &sdim, alpha, beta,
...
struct gges_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
      MatrixA& a, MatrixB& b, fortran_int_t& sdim, VectorALPHAR& alphar,
      VectorALPHAI& alphai, VectorBETA& beta, MatrixVSL& vsl, MatrixVSR& vsr,
    ...
    return detail::gges(
        jobvsl, jobvsr, sort, selctg, bindings::size_column(a),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        jobvsl, jobvsr, sort, selctg, a, b, sdim, alphar, alphai, beta, vsl,
        vsr, workspace(tmp_work, tmp_bwork)
    );
  }
...
struct gges_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
      MatrixA& a, MatrixB& b, fortran_int_t& sdim, VectorALPHA& alpha,
  ...
  static std::ptrdiff_t invoke(
      const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
      MatrixA& a, MatrixB& b, fortran_int_t& sdim, VectorALPHA& alpha,
      VectorBETA& beta, MatrixVSL& vsl, MatrixVSR& vsr, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    ...
    return invoke(
        jobvsl, jobvsr, sort, selctg, a, b, sdim, alpha, beta, vsl, vsr,
  ...
  static std::ptrdiff_t invoke(
      const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
      MatrixA& a, MatrixB& b, fortran_int_t& sdim, VectorALPHA& alpha,
      VectorBETA& beta, MatrixVSL& vsl, MatrixVSR& vsr, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    ...
    detail::gges(
        ...
        bindings::begin_value(alpha), bindings::begin_value(beta),
        bindings::begin_value(vsl), bindings::stride_major(vsl),
        bindings::begin_value(vsr), bindings::stride_major(vsr), &opt_size_work,
        -1, bindings::begin_value(tmp_rwork), bindings::begin_value(tmp_bwork)
    );
    bindings::detail::array<value_type> tmp_work(
        traits::detail::to_int(opt_size_work)
    );
...
gges(
  ...
  return gges_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvsl, jobvsr, sort, selctg, a, b, sdim, alphar, alphai, beta, vsl, vsr,
      work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<MatrixVSR>, std::ptrdiff_t>::type
gges(
    const char jobvsl, const char jobvsr, const char sort, external_fp selctg,
    MatrixA& a, MatrixB& b, fortran_int_t& sdim, VectorALPHAR& alphar,
    VectorALPHAI& alphai, VectorBETA& beta, MatrixVSL& vsl, MatrixVSR& vsr
...
gges(
  ...
  return gges_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobvsl, jobvsr, sort, selctg, a, b, sdim, alpha, beta, vsl, vsr, work
  );
}
