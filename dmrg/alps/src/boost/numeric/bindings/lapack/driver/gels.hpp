...
inline std::ptrdiff_t gels(
    const Trans, const fortran_int_t m, const fortran_int_t n,
  ...
  LAPACK_SGELS(
      &lapack_option<Trans>::value, &m, &n, &nrhs, a, &lda, b, &ldb, work,
      &lwork, &info
  );
  return info;
}
...
struct gels_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      MatrixA& a, MatrixB& b, detail::workspace1<WORK> work
  ) {
    ...
    BOOST_ASSERT(
        ...
        std::max<std::ptrdiff_t>(1, bindings::size_row_op(a, trans()))
    );
    BOOST_ASSERT(
    ...
    return detail::gels(
        trans(), bindings::size_row_op(a, trans()),
        bindings::size_column_op(a, trans()), bindings::size_column(b),
  ...
  static std::ptrdiff_t invoke(MatrixA& a, MatrixB& b, minimal_workspace) {
    ...
    bindings::detail::array<real_type> tmp_work(min_size_work(
        bindings::size_row_op(a, trans()), bindings::size_column_op(a, trans()),
  ...
  static std::ptrdiff_t invoke(MatrixA& a, MatrixB& b, optimal_workspace) {
    ...
    detail::gels(
        ...
        bindings::size_column_op(a, trans()), bindings::size_column(b),
        bindings::begin_value(a), bindings::stride_major(a),
        bindings::begin_value(b), bindings::stride_major(b), &opt_size_work, -1
    );
  ...
  static std::ptrdiff_t min_size_work(
    ...
    return std::max<std::ptrdiff_t>(
        1, minmn + std::max<std::ptrdiff_t>(minmn, nrhs)
    );
  }
};
...
gels(MatrixA& a, MatrixB& b, Workspace work) {
  return gels_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, b, work
  );
}
