...
// * float value-type.
//
inline std::ptrdiff_t ggsvd(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t n, const fortran_int_t p, fortran_int_t& k,
    fortran_int_t& l, float* a, const fortran_int_t lda, float* b,
    const fortran_int_t ldb, float* alpha, float* beta, float* u,
  ...
  LAPACK_SGGSVD(
      &jobu, &jobv, &jobq, &m, &n, &p, &k, &l, a, &lda, b, &ldb, alpha, beta, u,
...
inline std::ptrdiff_t ggsvd(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t n, const fortran_int_t p, fortran_int_t& k,
    fortran_int_t& l, double* a, const fortran_int_t lda, double* b,
    const fortran_int_t ldb, double* alpha, double* beta, double* u,
...
inline std::ptrdiff_t ggsvd(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t n, const fortran_int_t p, fortran_int_t& k,
    fortran_int_t& l, std::complex<float>* a, const fortran_int_t lda,
    std::complex<float>* b, const fortran_int_t ldb, float* alpha, float* beta,
    std::complex<float>* u, const fortran_int_t ldu, std::complex<float>* v,
    const fortran_int_t ldv, std::complex<float>* q, const fortran_int_t ldq,
...
inline std::ptrdiff_t ggsvd(
    const char jobu, const char jobv, const char jobq, const fortran_int_t m,
    const fortran_int_t n, const fortran_int_t p, fortran_int_t& k,
    fortran_int_t& l, std::complex<double>* a, const fortran_int_t lda,
    std::complex<double>* b, const fortran_int_t ldb, double* alpha,
    double* beta, std::complex<double>* u, const fortran_int_t ldu,
    std::complex<double>* v, const fortran_int_t ldv, std::complex<double>* q,
    const fortran_int_t ldq, std::complex<double>* work, double* rwork,
    fortran_int_t* iwork
) {
  fortran_int_t info(0);
  LAPACK_ZGGSVD(
...
struct ggsvd_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  template <
      ...
      typename VectorBETA, typename MatrixU, typename MatrixV, typename MatrixQ,
      typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const char jobu, const char jobv, const char jobq, fortran_int_t& k,
      fortran_int_t& l, MatrixA& a, MatrixB& b, VectorALPHA& alpha,
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<MatrixU>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<MatrixV>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
    ...
    BOOST_ASSERT(
        bindings::size_minor(u) == 1 || bindings::stride_minor(u) == 1
    );
    BOOST_ASSERT(
        bindings::size_minor(v) == 1 || bindings::stride_minor(v) == 1
    );
    ...
    BOOST_ASSERT(
        ...
        std::max<std::ptrdiff_t>(1, bindings::size_row(b))
    );
    BOOST_ASSERT(jobq == 'Q' || jobq == 'N');
    BOOST_ASSERT(jobu == 'U' || jobu == 'N');
    BOOST_ASSERT(jobv == 'V' || jobv == 'N');
    return detail::ggsvd(
        jobu, jobv, jobq, bindings::size_row(a), bindings::size_column(a),
        bindings::size_row(b), k, l, bindings::begin_value(a),
  ...
  static std::ptrdiff_t invoke(
      const char jobu, const char jobv, const char jobq, fortran_int_t& k,
      fortran_int_t& l, MatrixA& a, MatrixB& b, VectorALPHA& alpha,
      VectorBETA& beta, MatrixU& u, MatrixV& v, MatrixQ& q, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    bindings::detail::array<real_type> tmp_work(min_size_work(
        bindings::size_column(a), bindings::size_row(a), bindings::size_row(b)
    ));
    bindings::detail::array<fortran_int_t> tmp_iwork(
        min_size_iwork(bindings::size_column(a))
    );
    return invoke(
        jobu, jobv, jobq, k, l, a, b, alpha, beta, u, v, q,
  ...
  static std::ptrdiff_t invoke(
      const char jobu, const char jobv, const char jobq, fortran_int_t& k,
      fortran_int_t& l, MatrixA& a, MatrixB& b, VectorALPHA& alpha,
      VectorBETA& beta, MatrixU& u, MatrixV& v, MatrixQ& q, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    return invoke(
        jobu, jobv, jobq, k, l, a, b, alpha, beta, u, v, q, minimal_workspace()
    );
  }
  ...
  static std::ptrdiff_t min_size_work(
      const std::ptrdiff_t n, const std::ptrdiff_t m, const std::ptrdiff_t p
  ) {
  ...
  //
  static std::ptrdiff_t min_size_iwork(const std::ptrdiff_t n) { return n; }
};
...
struct ggsvd_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  //
  static std::ptrdiff_t min_size_rwork(const std::ptrdiff_t n) { return 2 * n; }
...
ggsvd(
    const char jobu, const char jobv, const char jobq, fortran_int_t& k,
    fortran_int_t& l, MatrixA& a, MatrixB& b, VectorALPHA& alpha,
    VectorBETA& beta, MatrixU& u, MatrixV& v, MatrixQ& q, Workspace work
) {
  return ggsvd_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobu, jobv, jobq, k, l, a, b, alpha, beta, u, v, q, work
  );
}
...
ggsvd(
  ...
  return ggsvd_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      jobu, jobv, jobq, k, l, a, b, alpha, beta, u, v, q, optimal_workspace()
  );
}
