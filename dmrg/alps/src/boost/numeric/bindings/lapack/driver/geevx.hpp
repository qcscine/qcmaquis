...
inline std::ptrdiff_t geevx(
  ...
  LAPACK_SGEEVX(
      &balanc, &jobvl, &jobvr, &sense, &n, a, &lda, wr, wi, vl, &ldvl, vr,
...
inline std::ptrdiff_t geevx(
    ...
    std::complex<float>* w, std::complex<float>* vl, const fortran_int_t ldvl,
  ...
  fortran_int_t info(0);
  LAPACK_CGEEVX(
      &balanc, &jobvl, &jobvr, &sense, &n, a, &lda, w, vl, &ldvl, vr, &ldvr,
...
inline std::ptrdiff_t geevx(
    ...
    std::complex<double>* w, std::complex<double>* vl, const fortran_int_t ldvl,
...
struct geevx_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename VectorWR, typename VectorWI, typename MatrixVL,
      typename MatrixVR, typename VectorSCALE, typename VectorRCONDE,
      typename VectorRCONDV, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            ...
            typename remove_const<
                typename bindings::value_type<VectorWR>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorWI>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorSCALE>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT((
        boost::is_same<
            typename remove_const<
    ...
    BOOST_ASSERT(
        ...
        min_size_work(sense, jobvl, jobvr, bindings::size_column(a))
    );
    ...
    BOOST_ASSERT(jobvl == 'N' || jobvl == 'V' || jobvl == 'E' || jobvl == 'B');
    BOOST_ASSERT(jobvr == 'N' || jobvr == 'V' || jobvr == 'E' || jobvr == 'B');
    ...
    return detail::geevx(
        ...
        bindings::begin_value(scale), abnrm, bindings::begin_value(rconde),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        balanc, jobvl, jobvr, sense, a, wr, wi, vl, vr, ilo, ihi, scale, abnrm,
        rconde, rcondv, workspace(tmp_work, tmp_iwork)
    );
  }
  ...
  static std::ptrdiff_t min_size_work(
      const char sense, const char jobvl, const char jobvr,
...
struct geevx_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename VectorW, typename MatrixVL, typename MatrixVR,
      typename VectorSCALE, typename VectorRCONDE, typename VectorRCONDV,
      typename WORK, typename RWORK>
  static std::ptrdiff_t invoke(
      const char balanc, const char jobvl, const char jobvr, const char sense,
      MatrixA& a, VectorW& w, MatrixVL& vl, MatrixVR& vr, fortran_int_t& ilo,
    ...
    return detail::geevx(
        ...
        bindings::stride_major(vr), ilo, ihi, bindings::begin_value(scale),
        abnrm, bindings::begin_value(rconde), bindings::begin_value(rcondv),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        balanc, jobvl, jobvr, sense, a, w, vl, vr, ilo, ihi, scale, abnrm,
        rconde, rcondv, workspace(tmp_work, tmp_rwork)
    );
  }
...
geevx(
  ...
  return geevx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      balanc, jobvl, jobvr, sense, a, wr, wi, vl, vr, ilo, ihi, scale, abnrm,
      rconde, rcondv, work
  );
}
...
geevx(
  ...
  return geevx_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      balanc, jobvl, jobvr, sense, a, w, vl, vr, ilo, ihi, scale, abnrm, rconde,
      rcondv, work
  );
}
