...
ormrq(
  ...
  return ormrq_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      side, a, tau, c, work
  );
}
...
ormrq(const Side side, const MatrixA& a, const VectorTAU& tau, MatrixC& c) {
  return ormrq_impl<typename bindings::value_type<MatrixA>::type>::invoke(
