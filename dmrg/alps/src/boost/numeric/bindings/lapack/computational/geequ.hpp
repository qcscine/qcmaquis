...
struct geequ_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const MatrixA& a, VectorR& r, VectorC& c, real_type& rowcnd,
...
template <typename MatrixA, typename VectorR, typename VectorC>
inline std::ptrdiff_t geequ(
    const MatrixA& a, VectorR& r, VectorC& c,
  ...
  return geequ_impl<typename bindings::value_type<MatrixA>::type>::invoke(
