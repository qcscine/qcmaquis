...
ormrz(
  ...
  return ormrz_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      side, a, tau, c, work
  );
}
...
ormrz(const Side side, const MatrixA& a, const VectorTAU& tau, MatrixC& c) {
  return ormrz_impl<typename bindings::value_type<MatrixA>::type>::invoke(
