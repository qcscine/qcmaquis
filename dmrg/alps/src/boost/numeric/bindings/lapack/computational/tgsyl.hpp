...
inline std::ptrdiff_t tgsyl(
    const Trans, const fortran_int_t ijob, const fortran_int_t m,
    const fortran_int_t n, const float* a, const fortran_int_t lda,
    const float* b, const fortran_int_t ldb, float* c, const fortran_int_t ldc,
    const float* d, const fortran_int_t ldd, const float* e,
    const fortran_int_t lde, float* f, const fortran_int_t ldf, float& scale,
    float& dif, float* work, const fortran_int_t lwork, fortran_int_t* iwork
) {
  fortran_int_t info(0);
  LAPACK_STGSYL(
      &lapack_option<Trans>::value, &ijob, &m, &n, a, &lda, b, &ldb, c, &ldc, d,
...
inline std::ptrdiff_t tgsyl(
    ...
    const fortran_int_t ldb, std::complex<float>* c, const fortran_int_t ldc,
    const std::complex<float>* d, const fortran_int_t ldd,
    const std::complex<float>* e, const fortran_int_t lde,
    std::complex<float>* f, const fortran_int_t ldf, float& scale, float& dif,
    std::complex<float>* work, const fortran_int_t lwork, fortran_int_t* iwork
) {
  fortran_int_t info(0);
  LAPACK_CTGSYL(
      &lapack_option<Trans>::value, &ijob, &m, &n, a, &lda, b, &ldb, c, &ldc, d,
...
inline std::ptrdiff_t tgsyl(
    ...
    const fortran_int_t ldb, std::complex<double>* c, const fortran_int_t ldc,
...
struct tgsyl_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  template <
      ...
      typename MatrixE, typename MatrixF, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const fortran_int_t ijob, const MatrixA& a, const MatrixB& b, MatrixC& c,
      const MatrixD& d, const MatrixE& e, MatrixF& f, real_type& scale,
      real_type& dif, detail::workspace2<WORK, IWORK> work
  ) {
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<MatrixD>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<MatrixE>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<MatrixF>::type>::type>::value)
    );
    ...
    BOOST_ASSERT(
        ...
        min_size_iwork(
            bindings::size_column_op(a, trans()), bindings::size_column(b)
        )
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(
        bindings::size_minor(d) == 1 || bindings::stride_minor(d) == 1
    );
    BOOST_ASSERT(
        bindings::size_minor(e) == 1 || bindings::stride_minor(e) == 1
    );
    BOOST_ASSERT(
        bindings::size_minor(f) == 1 || bindings::stride_minor(f) == 1
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(
        ...
        std::max<std::ptrdiff_t>(1, bindings::size_column(b))
    );
    BOOST_ASSERT(
    ...
    BOOST_ASSERT(
        bindings::stride_major(d) >=
        std::max<std::ptrdiff_t>(1, bindings::size_column_op(a, trans()))
    );
    BOOST_ASSERT(
        bindings::stride_major(e) >=
        std::max<std::ptrdiff_t>(1, bindings::size_column(b))
    );
    BOOST_ASSERT(
        bindings::stride_major(f) >=
        std::max<std::ptrdiff_t>(1, bindings::size_column_op(a, trans()))
    );
    return detail::tgsyl(
        trans(), ijob, bindings::size_column_op(a, trans()),
  ...
  template <
      typename MatrixA, typename MatrixB, typename MatrixC, typename MatrixD,
      typename MatrixE, typename MatrixF>
  static std::ptrdiff_t invoke(
      const fortran_int_t ijob, const MatrixA& a, const MatrixB& b, MatrixC& c,
      const MatrixD& d, const MatrixE& e, MatrixF& f, real_type& scale,
      real_type& dif, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::data_order<MatrixB>::type order;
    typedef typename result_of::trans_tag<MatrixA, order>::type trans;
    ...
    bindings::detail::array<fortran_int_t> tmp_iwork(min_size_iwork(
        bindings::size_column_op(a, trans()), bindings::size_column(b)
    ));
    return invoke(
        ijob, a, b, c, d, e, f, scale, dif, workspace(tmp_work, tmp_iwork)
    );
  }
  ...
  static std::ptrdiff_t invoke(
      const fortran_int_t ijob, const MatrixA& a, const MatrixB& b, MatrixC& c,
      const MatrixD& d, const MatrixE& e, MatrixF& f, real_type& scale,
      real_type& dif, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::data_order<MatrixB>::type order;
    typedef typename result_of::trans_tag<MatrixA, order>::type trans;
...
template <
    typename MatrixA, typename MatrixB, typename MatrixC, typename MatrixD,
    typename MatrixE, typename MatrixF, typename Workspace>
...
tgsyl(
  ...
  return tgsyl_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      ijob, a, b, c, d, e, f, scale, dif, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<MatrixF>, std::ptrdiff_t>::type
tgsyl(
    const fortran_int_t ijob, const MatrixA& a, const MatrixB& b, MatrixC& c,
    const MatrixD& d, const MatrixE& e, MatrixF& f,
    typename remove_imaginary<
  ...
  return tgsyl_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      ijob, a, b, c, d, e, f, scale, dif, optimal_workspace()
  );
}
