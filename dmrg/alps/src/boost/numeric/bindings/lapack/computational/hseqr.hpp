...
inline std::ptrdiff_t hseqr(
  ...
  LAPACK_SHSEQR(
      &job, &compz, &n, &ilo, &ihi, h, &ldh, wr, wi, z, &ldz, work, &lwork,
      &info
  );
  return info;
}
...
inline std::ptrdiff_t hseqr(
    ...
    const fortran_int_t ldh, std::complex<float>* w, std::complex<float>* z,
...
inline std::ptrdiff_t hseqr(
    ...
    const fortran_int_t ldh, std::complex<double>* w, std::complex<double>* z,
...
struct hseqr_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixH, typename VectorWR, typename VectorWI, typename MatrixZ,
      typename WORK>
  static std::ptrdiff_t invoke(
      const char job, const char compz, const fortran_int_t ilo,
    ...
    return detail::hseqr(
        job, compz, bindings::size_column(h), ilo, ihi,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(job, compz, ilo, ihi, h, wr, wi, z, workspace(tmp_work));
  }
...
struct hseqr_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  // * Asserts that most arguments make sense.
  //
  template <typename MatrixH, typename VectorW, typename MatrixZ, typename WORK>
  static std::ptrdiff_t invoke(
      const char job, const char compz, const fortran_int_t ilo,
...
hseqr(
    const char job, const char compz, const fortran_int_t ilo,
    const fortran_int_t ihi, MatrixH& h, VectorWR& wr, VectorWI& wi, MatrixZ& z,
    Workspace work
) {
  return hseqr_impl<typename bindings::value_type<MatrixH>::type>::invoke(
      job, compz, ilo, ihi, h, wr, wi, z, work
  );
}
...
hseqr(
  ...
  return hseqr_impl<typename bindings::value_type<MatrixH>::type>::invoke(
      job, compz, ilo, ihi, h, wr, wi, z, optimal_workspace()
  );
}
//
// Overloaded function for hseqr. Its overload differs for
...
//
template <
    typename MatrixH, typename VectorW, typename MatrixZ, typename Workspace>
inline typename boost::enable_if<
    mpl::and_<
        is_complex<typename bindings::value_type<MatrixH>::type>,
        detail::is_workspace<Workspace> >,
    std::ptrdiff_t>::type
hseqr(
    const char job, const char compz, const fortran_int_t ilo,
    const fortran_int_t ihi, MatrixH& h, VectorW& w, MatrixZ& z, Workspace work
) {
  return hseqr_impl<typename bindings::value_type<MatrixH>::type>::invoke(
      job, compz, ilo, ihi, h, w, z, work
  );
}
...
inline typename boost::disable_if<
    mpl::or_<
        is_real<typename bindings::value_type<MatrixH>::type>,
...
hseqr(
  ...
  return hseqr_impl<typename bindings::value_type<MatrixH>::type>::invoke(
      job, compz, ilo, ihi, h, w, z, optimal_workspace()
  );
}
//
// Overloaded function for hseqr. Its overload differs for
...
hseqr(
  ...
  std::ptrdiff_t info =
      hseqr_impl<typename bindings::value_type<MatrixH>::type>::invoke(
          job, compz, ilo, ihi, h, bindings::detail::real_part_view(w),
          bindings::detail::imag_part_view(w), z, work
      );
...
hseqr(
  ...
  std::ptrdiff_t info =
      hseqr_impl<typename bindings::value_type<MatrixH>::type>::invoke(
          job, compz, ilo, ihi, h, bindings::detail::real_part_view(w),
          bindings::detail::imag_part_view(w), z, optimal_workspace()
      );
  bindings::detail::interlace(w);
  return info;
}
