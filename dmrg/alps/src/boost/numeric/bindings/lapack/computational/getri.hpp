...
inline std::ptrdiff_t getri(
    Order, const int n, float* a, const int lda, const int* ipiv, float* work,
    const int lwork
) {
...
template <typename Order>
inline std::ptrdiff_t getri(
    Order, const int n, double* a, const int lda, const int* ipiv, double* work,
    const int lwork
) {
...
template <typename Order>
inline std::ptrdiff_t getri(
    Order, const int n, std::complex<float>* a, const int lda, const int* ipiv,
...
template <typename Order>
inline std::ptrdiff_t getri(
    Order, const int n, std::complex<double>* a, const int lda, const int* ipiv,
...
template <typename Order>
inline std::ptrdiff_t getri(
    Order, const fortran_int_t n, float* a, const fortran_int_t lda,
...
template <typename Order>
inline std::ptrdiff_t getri(
    Order, const fortran_int_t n, double* a, const fortran_int_t lda,
...
template <typename Order>
inline std::ptrdiff_t getri(
    Order, const fortran_int_t n, std::complex<float>* a,
...
template <typename Order>
inline std::ptrdiff_t getri(
    Order, const fortran_int_t n, std::complex<double>* a,
    const fortran_int_t lda, const fortran_int_t* ipiv,
...
struct getri_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return detail::getri(
        order(), bindings::size_column(a), bindings::begin_value(a),
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::getri(
        order(), bindings::size_column(a), bindings::begin_value(a),
        bindings::stride_major(a), bindings::begin_value(ipiv), &opt_size_work,
        -1
    );
    bindings::detail::array<real_type> tmp_work(
...
getri(MatrixA& a, const VectorIPIV& ipiv, Workspace work) {
  return getri_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, ipiv, work
  );
}
