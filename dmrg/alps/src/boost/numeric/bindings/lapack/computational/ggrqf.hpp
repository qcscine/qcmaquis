...
inline std::ptrdiff_t ggrqf(
    const fortran_int_t m, const fortran_int_t p, const fortran_int_t n,
    std::complex<float>* a, const fortran_int_t lda, std::complex<float>* taua,
    std::complex<float>* b, const fortran_int_t ldb, std::complex<float>* taub,
...
inline std::ptrdiff_t ggrqf(
    ...
    const fortran_int_t ldb, std::complex<double>* taub,
...
struct ggrqf_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename VectorTAUA, typename MatrixB,
      typename VectorTAUB, typename WORK>
  static std::ptrdiff_t invoke(
      MatrixA& a, VectorTAUA& taua, MatrixB& b, VectorTAUB& taub,
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            ...
            typename remove_const<
                typename bindings::value_type<VectorTAUA>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorTAUB>::type>::type>::value)
    );
    ...
    return detail::ggrqf(
        bindings::size_row(a), bindings::size_row(b), bindings::size_column(a),
        bindings::begin_value(a), bindings::stride_major(a),
        bindings::begin_value(taua), bindings::begin_value(b),
        bindings::stride_major(b), bindings::begin_value(taub),
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::ggrqf(
        ...
        bindings::begin_value(a), bindings::stride_major(a),
        bindings::begin_value(taua), bindings::begin_value(b),
        bindings::stride_major(b), bindings::begin_value(taub), &opt_size_work,
        -1
    );
  ...
  static std::ptrdiff_t min_size_work(
    ...
    return std::max<std::ptrdiff_t>(
        1, std::max<std::ptrdiff_t>(n, std::max<std::ptrdiff_t>(m, p))
    );
  }
};
...
ggrqf(
    MatrixA& a, VectorTAUA& taua, MatrixB& b, VectorTAUB& taub, Workspace work
) {
  return ggrqf_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, taua, b, taub, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<VectorTAUB>, std::ptrdiff_t>::type
ggrqf(MatrixA& a, VectorTAUA& taua, MatrixB& b, VectorTAUB& taub) {
  return ggrqf_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, taua, b, taub, optimal_workspace()
  );
}
