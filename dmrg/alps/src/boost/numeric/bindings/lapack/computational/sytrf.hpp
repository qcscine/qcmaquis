...
inline std::ptrdiff_t sytrf(
    const UpLo, const fortran_int_t n, float* a, const fortran_int_t lda,
    fortran_int_t* ipiv, float* work, const fortran_int_t lwork
) {
  fortran_int_t info(0);
  LAPACK_SSYTRF(
      &lapack_option<UpLo>::value, &n, a, &lda, ipiv, work, &lwork, &info
  );
  return info;
}
...
inline std::ptrdiff_t sytrf(
    ...
    fortran_int_t* ipiv, double* work, const fortran_int_t lwork
) {
  fortran_int_t info(0);
  LAPACK_DSYTRF(
      &lapack_option<UpLo>::value, &n, a, &lda, ipiv, work, &lwork, &info
...
inline std::ptrdiff_t sytrf(
    ...
    const fortran_int_t lda, fortran_int_t* ipiv, std::complex<float>* work,
...
inline std::ptrdiff_t sytrf(
    ...
    const fortran_int_t lda, fortran_int_t* ipiv, std::complex<double>* work,
    const fortran_int_t lwork
) {
  fortran_int_t info(0);
  LAPACK_ZSYTRF(
...
struct sytrf_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      MatrixA& a, VectorIPIV& ipiv, detail::workspace1<WORK> work
  ) {
  ...
  static std::ptrdiff_t invoke(
      MatrixA& a, VectorIPIV& ipiv, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
  ...
  template <typename MatrixA, typename VectorIPIV>
  static std::ptrdiff_t invoke(
      MatrixA& a, VectorIPIV& ipiv, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixA>::type uplo;
...
sytrf(MatrixA& a, VectorIPIV& ipiv, Workspace work) {
  return sytrf_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, ipiv, work
  );
}
