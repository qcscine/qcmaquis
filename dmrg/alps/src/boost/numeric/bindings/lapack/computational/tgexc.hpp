...
inline std::ptrdiff_t tgexc(
    ...
    std::complex<float>* b, const fortran_int_t ldb, std::complex<float>* q,
    const fortran_int_t ldq, std::complex<float>* z, const fortran_int_t ldz,
...
inline std::ptrdiff_t tgexc(
    ...
    std::complex<double>* b, const fortran_int_t ldb, std::complex<double>* q,
    const fortran_int_t ldq, std::complex<double>* z, const fortran_int_t ldz,
    const fortran_int_t ifst, fortran_int_t& ilst
) {
  fortran_int_t info(0);
  LAPACK_ZTGEXC(
...
struct tgexc_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename MatrixB, typename MatrixQ, typename MatrixZ,
      typename WORK>
  static std::ptrdiff_t invoke(
      const fortran_bool_t wantq, const fortran_bool_t wantz, MatrixA& a,
    ...
    return detail::tgexc(
        wantq, wantz, bindings::size_column(a), bindings::begin_value(a),
        ...
        bindings::stride_major(z), ifst, ilst,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(wantq, wantz, a, b, q, z, ifst, ilst, workspace(tmp_work));
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    detail::tgexc(
        ...
        bindings::stride_major(b), bindings::begin_value(q),
        bindings::stride_major(q), bindings::begin_value(z),
        bindings::stride_major(z), ifst, ilst, &opt_size_work, -1
    );
    bindings::detail::array<real_type> tmp_work(
...
tgexc(
  ...
  return tgexc_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      wantq, wantz, a, b, q, z, ifst, ilst, work
  );
}
...
tgexc(
    const fortran_bool_t wantq, const fortran_bool_t wantz, MatrixA& a,
    MatrixB& b, MatrixQ& q, MatrixZ& z, fortran_int_t& ifst, fortran_int_t& ilst
) {
  return tgexc_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      wantq, wantz, a, b, q, z, ifst, ilst, optimal_workspace()
  );
}
//
// Overloaded function for tgexc. Its overload differs for
