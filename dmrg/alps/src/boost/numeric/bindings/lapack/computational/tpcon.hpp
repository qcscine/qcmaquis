...
inline std::ptrdiff_t tpcon(
    const char norm, const UpLo, const Diag, const fortran_int_t n,
    const float* ap, float& rcond, float* work, fortran_int_t* iwork
) {
  fortran_int_t info(0);
  LAPACK_STPCON(
      &norm, &lapack_option<UpLo>::value, &lapack_option<Diag>::value, &n, ap,
...
inline std::ptrdiff_t tpcon(
    const char norm, const UpLo, const Diag, const fortran_int_t n,
    const double* ap, double& rcond, double* work, fortran_int_t* iwork
) {
  fortran_int_t info(0);
  LAPACK_DTPCON(
      &norm, &lapack_option<UpLo>::value, &lapack_option<Diag>::value, &n, ap,
...
inline std::ptrdiff_t tpcon(
    const char norm, const UpLo, const Diag, const fortran_int_t n,
    const std::complex<float>* ap, float& rcond, std::complex<float>* work,
    float* rwork
) {
  fortran_int_t info(0);
  LAPACK_CTPCON(
...
inline std::ptrdiff_t tpcon(
    const char norm, const UpLo, const Diag, const fortran_int_t n,
    const std::complex<double>* ap, double& rcond, std::complex<double>* work,
    double* rwork
) {
  fortran_int_t info(0);
  LAPACK_ZTPCON(
...
struct tpcon_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char norm, const MatrixAP& ap, real_type& rcond,
    ...
    return detail::tpcon(
        norm, uplo(), diag(), bindings::size_column(ap),
  ...
  static std::ptrdiff_t invoke(
      const char norm, const MatrixAP& ap, real_type& rcond, minimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAP>::type uplo;
    typedef typename result_of::diag_tag<MatrixAP>::type diag;
  ...
  template <typename MatrixAP>
  static std::ptrdiff_t invoke(
      const char norm, const MatrixAP& ap, real_type& rcond, optimal_workspace
  ) {
    namespace bindings = ::boost::numeric::bindings;
    typedef typename result_of::uplo_tag<MatrixAP>::type uplo;
    typedef typename result_of::diag_tag<MatrixAP>::type diag;
...
tpcon(
    const char norm, const MatrixAP& ap,
    typename remove_imaginary<
        typename bindings::value_type<MatrixAP>::type>::type& rcond,
    Workspace work
) {
  return tpcon_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      norm, ap, rcond, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<MatrixAP>, std::ptrdiff_t>::type
tpcon(
    const char norm, const MatrixAP& ap,
    typename remove_imaginary<
        typename bindings::value_type<MatrixAP>::type>::type& rcond
  ...
  return tpcon_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      norm, ap, rcond, optimal_workspace()
  );
}
