...
inline std::ptrdiff_t hprfs(
  ...
  LAPACK_SSPRFS(
      &lapack_option<UpLo>::value, &n, &nrhs, ap, afp, ipiv, b, &ldb, x, &ldx,
...
struct hprfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        ap, afp, ipiv, b, x, ferr, berr, workspace(tmp_work, tmp_iwork)
    );
  }
...
struct hprfs_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(
        ap, afp, ipiv, b, x, ferr, berr, workspace(tmp_work, tmp_rwork)
    );
  }
...
hprfs(
  ...
  return hprfs_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      ap, afp, ipiv, b, x, ferr, berr, work
  );
}
...
hprfs(
  ...
  return hprfs_impl<typename bindings::value_type<MatrixAP>::type>::invoke(
      ap, afp, ipiv, b, x, ferr, berr, optimal_workspace()
  );
}
