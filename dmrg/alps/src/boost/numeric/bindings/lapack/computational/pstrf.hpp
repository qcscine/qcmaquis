...
inline std::ptrdiff_t pstrf(
  ...
  LAPACK_SPSTRF(
      &lapack_option<UpLo>::value, &n, a, &lda, piv, &rank, &tol, work, &info
  );
  return info;
}
...
struct pstrf_impl {
  ...
  static std::ptrdiff_t invoke(
      MatrixA& a, VectorPIV& piv, fortran_int_t& rank, const real_type tol,
    ...
    return detail::pstrf(
        ...
        bindings::stride_major(a), bindings::begin_value(piv), rank, tol,
...
pstrf(
    MatrixA& a, VectorPIV& piv, fortran_int_t& rank,
    const typename remove_imaginary<
        typename bindings::value_type<MatrixA>::type>::type tol,
    Workspace work
) {
  return pstrf_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, piv, rank, tol, work
  );
}
...
inline typename boost::disable_if<
    detail::is_workspace<VectorPIV>, std::ptrdiff_t>::type
pstrf(
    MatrixA& a, VectorPIV& piv, fortran_int_t& rank,
    const typename remove_imaginary<
        typename bindings::value_type<MatrixA>::type>::type tol
  ...
  return pstrf_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, piv, rank, tol, optimal_workspace()
  );
}
