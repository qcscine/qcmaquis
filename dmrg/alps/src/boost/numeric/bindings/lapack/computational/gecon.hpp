...
struct gecon_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const char norm, const MatrixA& a, const real_type anorm,
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(norm, a, anorm, rcond, workspace(tmp_work, tmp_iwork));
  }
...
struct gecon_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(norm, a, anorm, rcond, workspace(tmp_work, tmp_rwork));
  }
...
gecon(
  ...
  return gecon_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      norm, a, anorm, rcond, work
  );
}
...
gecon(
  ...
  return gecon_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      norm, a, anorm, rcond, optimal_workspace()
  );
}
