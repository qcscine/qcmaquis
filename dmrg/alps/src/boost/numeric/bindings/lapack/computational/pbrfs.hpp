...
inline std::ptrdiff_t pbrfs(
  ...
  LAPACK_SPBRFS(
      &lapack_option<UpLo>::value, &n, &kd, &nrhs, ab, &ldab, afb, &ldafb, b,
...
inline std::ptrdiff_t pbrfs(
    ...
    const fortran_int_t ldafb, const std::complex<float>* b,
...
inline std::ptrdiff_t pbrfs(
    ...
    const fortran_int_t ldafb, const std::complex<double>* b,
...
struct pbrfs_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixAB, typename MatrixAFB, typename MatrixB, typename MatrixX,
      typename VectorFERR, typename VectorBERR, typename WORK, typename IWORK>
  static std::ptrdiff_t invoke(
      const MatrixAB& ab, const MatrixAFB& afb, const MatrixB& b, MatrixX& x,
    ...
    return detail::pbrfs(
        ...
        bindings::stride_major(afb), bindings::begin_value(b),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(ab, afb, b, x, ferr, berr, workspace(tmp_work, tmp_iwork));
  }
...
struct pbrfs_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(ab, afb, b, x, ferr, berr, workspace(tmp_work, tmp_rwork));
  }
...
pbrfs(
  ...
  return pbrfs_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      ab, afb, b, x, ferr, berr, work
  );
}
...
pbrfs(
  ...
  return pbrfs_impl<typename bindings::value_type<MatrixAB>::type>::invoke(
      ab, afb, b, x, ferr, berr, optimal_workspace()
  );
}
