...
inline std::ptrdiff_t labrd(
    ...
    std::complex<float>* x, const fortran_int_t ldx, std::complex<float>* y,
    const fortran_int_t ldy
) {
  fortran_int_t info(0);
...
inline std::ptrdiff_t labrd(
    const fortran_int_t m, const fortran_int_t n, const fortran_int_t nb,
    std::complex<double>* a, const fortran_int_t lda, double* d, double* e,
    std::complex<double>* tauq, std::complex<double>* taup,
    std::complex<double>* x, const fortran_int_t ldx, std::complex<double>* y,
    const fortran_int_t ldy
) {
  fortran_int_t info(0);
...
struct labrd_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename MatrixA, typename VectorD, typename VectorE, typename VectorTAUQ,
      typename VectorTAUP, typename MatrixX, typename MatrixY>
  static std::ptrdiff_t invoke(
      MatrixA& a, VectorD& d, VectorE& e, VectorTAUQ& tauq, VectorTAUP& taup,
      MatrixX& x, MatrixY& y
  ) {
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorTAUQ>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<VectorTAUP>::type>::type>::value)
    );
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
    ...
    BOOST_STATIC_ASSERT(
        (boost::is_same<
            typename remove_const<
                typename bindings::value_type<MatrixA>::type>::type,
            typename remove_const<
                typename bindings::value_type<MatrixY>::type>::type>::value)
    );
    ...
    BOOST_ASSERT(
        bindings::size_minor(y) == 1 || bindings::stride_minor(y) == 1
    );
    BOOST_ASSERT(
...
inline std::ptrdiff_t labrd(
  ...
  return labrd_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      a, d, e, tauq, taup, x, y
  );
}
