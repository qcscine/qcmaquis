...
//
inline std::ptrdiff_t larfg(
    const fortran_int_t n, std::complex<float>& alpha, std::complex<float>* x,
    const fortran_int_t incx, std::complex<float>& tau
) {
  fortran_int_t info(0);
...
//
inline std::ptrdiff_t larfg(
    const fortran_int_t n, std::complex<double>& alpha, std::complex<double>* x,
...
struct larfg_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  static std::ptrdiff_t invoke(
      const fortran_int_t n, real_type& alpha, VectorX& x, real_type& tau
  ) {
    namespace bindings = ::boost::numeric::bindings;
    BOOST_STATIC_ASSERT((bindings::is_mutable<VectorX>::value));
    return detail::larfg(
        n, alpha, bindings::begin_value(x), bindings::stride(x), tau
    );
  }
};
...
struct larfg_impl<Value, typename boost::enable_if<is_complex<Value> >::type> {
  ...
  template <typename VectorX>
  static std::ptrdiff_t invoke(
      const fortran_int_t n, value_type& alpha, VectorX& x, value_type& tau
  ) {
    namespace bindings = ::boost::numeric::bindings;
    BOOST_STATIC_ASSERT((bindings::is_mutable<VectorX>::value));
    return detail::larfg(
...
inline std::ptrdiff_t larfg(
  ...
  return larfg_impl<typename bindings::value_type<VectorX>::type>::invoke(
      n, alpha, x, tau
  );
}
//
...
template <typename VectorX>
inline std::ptrdiff_t larfg(
    const fortran_int_t n, typename bindings::value_type<VectorX>::type& alpha,
    VectorX& x, typename bindings::value_type<VectorX>::type& tau
) {
  return larfg_impl<typename bindings::value_type<VectorX>::type>::invoke(
      n, alpha, x, tau
  );
