...
inline std::ptrdiff_t larfb(
    const Side, const Trans, const char direct, const char storev,
  ...
  LAPACK_SLARFB(
      &lapack_option<Side>::value, &lapack_option<Trans>::value, &direct,
...
struct larfb_impl<Value, typename boost::enable_if<is_real<Value> >::type> {
  ...
  //
  template <
      typename Side, typename MatrixV, typename MatrixT, typename MatrixC,
      typename WORK>
  static std::ptrdiff_t invoke(
      const Side side, const char direct, const char storev, const MatrixV& v,
      const MatrixT& t, MatrixC& c, const fortran_int_t ldwork,
    ...
    return detail::larfb(
        side, trans(), direct, storev, bindings::size_row(c),
        bindings::size_column(c), bindings::size_column(t),
  ...
  static std::ptrdiff_t invoke(
    ...
    return invoke(side, direct, storev, v, t, c, ldwork, workspace(tmp_work));
  }
  ...
  static std::ptrdiff_t invoke(
    ...
    typedef typename result_of::data_order<MatrixT>::type order;
    typedef typename result_of::trans_tag<MatrixV, order>::type trans;
    return invoke(side, direct, storev, v, t, c, ldwork, minimal_workspace());
  }
  ...
  static std::ptrdiff_t min_size_work(
      const std::ptrdiff_t ldwork, const std::ptrdiff_t k
  ) {
    return ldwork * k;
  }
};
...
larfb(
    const Side side, const char direct, const char storev, const MatrixV& v,
    const MatrixT& t, MatrixC& c, const fortran_int_t ldwork, Workspace work
) {
  return larfb_impl<typename bindings::value_type<MatrixV>::type>::invoke(
      side, direct, storev, v, t, c, ldwork, work
  );
}
...
larfb(
  ...
  return larfb_impl<typename bindings::value_type<MatrixV>::type>::invoke(
      side, direct, storev, v, t, c, ldwork, optimal_workspace()
  );
}
