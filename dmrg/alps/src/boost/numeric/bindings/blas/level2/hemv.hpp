...
inline void hemv(
  ...
  cblas_ssymv(
      cblas_option<Order>::value, cblas_option<UpLo>::value, n, alpha, a, lda,
      x, incx, beta, y, incy
  );
}
...
inline void hemv(
  ...
  cublasSsymv(
      blas_option<UpLo>::value, n, alpha, a, lda, x, incx, beta, y, incy
  );
}
...
hemv(
  ...
  hemv_impl<typename bindings::value_type<MatrixA>::type>::invoke(
      alpha, a, x, beta, y
  );
}
