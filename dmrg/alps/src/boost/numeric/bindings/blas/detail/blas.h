...
float BLAS_SCASUM(
    const fortran_int_t* n, const void* x, const fortran_int_t* incx
);
double BLAS_DZASUM(
    const fortran_int_t* n, const void* x, const fortran_int_t* incx
);
...
void BLAS_CAXPY(
    const fortran_int_t* n, const void* a, const void* x,
...
void BLAS_SCOPY(
    const fortran_int_t* n, const float* x, const fortran_int_t* incx, float* y,
...
void BLAS_CCOPY(
    const fortran_int_t* n, const void* x, const fortran_int_t* incx, void* y,
    const fortran_int_t* incy
);
void BLAS_ZCOPY(
    const fortran_int_t* n, const void* x, const fortran_int_t* incx, void* y,
...
std::complex<float> BLAS_CDOTU(
    const fortran_int_t* n, const void* x, const fortran_int_t* incx,
    const void* y, const fortran_int_t* incy
);
...
fortran_int_t BLAS_ISAMAX(
    const fortran_int_t* n, const float* x, const fortran_int_t* incx
);
fortran_int_t BLAS_IDAMAX(
    const fortran_int_t* n, const double* x, const fortran_int_t* incx
);
fortran_int_t BLAS_ICAMAX(
    const fortran_int_t* n, const void* x, const fortran_int_t* incx
);
fortran_int_t BLAS_IZAMAX(
    const fortran_int_t* n, const void* x, const fortran_int_t* incx
);
...
void BLAS_SROTM(
    const fortran_int_t* n, float* x, const fortran_int_t* incx, float* y,
    const fortran_int_t* incy, float* param
);
void BLAS_DROTM(
    const fortran_int_t* n, double* x, const fortran_int_t* incx, double* y,
    const fortran_int_t* incy, double* param
);

// Value-type variants of rotmg
void BLAS_SROTMG(
    float* d1, float* d2, float* x1, const float* y1, float* sparam
);
void BLAS_DROTMG(
    double* d1, double* d2, double* x1, const double* y1, double* dparam
);
...
void BLAS_DSCAL(
    const fortran_int_t* n, const double* a, double* x,
    const fortran_int_t* incx
);
void BLAS_CSSCAL(
    const fortran_int_t* n, const float* a, void* x, const fortran_int_t* incx
);
void BLAS_ZDSCAL(
    const fortran_int_t* n, const double* a, void* x, const fortran_int_t* incx
);
void BLAS_CSCAL(
    const fortran_int_t* n, const void* a, void* x, const fortran_int_t* incx
);
void BLAS_ZSCAL(
    const fortran_int_t* n, const void* a, void* x, const fortran_int_t* incx
);
...
void BLAS_CGBMV(
    const char* trans, const fortran_int_t* m, const fortran_int_t* n,
    const fortran_int_t* kl, const fortran_int_t* ku, const void* alpha,
...
void BLAS_DGEMV(
    ...
    const double* x, const fortran_int_t* incx, const double* beta, double* y,
    const fortran_int_t* incy
);
void BLAS_CGEMV(
    const char* trans, const fortran_int_t* m, const fortran_int_t* n,
    const void* alpha, const void* a, const fortran_int_t* lda, const void* x,
    const fortran_int_t* incx, const void* beta, void* y,
    const fortran_int_t* incy
);
void BLAS_ZGEMV(
...
void BLAS_CGERC(
    const fortran_int_t* m, const fortran_int_t* n, const void* alpha,
...
void BLAS_CHBMV(
    const char* uplo, const fortran_int_t* n, const fortran_int_t* k,
    const void* alpha, const void* a, const fortran_int_t* lda, const void* x,
    const fortran_int_t* incx, const void* beta, void* y,
    const fortran_int_t* incy
);
...
void BLAS_CHEMV(
    const char* uplo, const fortran_int_t* n, const void* alpha, const void* a,
...
void BLAS_CHER(
    const char* uplo, const fortran_int_t* n, const float* alpha, const void* x,
    const fortran_int_t* incx, void* a, const fortran_int_t* lda
);
void BLAS_ZHER(
    const char* uplo, const fortran_int_t* n, const double* alpha,
    const void* x, const fortran_int_t* incx, void* a, const fortran_int_t* lda
);

// Value-type variants of her2
void BLAS_CHER2(
    const char* uplo, const fortran_int_t* n, const void* alpha, const void* x,
    const fortran_int_t* incx, const void* y, const fortran_int_t* incy,
    void* a, const fortran_int_t* lda
);
void BLAS_ZHER2(
    const char* uplo, const fortran_int_t* n, const void* alpha, const void* x,
    const fortran_int_t* incx, const void* y, const fortran_int_t* incy,
...
void BLAS_CHPMV(
    const char* uplo, const fortran_int_t* n, const void* alpha, const void* ap,
    const void* x, const fortran_int_t* incx, const void* beta, void* y,
    const fortran_int_t* incy
);
void BLAS_ZHPMV(
    const char* uplo, const fortran_int_t* n, const void* alpha, const void* ap,
...
void BLAS_CHPR(
    const char* uplo, const fortran_int_t* n, const float* alpha, const void* x,
    const fortran_int_t* incx, void* ap
);
void BLAS_ZHPR(
    const char* uplo, const fortran_int_t* n, const double* alpha,
...
void BLAS_SSPMV(
    const char* uplo, const fortran_int_t* n, const float* alpha,
...
void BLAS_CTPMV(
    const char* uplo, const char* trans, const char* diag,
    const fortran_int_t* n, const void* ap, void* x, const fortran_int_t* incx
);
void BLAS_ZTPMV(
    const char* uplo, const char* trans, const char* diag,
    const fortran_int_t* n, const void* ap, void* x, const fortran_int_t* incx
...
void BLAS_SGEMM(
    const char* transa, const char* transb, const fortran_int_t* m,
...
void BLAS_CGEMM(
    const char* transa, const char* transb, const fortran_int_t* m,
    const fortran_int_t* n, const fortran_int_t* k, const void* alpha,
    const void* a, const fortran_int_t* lda, const void* b,
    const fortran_int_t* ldb, const void* beta, void* c,
    const fortran_int_t* ldc
);
void BLAS_ZGEMM(
    const char* transa, const char* transb, const fortran_int_t* m,
...
void BLAS_CHEMM(
    const char* side, const char* uplo, const fortran_int_t* m,
...
void BLAS_CHER2K(
    const char* uplo, const char* trans, const fortran_int_t* n,
...
void BLAS_STRMM(
    ...
    const fortran_int_t* m, const fortran_int_t* n, const float* alpha,
    const float* a, const fortran_int_t* lda, float* b, const fortran_int_t* ldb
);
void BLAS_DTRMM(
    const char* side, const char* uplo, const char* transa, const char* diag,
    const fortran_int_t* m, const fortran_int_t* n, const double* alpha,
