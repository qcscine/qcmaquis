...
void plus_minus_assign_impl(
    Matrix1& lhs, Matrix2 const& rhs, Operation op, tag::matrix, tag::matrix
) {
...
void multiplies_assign_impl(
    Matrix& lhs, T2 const& t, tag::matrix, tag::scalar
) {
...
void plus_assign(
    Matrix1& lhs, Matrix2 const& rhs, tag::matrix tag1, tag::matrix tag2
) {
  using impl::plus_minus_assign_impl;
  plus_minus_assign_impl(lhs, rhs, impl::plus_assign_operator(), tag1, tag2);
}
...
void minus_assign(
  ...
  using impl::plus_minus_assign_impl;
  plus_minus_assign_impl(lhs, rhs, impl::minus_assign_operator(), tag1, tag2);
}

template <typename Matrix, typename T2>
void multiplies_assign(
    Matrix& lhs, T2 const& t, tag::matrix tag1, tag::scalar tag2
) {
