...
class matrix_archetype {
 ...
 public:
  ...
  typedef std::size_t
      size_type;  //< An unsigned integral type used to represent the size
   ...
   *
   * @postcond The matrix has the same dimensions as m and the same
   *coefficients.
 ...
 **/
template <typename T>
typename matrix_archetype<T>::size_type num_rows(matrix_archetype<T> const& m) {
  return typename matrix_archetype<T>::size_type(0);
}
 ...
 **/
template <typename T>
typename matrix_archetype<T>::size_type num_cols(matrix_archetype<T> const& m) {
  return typename matrix_archetype<T>::size_type(0);
}
 ...
 */
template <typename T>
matrix_archetype<T> operator+(
    matrix_archetype<T> a, matrix_archetype<T> const& b
) {
  return matrix_archetype<T>();
}
...
template <typename T>
std::pair<
    typename matrix_archetype<T>::row_element_iterator,
    typename matrix_archetype<T>::row_element_iterator>
...
template <typename T>
std::pair<
    typename matrix_archetype<T>::const_row_element_iterator,
    typename matrix_archetype<T>::const_row_element_iterator>
 ...
 * @return a pair of column iterators indicating the begin and end of the column
 * j
 */
template <typename T>
std::pair<
    typename matrix_archetype<T>::col_element_iterator,
    typename matrix_archetype<T>::col_element_iterator>
...
template <typename T>
std::pair<
    typename matrix_archetype<T>::const_col_element_iterator,
    typename matrix_archetype<T>::const_col_element_iterator>
