...
/* $Id: conj.hpp 7146 2013-09-22 09:07:28Z hehn $ */
...
// if std::complex<T> is used std::conj will be called by argument dependent
// look-up

template <class T>
typename boost::enable_if<boost::is_fundamental<T>, void>::type conj_inplace(
    T& t, tag::scalar
) {}
