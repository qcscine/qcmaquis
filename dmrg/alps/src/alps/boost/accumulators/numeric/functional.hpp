...
#define BOOST_NUMERIC_FUNCTIONAL_DEFINE_UNARY_OP(Name, Op)                    \
  ...
  struct Name##_base : std::unary_function<                                   \
...
#define BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(Name, Op, RetType)         \
  ...
  template <                                                                 \
      typename Left, typename Right, typename LeftTag, typename RightTag>    \
  struct Name : Name##_base<Left, Right, void> {};                           \
  }                                                                          \
  namespace op {                                                             \
  struct Name : boost::detail::function2<functional::Name<                   \
                    _1, _2, functional::tag<_1>, functional::tag<_2> > > {}; \
  }                                                                          \
  namespace {                                                                \
  op::Name const &Name = boost::detail::pod_singleton<op::Name>::instance;   \
  }                                                                          \
...
#define BOOST_NUMERIC_FUNCTIONAL_DEDUCED(Left, Op, Right)                   \
  BOOST_TYPEOF_NESTED_TYPEDEF_TPL(                                          \
      nested, boost::numeric::functional::detail::lvalue_of<Left>()         \
                  Op boost::numeric::functional::detail::lvalue_of<Right>() \
  )                                                                         \
  typedef typename nested::type type;                                       \
  /**/
...
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    minus, -, BOOST_NUMERIC_FUNCTIONAL_DEDUCED
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
...
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    modulus, %, BOOST_NUMERIC_FUNCTIONAL_DEDUCED
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    greater, >, BOOST_NUMERIC_FUNCTIONAL_DEDUCED
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    greater_equal, >=, BOOST_NUMERIC_FUNCTIONAL_DEDUCED
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    less, <, BOOST_NUMERIC_FUNCTIONAL_DEDUCED
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    less_equal, <=, BOOST_NUMERIC_FUNCTIONAL_DEDUCED
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    equal_to, ==, BOOST_NUMERIC_FUNCTIONAL_DEDUCED
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
...
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    assign, =, BOOST_NUMERIC_FUNCTIONAL_LEFT
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    plus_assign, +=, BOOST_NUMERIC_FUNCTIONAL_LEFT
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    minus_assign, -=, BOOST_NUMERIC_FUNCTIONAL_LEFT
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    multiplies_assign, *=, BOOST_NUMERIC_FUNCTIONAL_LEFT
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
    divides_assign, /=, BOOST_NUMERIC_FUNCTIONAL_LEFT
)
BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(
...
namespace functional {
template <typename Left, typename Right, typename EnableIf>
struct min_assign_base : std::binary_function<Left, Right, void> {
...
template <typename Left, typename Right, typename EnableIf>
struct max_assign_base : std::binary_function<Left, Right, void> {
  void operator()(Left &left, Right &right) const {
...
template <typename Left, typename Right, typename EnableIf>
struct average_base : functional::divides<Left, Right> {};

// partial specialization that promotes the arguments to double for
// integral division.
template <typename Left, typename Right>
struct average_base<
    Left, Right, typename enable_if<are_integral<Left, Right> >::type>
    : functional::divides<double const, double const> {};

template <typename To, typename From, typename EnableIf>
struct promote_base : std::unary_function<From, To> {
  To operator()(From &from) const { return from; }
};

template <typename ToFrom>
struct promote_base<ToFrom, ToFrom, void>
    : std::unary_function<ToFrom, ToFrom> {
  ToFrom &operator()(ToFrom &tofrom) { return tofrom; }
};
...
template <typename Left, typename Right, typename LeftTag, typename RightTag>
struct average : average_base<Left, Right, void> {};
...
struct promote
    : boost::detail::function1<functional::promote<
          To, _, typename functional::tag<To>::type, functional::tag<_> > > {};

struct min_assign : boost::detail::function2<functional::min_assign<
                        _1, _2, functional::tag<_1>, functional::tag<_2> > > {};

struct max_assign : boost::detail::function2<functional::max_assign<
                        _1, _2, functional::tag<_1>, functional::tag<_2> > > {};

struct average : boost::detail::function2<functional::average<
                     _1, _2, functional::tag<_1>, functional::tag<_2> > > {};
...
typename lazy_disable_if<
    is_const<From>, mpl::if_<is_same<To, From>, To &, To> >::type
promote(From &from) {
...
struct default_ {
  ...
  operator T const &() const { return default_::value; }
};
...
struct one {
  ...
  operator T const &() const { return one::value; }
};
...
struct zero {
  ...
  operator T const &() const { return zero::value; }
};
