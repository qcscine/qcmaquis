 ...
 * ALPS Libraries *
 *                                                                                 *
 * Copyright (C) 2012 by Ilia Zintchenko <iliazin@gmail.com> * Jan Gukelberger *
 *                                                                                 *
...
class multi_array : public boost::multi_array<T, D, Allocator> {
 ...
 public:
  ...
  multi_array(size_type N, size_type M, size_type K, size_type J, size_type I)
      : base_type(boost::extents[N][M][K][J][I]) {}
  multi_array(size_type N, size_type M, size_type K, size_type J)
      : base_type(boost::extents[N][M][K][J]) {}
  multi_array(size_type N, size_type M, size_type K)
      : base_type(boost::extents[N][M][K]) {}
  multi_array(size_type N, size_type M) : base_type(boost::extents[N][M]) {}
  multi_array(size_type N) : base_type(boost::extents[N]) {}

  multi_array(multi_array const& a)
      : base_type(static_cast<base_type const&>(a)) {}
  multi_array(base_type const& a) : base_type(a) {}
  multi_array(const boost::detail::multi_array::extent_gen<D>& ext)
      : base_type(ext) {}
  ...
  array_type& operator+=(const array_type& a) {
    ...
    std::transform(
        (*this).data(), (*this).data() + (*this).num_elements(), a.data(),
        (*this).data(), std::plus<T>()
    );
    return *this;
  }
  ...
  array_type& operator+=(const T s) {
    std::transform(
        (*this).data(), (*this).data() + (*this).num_elements(), (*this).data(),
