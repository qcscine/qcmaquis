...
/// @brief the abstract base class of a runtime-polymorphic buffered random
/// number generator generating double values in the interval [0,1[
///
/// @tparam RealType the floating point type of the random numbers, defaults to
/// double
///
/// This class template is an abstract base class template for
/// runtime-polymorphic uniform random number generators producing numbers in
/// the interval [0,1). It inherits from
/// @ref alps::buffered_generator and provides @c min() and @max () functions
/// returning 0. and 1. respectively,
// which makes this class template a model of UniformRandomNumberGenerator.

template <class RealType = double>
class buffered_uniform_01 : public buffered_generator<RealType> {
 public:
...
/// runtime-polymorphic generators. It uses a variate_generator producing
/// uniform random numbers in the interval[0,1) to fill the buffer of the
...
class basic_buffered_uniform_01 : public buffered_uniform_01<RealType> {
 public:
  ...
  /// constructs a default-seeded generator with a buffer of the size given as
  /// argument, and uses a default-generated random number generator.
  /// @param buffer_size the size of the buffer
