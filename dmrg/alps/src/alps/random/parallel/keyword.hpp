...
/// The number of named parameter arguments for the random library. The default
/// value can be changed by defining the macro.
...
typedef boost::parameter::parameters<
    ...
    boost::parameter::optional<
        random_tag::stream_number, boost::is_convertible<_, unsigned int> >,
    boost::parameter::optional<
        random_tag::total_streams, boost::is_convertible<_, unsigned int> > >
    seed_params;
