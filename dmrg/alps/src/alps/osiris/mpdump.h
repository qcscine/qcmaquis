...
/* $Id: mpdump.h 3166 2009-05-04 13:23:09Z gullc $ */
...
#undef ALPS_DUMP_DO_TYPE
 ...
 private:
  [[maybe_unused]] bool
      valid_;           // flag to indicate the state of the message buffers
...
class IMPDump : public IDump {
 public:
  ...
  );  // receive a message broadcasted from sender
