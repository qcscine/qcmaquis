...
/* $Id: stringvalue.h 4922 2010-10-12 05:35:42Z alet $ */

/// \file stringvalue.h
/// \brief implements a string class that can easily be assigned to and
...
template <class StringBase = std::string>
class lexical_cast_string;
...
/// \brief a string class with built-in conversion to other types using
/// lexical_cast
///
...
class lexical_cast_string : public StringBase {
 public:
  ...
  ///
  /// the strings "true" and "false" are valid ways to specify tryue or false
  /// boolean values. Any other value will be converted to bool using
  /// boost::lexical_cast
  operator bool() const {
