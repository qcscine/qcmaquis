...
//
//    bool solver(MATRIX matrix, MAGNITUDE_TYPE rho, VECTOR_TYPE v, VECTOR_TYPE
//    y)
//
// Solves the equation
//    y = (A - rho*I)^{-1} * v
...
std::pair<
    typename ietl::number_traits<
        typename vectorspace_traits<VS>::scalar_type>::magnitude_type,
