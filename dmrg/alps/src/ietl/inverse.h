...
//
//    void operator()(MATRIX matrix, MAGNITUDE_TYPE sigma, VECTOR_TYPE v,
//    VECTOR_TYPE y)
//
// Solves the equation
//    y = (A - sigma*I)^{-1} * v
...
std::pair<
    typename vectorspace_traits<VS>::magnitude_type,
    typename vectorspace_traits<VS>::vector_type>
inverse(
    const MATRIX& matrix, GEN& gen, const SOLVER& solver, ITER& iter,
    typename vectorspace_traits<VS>::magnitude_type sigma, const VS& vec
) {
