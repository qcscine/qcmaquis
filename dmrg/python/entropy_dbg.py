...
#*
#* Copyright (C) 2013 Department of Chemistry and Applied Biosciences, ETH Zurich
#*               2012-2014 by Sebastian Keller <sebkelle@phys.ethz.ch>
#*               2020 by Leon Freitag <lefreita@ethz.ch> (Python3 port)
#*
#*
...
class MaquisMeasurement:
    ...
    def __init__(self, inputfile):
        self.loc_n = pyalps.loadEigenstateMeasurements([inputfile], what='N')[0][0].y
