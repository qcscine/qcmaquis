...
int main(int argc, char **argv) {
  ...
  // // auto mps1 = compression::l2r_compress(mps, 100, 1e-20,
  // compression_trace, true);
  // // std::cout << "Input COMPRESSED bond dim = " << mps1.bond_dimension() <<
  // std::endl;
  ...
  std::string MPStimesMPOstr = "MPStimesMPO.chkp.h5";
  ...
  // std::cout << "Output bond dim = " << outputMPS.bond_dimension() <<
  // std::endl; std::cout << outputMPS.description() << std::endl; std::cout <<
  // outputMPS << std::endl;
  //
  // auto mps2 = compression::l2r_compress(outputMPS, 100, 1e-20,
  // compression_trace, true); std::cout << "Compressed bond dim = " <<
  // mps2.bond_dimension() << std::endl; std::cout << "Compression trace: " <<
  // compression_trace << std::endl;
