...
/**
 * @brief Class wrapping around an MPS, to be used in conjunction with
 * sweep-based algorithms.
 *
 * Similarly to [SweepMPOContainer], this class serves as a wrapper to hide how
 * the MPS for a given site (or, for the TS case, for a pair of neighbouring
 * sites) is constructed.
 *
