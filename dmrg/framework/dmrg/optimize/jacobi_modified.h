...
//     } ;
                                                                       ...
                                                                       const magnitude_type theta, ITER& iter, vector_type &eigvec, magnitude_type &eigval)
    {
        ...
        eigval = omega_vec_[i_state_] - theta/maquis::real(ietl::dot(u,u)) ;
                                                            ...
                                                            vector_type& t)
    {
        ...
        biconjgrad_stab_standard<MATRIX, vector_type, VS> gmres(this->matrix_, u, vecspace_, maquis::real(ray), ortho_space_,
...
//             multiply_diagonal(ri, u, maquis::real(ray)) ;
//             multiply_diagonal(ui, u, maquis::real(ray)) ;
            scalar_type epsilon = ietl::dot(u,ri) / ietl::dot(u,ui) ;
            t = epsilon*ui - ri ;
