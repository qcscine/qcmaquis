...
*
*****************************************************************************/
#ifndef STANDARD_FINALIZER_HPP
#define STANDARD_FINALIZER_HPP

template<class Matrix, class VecSpace>
class StandardFinalizer : public Finalizer<Matrix, VecSpace> {
public:
    ...
    {
        return this->get_uA(idx) - this->compute_energy(i_state, idx) * (this->get_u(idx)) ;
    }
};
