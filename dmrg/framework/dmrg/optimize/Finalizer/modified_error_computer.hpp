...
#ifndef MAQUIS_DMRG_MODIFIED_ERROR_HPP
#define MAQUIS_DMRG_MODIFIED_ERROR_HPP
...
class ModifiedError : public ErrorComputer<MATRIX, VecSpace> {
public:
    // Types definition
    ...
    vector_type compute_error(Finalizer<MATRIX, VecSpace>* finalizer,
                              ...
                              size_t const& idx)
    {
        return (finalizer->get_u(idx)) - (finalizer->get_uA(idx)) * finalizer->get_eigen(idx)  ;
    }
};
