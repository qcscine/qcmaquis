...
#ifndef MAQUIS_DMRG_STANDARD_SI_ERROR_HPP
#define MAQUIS_DMRG_STANDARD_SI_ERROR_HPP

#include "dmrg/optimize/Finalizer/error_computer.hpp"

// +-----------------------------+
//  Standard S&I corrector object
// +-----------------------------+

template<class MATRIX, class VecSpace>
class StandardSIError : public ErrorComputer<MATRIX, VecSpace> {
public:
    // Types definition
