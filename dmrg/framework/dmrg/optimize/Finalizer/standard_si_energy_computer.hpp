...
#ifndef MAQUIS_DMRG_STANDARD_SI_ENERGY_HPP
#define MAQUIS_DMRG_STANDARD_SI_ENERGY_HPP
...
class StandardSIEnergy : public EnergyComputer<MATRIX, VecSpace> {
public:
    // Types definition
                                  ...
                                  size_t const &idx)
    {
        ...
        res  = std::real(ietl::dot((finalizer->get_u(idx)), jnk)) ;
        res /= std::real(ietl::dot((finalizer->get_u(idx)), (finalizer->get_u(idx))));
        return res;
    }
    //
