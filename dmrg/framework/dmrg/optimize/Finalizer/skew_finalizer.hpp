...
*
*****************************************************************************/
#ifndef SKEW_FINALIZER_HPP
#define SKEW_FINALIZER_HPP

template<class Matrix, class VecSpace>
class SkewFinalizer : public Finalizer<Matrix, VecSpace> {
public:
    ...
    {
        vector_type jnk = ((this->get_uA(idx))) - (this->get_eigen(idx)) * ((this->get_u(idx))) ;
        jnk /= ietl::two_norm(((this->get_u(idx)))) ;
        return jnk ;
    }
};
#endif