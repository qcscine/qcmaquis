...
class static_allocator {
 public:
  ...
  size_type max_size() const NOEXCEPT_SPEC { return Size; }
...
class aligned_allocator {
 public:
  ...
  void deallocate(pointer p, size_type n) NOEXCEPT_SPEC { std::free(p); }
  ...
  bool operator==(aligned_allocator<U, UAlignment> const& b
  ) const NOEXCEPT_SPEC {
    return false;
  }
