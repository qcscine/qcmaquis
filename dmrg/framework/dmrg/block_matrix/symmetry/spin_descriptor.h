...
template <class SymmType>
inline SpinDescriptor<SymmType> couple(
    SpinDescriptor<SymmType> a, SpinDescriptor<SymmType> b
) {
...
inline std::ostream& operator<<(
    std::ostream& os, SpinDescriptor<SymmType> rhs
) {
  return os;
}
...
class SpinDescriptor<symm_traits::SU2Tag> {
 public:
  ...
  bool operator==(SpinDescriptor const& rhs) const {
    return (twoS == rhs.twoS && diff_ == rhs.diff_);
  }
...
inline SpinDescriptor<symm_traits::SU2Tag> couple(
    SpinDescriptor<symm_traits::SU2Tag> a, SpinDescriptor<symm_traits::SU2Tag> b
) {
  return a.couple(b);
}

inline SpinDescriptor<symm_traits::SU2Tag> operator-(
    SpinDescriptor<symm_traits::SU2Tag> rhs
) {
  rhs.diff_ = -rhs.diff_;
  return rhs;
}
...
inline std::ostream& operator<<(
    std::ostream& os, SpinDescriptor<symm_traits::SU2Tag> rhs
) {
...
typename SymmGroup::subcharge productSpin(
    typename SymmGroup::charge a, typename SymmGroup::charge b
) {
