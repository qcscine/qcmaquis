...
class sim : public abstract_sim {
 ...
 protected:
  using measurements_type =
      typename Model<Matrix, SymmGroup>::measurements_type;
  ...
  virtual void checkpoint_simulation(
      MPS<Matrix, SymmGroup> const& state, status_type const&,
      std::string filename = ""
  );
