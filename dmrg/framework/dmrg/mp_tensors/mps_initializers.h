...
template<class Matrix, class SymmGroup>
struct const_mps_init : public default_mps_init<Matrix, SymmGroup>
{
    typedef typename mps_initializer<Matrix, SymmGroup>::MPSVector MPSVector;
    ...
    : default_mps_init<Matrix, SymmGroup>(parms, phys_dims, right_end, site_type)
    { }

    void operator()(MPS<Matrix, SymmGroup> & mps)
    {
        this->init_sectors(mps, this->init_bond_dimension, false, 1.);
    }
...
template<class Matrix, class SymmGroup>
class basis_mps_init_generic_sa : public mps_initializer<Matrix, SymmGroup>
{
public:
    typedef typename mps_initializer<Matrix, SymmGroup>::MPSVector MPSVector;
