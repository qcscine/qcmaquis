                                             ...
                                             Index<SymmGroup> bond_dim)
{
    ...
    return identity_matrix<block_matrix<Matrix, SymmGroup>, SymmGroup>(data().right_basis());
}
                                              ...
                                              Index<SymmGroup> bond_dim)
{
    ...
    return identity_matrix<block_matrix<Matrix, SymmGroup>, SymmGroup>(data().left_basis());
}
