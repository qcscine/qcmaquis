...
zerosite_hamil2(block_matrix<Matrix, SymmGroup> bra_tensor, block_matrix<Matrix, SymmGroup> ket_tensor, Boundary<OtherMatrix, SymmGroup> const & left,
                Boundary<OtherMatrix, SymmGroup> const & right, MPOTensor<Matrix, SymmGroup> const & mpo_left, MPOTensor<Matrix, SymmGroup> const & mpo_right)
{
    return zerosite_hamil_lbtm(bra_tensor, ket_tensor, left, right, mpo_left, mpo_right);
}
...
{
    return zerosite_hamil_lbtm(ket_tensor, ket_tensor, left, right, mpo_left, mpo_right);
}
                           ...
                           MPOTensor<Matrix, SymmGroup> const & mpo_left, MPOTensor<Matrix, SymmGroup> const & mpo_right)
{
    ...
    contraction::common::BoundaryMPSProduct<Matrix, OtherMatrix, SymmGroup, ::SU2::SU2Gemms> t(ket_tensor, left, mpo_right, false);
...
{
    return zerosite_hamil_lbtm_kernel<Matrix, OtherMatrix, SymmGroup>(ket_tensor, ket_tensor, left, right, mpo_left, mpo_right);
}
...
zerosite_hamil_lbtm(block_matrix<Matrix, SymmGroup> bra_tensor, block_matrix<Matrix, SymmGroup> ket_tensor,
                    ...
                    MPOTensor<Matrix, SymmGroup> const & mpo_left, MPOTensor<Matrix, SymmGroup> const & mpo_right)
{
    return zerosite_hamil_lbtm_kernel<Matrix, OtherMatrix, SymmGroup>(bra_tensor, ket_tensor, left, right, mpo_left, mpo_right);
}
