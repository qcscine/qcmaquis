...
using ::contraction::common::MPSBoundaryProduct;
                    ...
                    task_capsule<Matrix, SymmGroup> & tasks_cap)
    {
        ...
        // Note: can't be replaced by range-based for loop since dereferencing row_proxy iterator disabled
                        ...
                        MPSBoundaryProduct<Matrix, OtherMatrix, SymmGroup, ::SU2::SU2Gemms> const & t)
    {
        ...
        std::vector<value_type> phases = (mpo.herm_info.left_skip(b1))
          ? ::contraction::common::conjugate_phases(left_b1, mpo, b1, true, false)
