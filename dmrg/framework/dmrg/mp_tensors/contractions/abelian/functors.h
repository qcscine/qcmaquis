...
struct lbtm_functor
{
    ...
    void operator()(size_t b2,
                    ...
                    ProductBasis<SymmGroup> const & out_left_pb)
    {
        contraction::lbtm_kernel(b2, contr_grid, left, left_mult_mps, mpo, ket_basis, right_i, out_left_i, in_right_pb, out_left_pb);
    }
};
...
struct rbtm_functor
{
    ...
    operator()(size_t b1,
               ...
               ProductBasis<SymmGroup> const & out_right_pb)
    {
        return contraction::rbtm_kernel(b1, right, right_mult_mps, mpo, ket_basis, left_i, out_right_i, in_left_pb, out_right_pb);
    }
