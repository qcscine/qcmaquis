 ...
 * @brief Implementation of the virtual base class for the calculation of the
 * particle RDM with the pre-BO model.
...
class PreBOParticleRDM : public measurement<Matrix, NU1_template<N>> {
 public:
  ...
  using tag_type =
      typename generate_mpo::OperatorTagTerm<Matrix, NU1>::tag_type;
   ...
   * @param ptr_term_generator_ term generator object (see
   * prebo_TermGenerator.hpp)
   */
  PreBOParticleRDM(
