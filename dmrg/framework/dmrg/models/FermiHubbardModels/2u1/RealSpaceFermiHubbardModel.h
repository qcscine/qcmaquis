...
public:
    ...
    void create_terms() override {
        ...
        for (int iSite = 0; iSite < height*width; iSite++) {
            std::vector< OperatorType > opVector = {OperatorType::CreateAlpha, OperatorType::DestroyAlpha, OperatorType::CreateBeta, OperatorType::DestroyBeta};
            std::vector< pos_t > positions = {iSite, iSite, iSite, iSite};
            this->terms_.push_back(jw.getTerm(positions, opVector, tag_handler, true, U));
        ...
        for (int iSite = 0; iSite < width*height; iSite++)
        {
            ...
            if (isTranscorrelated_) {
                ...
                if (hasLower) {
                    ...
                    posVectorDownTC_3 = {iSite, iSite+1, iSite, iSite, iSite+1, iSite+1};
                    posVectorDownHermTC_3 = {iSite+1, iSite, iSite+1, iSite+1, iSite, iSite};
                }
                else {
                    posVectorDownTC_1 = {iSite, iSite-height+1, iSite-height+1, iSite-height+1};
                    posVectorDownHermTC_1 = {iSite-height+1, iSite, iSite, iSite};
                    posVectorDownTC_2 = {iSite, iSite-height+1, iSite, iSite};
                    posVectorDownHermTC_2 = {iSite-height+1, iSite, iSite-height+1, iSite-height+1};
                    posVectorDownTC_3 = {iSite, iSite-height+1, iSite, iSite, iSite-height+1, iSite-height+1};
                    posVectorDownHermTC_3 = {iSite-height+1, iSite, iSite-height+1, iSite-height+1, iSite, iSite};
                }
                if (hasRight) {
                    posVectorLeftTC_1 = {iSite, iSite+height, iSite+height, iSite+height};
                    posVectorLeftHermTC_1 = {iSite+height, iSite, iSite, iSite};
                    posVectorLeftTC_2 = {iSite, iSite+height, iSite, iSite};
                    posVectorLeftHermTC_2 = {iSite+height, iSite, iSite+height, iSite+height};
                    posVectorLeftTC_3 = {iSite, iSite+height, iSite, iSite, iSite+height, iSite+height};
        ...
        maquis::cout << " Hamiltonian Norm = " << std::sqrt(hamiltonianNorm) << std::endl;
        maquis::cout << " Non-Hermtian Hamiltonian Norm = " << std::sqrt(nonHermitianNorm) << std::endl;
