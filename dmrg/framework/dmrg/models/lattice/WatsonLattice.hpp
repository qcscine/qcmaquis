 ...
 *
 * Lattice representing the canonical quantization-based vibrational
 * Hamiltonian. Unlike the NU1 case, each site is mapped to a mode.
 */
...
class WatsonLattice : public lattice_impl {
 public:
   ...
   */
  explicit WatsonLattice(BaseParameters& parameters)
      : L(parameters["L"]), numTypes(parameters["L"]) {}
