...
template <>
Ztwo::charge state_to_charge<Ztwo>(
  ...
  typedef std::map<std::string, int> qn_map_type;
  int tmp = 0;
  for (typename alps::SiteBasisDescriptor<short>::const_iterator it = b.begin();
       it != b.end(); ++it) {
