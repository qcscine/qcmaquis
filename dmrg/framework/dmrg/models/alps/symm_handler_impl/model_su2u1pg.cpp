...
// SU2UPG Symmetry
template <>
SU2U1PG::charge state_to_charge<SU2U1PG>(alps::site_state<short> const & state, alps::SiteBasisDescriptor<short> const& b,
...
template <>
SU2U1PG::charge init_charge<SU2U1PG> (const alps::Parameters& parms, std::map<std::string, int> const& all_conserved_qn)
{
    typedef std::map<std::string, int> qn_map_type;
