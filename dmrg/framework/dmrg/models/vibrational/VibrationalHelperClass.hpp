...
class VibrationalHelpers {
 public:
  ...
  static std::vector<OperatorType> generatePowersOfPositionOperator(
      int maxCoupling, int nMax, const OperatorType& identityOp,
  ...
  static std::vector<OperatorType> generatePowersOfMomentumOperator(
      int maxCoupling, int nMax, const OperatorType& identityOp,
