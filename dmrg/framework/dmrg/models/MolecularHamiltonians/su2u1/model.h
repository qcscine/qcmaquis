...
class qc_su2 : public model_impl<Matrix, SymmGroup> {
  ...
  typedef
      typename alps::numeric::associated_one_matrix<Matrix>::type one_matrix;
 ...
 public:
  ...
  tag_type identity_matrix_tag(size_t type) const { return ops.ident[type]; }
  tag_type filling_matrix_tag(size_t type) const { return ops.fill[type]; }
