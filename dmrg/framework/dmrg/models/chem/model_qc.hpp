...
{
    typedef typename tag_type<M, TwoU1>::type tag_type;

    typename op_t<M, TwoU1>::type create_up_op, create_down_op, destroy_up_op, destroy_down_op,
    ...
    typename op_t<M, TwoU1>::type tmp;
    ...
    chem_detail::ChemHelper<M, TwoU1> term_assistant(parms, lat, ident, fill, tag_handler);
    ...
    /*** Tagged terms *****************************************************/
    /**********************************************************************/
    std::vector<typename hamtagterm_t<M, TwoU1>::type > tagterms;
    for (std::size_t m=0; m < matrix_elements.size(); ++m) {
        ...
        if ( i==-1 && j==-1 && k==-1 && l==-1) {
            ...
            typename hamtagterm_t<M, TwoU1>::type term;
        ...
        // Hopping term t_ij 
            ...
            tagterms.push_back(TermMaker<M, TwoU1>::positional_two_term(
        ...
        // V_ijjj = V_jijj = V_jjij = V_jjji
            ...
            tagterms.push_back( TermMaker<M, TwoU1>::positional_two_term(true, fill, matrix_elements[m] * ptag.second, same_idx, pos1,
        ...
        // V_ijij == V_jiji = V_ijji = V_jiij
            ...
            typename op_t<M, TwoU1>::type tmp1, tmp2;
    ...
    std::vector<typename hamterm_t<M, TwoU1>::type > terms;
