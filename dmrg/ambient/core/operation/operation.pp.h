...
operation( FP op, T0 *arg0 , T1 *arg1 , T2 *arg2 , T3 *arg3 , T4 *arg4 );
template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 >
void extract_template(void (*)( T0& , T1& , T2& , T3& , T4& ));
template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 >
void prototype_template(void (*)( T0& , T1& , T2& , T3& , T4& ));
template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void extract_template(void (*)( pinned T0& , T1& , T2& , T3& , T4& )); template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void prototype_template(void (*)( pinned T0& , T1& , T2& , T3& , T4& )); template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void extract_template(void (*)( T0& , pinned T1& , T2& , T3& , T4& )); template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void prototype_template(void (*)( T0& , pinned T1& , T2& , T3& , T4& )); template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void extract_template(void (*)( T0& , T1& , pinned T2& , T3& , T4& )); template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void prototype_template(void (*)( T0& , T1& , pinned T2& , T3& , T4& )); template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void extract_template(void (*)( T0& , T1& , T2& , pinned T3& , T4& )); template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void prototype_template(void (*)( T0& , T1& , T2& , pinned T3& , T4& )); template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void extract_template(void (*)( T0& , T1& , T2& , T3& , pinned T4& )); template < typename T0 , typename T1 , typename T2 , typename T3 , typename T4 > void prototype_template(void (*)( T0& , T1& , T2& , T3& , pinned T4& ));
