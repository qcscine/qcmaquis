...
In any case, the transcorrelated Hamiltonian is not Hermitian.
Therefore, its ground-state energy cannot be optimized by straightforwardly applying the variational principle.
...
In the following, we will describe how to run tcDMRG calculations in these cases.
