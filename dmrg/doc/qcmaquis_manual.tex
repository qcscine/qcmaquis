...
The DMRG calculations are then conducted with the software \qcm\ that requires a citation.
...
The details of the vibrational DMRG methods are described in the following paper:
...
\subsection{QCMaquis vibrational DMRG module}

The vibrational DMRG (vDMRG) module enables calculating the ground-state energy of vibrational Hamiltonians.
...
\subsection{QCMaquis pre-Born--Oppenheimer module}
\label{sec:preBO}
