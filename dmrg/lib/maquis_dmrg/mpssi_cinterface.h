...
// nstates: number of states considered for each project (array of the size
// n_projects)
...
// void qcmaquis_mpssi_get_onetdm(char* bra_pname, int bra_state, char*
// ket_pname, int ket_state, int* indices, V* values, int size);
