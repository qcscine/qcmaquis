...
BOOST_AUTO_TEST_CASE( Test2 )
{
    ...
    for (auto&& s: symmetries)
    {
        ...
        p.set(measure_2rdm,checkpoint_path.c_str());
        {
            ...
            BOOST_CHECK_EQUAL(meas_trans2rdm.first.size(), 160);
            BOOST_CHECK_EQUAL(meas_trans2rdm.second.size(), 160);
            ...
            check_measurement_mat(meas_trans2rdm, ref_trans2rdm, true);
