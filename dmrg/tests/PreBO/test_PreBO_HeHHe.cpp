...
// Test 1: HeHHe+ with d=3.4907021 Bohr, singlet, STO-3G basis set for electrons
// and PB3-D (s-orbitals only) for p+, FCI, integrals generated by Blueberry
BOOST_AUTO_TEST_CASE(PreBO_Test2) {
  ...
  std::vector<std::vector<double>> MutInf{
      {0.0183460667, 0.0013355130, 0.0149355767, 0.0007703220, 0.0007706595,
       0.0000002699},
      {0.0013355130, 0.0142746700, 0.0128860821, 0.0000101430, 0.0000101362,
       0.0000000141},
      {0.0149355767, 0.0128860821, 0.0299460169, 0.0007837109, 0.0007840622,
       0.0000002797},
      {0.0007703220, 0.0000101430, 0.0007837109, 0.0048057107, 0.0036272786,
       0.0000332957},
      {0.0007706595, 0.0000101362, 0.0007840622, 0.0036272786, 0.0047812823,
       0.0000070624},
      {0.0000002699, 0.0000000141, 0.0000002797, 0.0000332957, 0.0000070624,
       0.0000445343}};
  ...
  for (auto&& o : optimizer) {
    ...
    maquis::cout << "Running Pre-BO test for symmetry nu1 with optimization: "
                 << o << std::endl;
    ...
    // test 1-RDM
    const typename maquis::DMRGInterface<double>::meas_with_results_type&
        meas1 = interface.onerdm();
