...
struct H2Fixture {
  ...
  H2Fixture() {
    ...
    integralH2 = RealIntegralMapType{
        {{1, 1, 1, 1}, 0.354237848011},  {{1, 1, 2, 1}, -0.821703816101E-13},
        {{2, 1, 2, 1}, 0.185125251547},  {{2, 2, 2, 1}, 0.782984788117E-13},
        {{1, 1, 2, 2}, 0.361001163519},  {{2, 2, 2, 2}, 0.371320200119},
        {{1, 1, 0, 0}, -0.678487901790}, {{2, 1, 0, 0}, -0.539801158857E-14},
        {{2, 2, 0, 0}, -0.653221638776}, {{0, 0, 0, 0}, 0.176392403557}};

    //  H2 integral file in conventional format
    integralFileH2ConventionalFormat.open("IntegralFile_H2_ConventionalFormat");
    integralFileH2ConventionalFormat << " &FCI NORB=2,NELEC=2,MS2=0, "
                                     << std::endl;
    ...
    integralFileH2ConventionalFormat << " 0.354237848011E+00   1  1  1  1"
                                     << std::endl;
    integralFileH2ConventionalFormat << " 0.185125251547E+00   2  1  2  1"
                                     << std::endl;
    integralFileH2ConventionalFormat << " 0.361001163519E+00   1  1  2  2"
                                     << std::endl;
    integralFileH2ConventionalFormat << " 0.371320200119E+00   2  2  2  2"
                                     << std::endl;
    integralFileH2ConventionalFormat << "-0.678487901790E+00   1  1  0  0"
                                     << std::endl;
    integralFileH2ConventionalFormat << "-0.653221638776E+00   2  2  0  0"
                                     << std::endl;
    integralFileH2ConventionalFormat << " 0.176392403557E+00   0  0  0  0"
                                     << std::endl;
    ...
    integralFileH2QuantumFormatConventional << " &FCI NORB=2,NELEC=2,MS2=0, "
                                            << std::endl;
    ...
    integralFileH2QuantumFormatConventional
        << "-9.481694515690000e-01    1   1    0    0" << std::endl;
    integralFileH2QuantumFormatConventional
        << "-9.314443646090000e-01    2   2    0    0" << std::endl;
    integralFileH2QuantumFormatConventional
        << "+3.542378480110000e-01    1   1    1    1" << std::endl;
    integralFileH2QuantumFormatConventional
        << "+1.851252515470000e-01    2   1    2    1" << std::endl;
    integralFileH2QuantumFormatConventional
        << "+3.610011635190000e-01    2   2    1    1" << std::endl;
    integralFileH2QuantumFormatConventional
        << "+3.713202001190000e-01    2   2    2    2" << std::endl;
    integralFileH2QuantumFormatConventional
        << "+0.176392403557000E+00    0   0    0    0" << std::endl;
    integralFileH2QuantumFormatConventional.close();

    // H2 integral file in quantum format + transcorrelation (so, twofold
    // symmetry).
    integralFileH2QuantumFormatTranscorrelated.open(
        "IntegralFile_H2_QuantumFormat_Transcorrelated"
    );
    integralFileH2QuantumFormatTranscorrelated << " &FCI NORB=2,NELEC=2,MS2=0, "
                                               << std::endl;
    ...
    integralFileH2QuantumFormatTranscorrelated
        << "-9.481694515690000e-01    1   1    0    0    0    0" << std::endl;
    integralFileH2QuantumFormatTranscorrelated
        << "-9.314443646090000e-01    2   2    0    0    0    0" << std::endl;
    integralFileH2QuantumFormatTranscorrelated
        << "+3.542378480110000e-01    1   1    1    1    0    0" << std::endl;
    integralFileH2QuantumFormatTranscorrelated
        << "+1.851252515470000e-01    1   2    1    2    0    0" << std::endl;
    integralFileH2QuantumFormatTranscorrelated
        << "+1.851252515470000e-01    2   1    1    2    0    0" << std::endl;
    integralFileH2QuantumFormatTranscorrelated
        << "+1.851252515470000e-01    2   1    2    1    0    0" << std::endl;
    integralFileH2QuantumFormatTranscorrelated
        << "+3.610011635190000e-01    2   2    1    1    0    0" << std::endl;
    integralFileH2QuantumFormatTranscorrelated
        << "+3.713202001190000e-01    2   2    2    2    0    0" << std::endl;
    integralFileH2QuantumFormatTranscorrelated
        << "+0.176392403557000E+00    0   0    0    0    0    0" << std::endl;
    ...
    parametersH2QuantumFormat.set(
        "integral_file", "IntegralFile_H2_QuantumFormat"
    );
    ...
    parametersH2QuantumFormatTranscorrelated.set(
        "CONSERVED_QUANTUMNUMBERS", "Nup,Ndown"
    );
    parametersH2QuantumFormatTranscorrelated.set("MODEL", "quantum_chemistry");
    parametersH2QuantumFormatTranscorrelated.set(
        "integral_file", "IntegralFile_H2_ConventionalFormat"
    );
    ...
    parametersH2QuantumFormatTranscorrelated.set(
        "quantum_computing_format", "no"
    );
    parametersH2QuantumFormatTranscorrelated.set(
        "transcorrelated_nsweeps_TI", 0
    );
    parametersH2QuantumFormatTranscorrelated.set(
        "transcorrelated_nsweeps_TC", 100
    );
    parametersH2QuantumFormatTranscorrelated.set(
  ...
  DmrgParameters parametersH2, parametersH2QuantumFormatTranscorrelated,
      parametersH2QuantumFormat;
  std::ofstream integralFileH2ConventionalFormat,
      integralFileH2QuantumFormatTranscorrelated,
      integralFileH2QuantumFormatConventional;
};
