...
namespace boost { namespace numeric { namespace bindings { namespace detail {
    ...
    using ::blas::p_dense_matrix;

    template <typename T, typename MemoryBlock, typename Id, typename Enable>
    struct adaptor< p_dense_matrix<T,MemoryBlock>, Id, Enable>
    {
        ...
        //typedef typename ::blas::p_dense_matrix<T,Alloc>::size_type         size_type;
        //typedef typename ::blas::p_dense_matrix<T,Alloc>::difference_type   difference_type;
