...
namespace ambient {
    ...
    struct cast_to_p_dense : public ambient::kernel< cast_to_p_dense<T> > 
    {
        ...
        inline void c(const std::vector<T>*& ac, maquis::types::p_dense_matrix_impl<T>& a, const size_t& m, const size_t& n, const size_t& lda){
            __A_TIME_C("ambient_cast_to_p_dense_c_kernel"); 
            size_t x = ctxt.get_block_id().x;
            size_t y = ctxt.get_block_id().y;
    ...
    template<typename T>
    struct overlap : public ambient::kernel< overlap<T> > 
    {
        typedef void (overlap::*F)(const maquis::types::p_dense_matrix_impl<T>&, const maquis::types::p_dense_matrix_impl<T>&, const size_t&, const size_t&, T*&);
