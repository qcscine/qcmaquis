...
namespace ambient {
    ...
    // V = double, S = size_t
    template<typename T>
    void __a_memptf(void (*ptf)(maquis::types::p_dense_matrix_impl<T>& dest, T* dd, dim2 const& dpos, 
