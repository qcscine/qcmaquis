#ifndef __ALPS_P_RESIZABLE_MATRIX_INTERFACE_HPP__
#define __ALPS_P_RESIZABLE_MATRIX_INTERFACE_HPP__

#include "types/p_dense_matrix/concept/resizable_matrix_concept_check.hpp"
...
namespace maquis {
    ...
    {
    //    BOOST_CONCEPT_ASSERT((maquis::types::ResizableMatrix<p_dense_matrix<T> >));
        return m.resize(i,j);
    }
